...
class Java9Parser extends Parser {
  ...
  static const int TOKEN_T__0 = 1,
      ...
      TOKEN_VOLATILE = 59,
      TOKEN_WHILE = 60,
      TOKEN_UNDER_SCORE = 61,
      TOKEN_IntegerLiteral = 62,
      TOKEN_FloatingPointLiteral = 63,
      TOKEN_BooleanLiteral = 64,
      TOKEN_CharacterLiteral = 65,
      TOKEN_StringLiteral = 66,
      TOKEN_NullLiteral = 67,
      TOKEN_LPAREN = 68,
      TOKEN_RPAREN = 69,
      TOKEN_LBRACE = 70,
      TOKEN_RBRACE = 71,
      ...
      TOKEN_CARET = 102,
      TOKEN_MOD = 103,
      TOKEN_ADD_ASSIGN = 104,
      TOKEN_SUB_ASSIGN = 105,
      TOKEN_MUL_ASSIGN = 106,
      TOKEN_DIV_ASSIGN = 107,
      TOKEN_AND_ASSIGN = 108,
      TOKEN_OR_ASSIGN = 109,
      TOKEN_XOR_ASSIGN = 110,
      TOKEN_MOD_ASSIGN = 111,
      TOKEN_LSHIFT_ASSIGN = 112,
      TOKEN_RSHIFT_ASSIGN = 113,
      TOKEN_URSHIFT_ASSIGN = 114,
      TOKEN_Identifier = 115,
      TOKEN_WS = 116,
      TOKEN_COMMENT = 117,
      TOKEN_LINE_COMMENT = 118;
  ...
  LiteralContext literal() {
    ...
    try {
      ...
      if (!(((((_la - 62)) & ~0x3f) == 0 &&
          ((BigInt.one << (_la - 62)) &
                  ((BigInt.one << (TOKEN_IntegerLiteral - 62)) |
                      (BigInt.one << (TOKEN_FloatingPointLiteral - 62)) |
                      (BigInt.one << (TOKEN_BooleanLiteral - 62)) |
                      (BigInt.one << (TOKEN_CharacterLiteral - 62)) |
                      (BigInt.one << (TOKEN_StringLiteral - 62)) |
                      (BigInt.one << (TOKEN_NullLiteral - 62)))) !=
              BigInt.zero))) {
  ...
  ClassType_lf_classOrInterfaceTypeContext classType_lf_classOrInterfaceType() {
    dynamic _localctx =
        ClassType_lf_classOrInterfaceTypeContext(context, state);
  ...
  ClassType_lfno_classOrInterfaceTypeContext
      classType_lfno_classOrInterfaceType() {
    dynamic _localctx =
        ClassType_lfno_classOrInterfaceTypeContext(context, state);
  ...
  InterfaceType_lf_classOrInterfaceTypeContext
      interfaceType_lf_classOrInterfaceType() {
    dynamic _localctx =
        InterfaceType_lf_classOrInterfaceTypeContext(context, state);
  ...
  InterfaceType_lfno_classOrInterfaceTypeContext
      interfaceType_lfno_classOrInterfaceType() {
    dynamic _localctx =
        InterfaceType_lfno_classOrInterfaceTypeContext(context, state);
      ...
      while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
        if (_alt == 1) {
          ...
          pushNewRecursionContext(
              _localctx, _startState, RULE_packageOrTypeName);
          state = 714;
          if (!(precpred(context, 1))) {
            throw FailedPredicateException(this, "precpred(context, 1)");
          }
  ...
  ClassBodyContext classBody() {
    ...
    try {
      ...
      while ((((_la) & ~0x3f) == 0 &&
          ...
          ((((_la - 70)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 70)) &
                      ((BigInt.one << (TOKEN_LBRACE - 70)) |
                          (BigInt.one << (TOKEN_SEMI - 70)) |
                          (BigInt.one << (TOKEN_AT - 70)) |
                          (BigInt.one << (TOKEN_LT - 70)) |
                          (BigInt.one << (TOKEN_Identifier - 70)))) !=
                  BigInt.zero)) {
        state = 959;
        classBodyDeclaration();
        state = 964;
  ...
  FieldDeclarationContext fieldDeclaration() {
    ...
    try {
      ...
      while (((((_la - 28)) & ~0x3f) == 0 &&
          ((BigInt.one << (_la - 28)) &
                  ((BigInt.one << (TOKEN_FINAL - 28)) |
                      (BigInt.one << (TOKEN_PRIVATE - 28)) |
                      (BigInt.one << (TOKEN_PROTECTED - 28)) |
                      (BigInt.one << (TOKEN_PUBLIC - 28)) |
                      (BigInt.one << (TOKEN_STATIC - 28)) |
                      (BigInt.one << (TOKEN_TRANSIENT - 28)) |
                      (BigInt.one << (TOKEN_VOLATILE - 28)) |
                      (BigInt.one << (TOKEN_AT - 28)))) !=
              BigInt.zero)) {
        state = 980;
        fieldModifier();
        state = 985;
  ...
  UnannClassType_lf_unannClassOrInterfaceTypeContext
      unannClassType_lf_unannClassOrInterfaceType() {
    dynamic _localctx =
        UnannClassType_lf_unannClassOrInterfaceTypeContext(context, state);
  ...
  UnannClassType_lfno_unannClassOrInterfaceTypeContext
      unannClassType_lfno_unannClassOrInterfaceType() {
    dynamic _localctx =
        UnannClassType_lfno_unannClassOrInterfaceTypeContext(context, state);
    enterRule(
        _localctx, 138, RULE_unannClassType_lfno_unannClassOrInterfaceType);
    int _la;
    try {
      enterOuterAlt(_localctx, 1);
      state = 1074;
  ...
  UnannInterfaceType_lf_unannClassOrInterfaceTypeContext
      unannInterfaceType_lf_unannClassOrInterfaceType() {
    dynamic _localctx =
        UnannInterfaceType_lf_unannClassOrInterfaceTypeContext(context, state);
    enterRule(
        _localctx, 142, RULE_unannInterfaceType_lf_unannClassOrInterfaceType);
    try {
      enterOuterAlt(_localctx, 1);
      state = 1080;
      unannClassType_lf_unannClassOrInterfaceType();
  ...
  UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext
    ...
    dynamic _localctx =
        UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext(
            context, state);
    enterRule(
        _localctx, 144, RULE_unannInterfaceType_lfno_unannClassOrInterfaceType);
    try {
      enterOuterAlt(_localctx, 1);
      state = 1082;
      unannClassType_lfno_unannClassOrInterfaceType();
  ...
  ConstructorDeclarationContext constructorDeclaration() {
    ...
    try {
      ...
      while (((((_la - 43)) & ~0x3f) == 0 &&
          ((BigInt.one << (_la - 43)) &
                  ((BigInt.one << (TOKEN_PRIVATE - 43)) |
                      (BigInt.one << (TOKEN_PROTECTED - 43)) |
                      (BigInt.one << (TOKEN_PUBLIC - 43)) |
                      (BigInt.one << (TOKEN_AT - 43)))) !=
              BigInt.zero)) {
        state = 1246;
        constructorModifier();
        state = 1251;
      ...
      if ((((_la) & ~0x3f) == 0 &&
              ((BigInt.one << _la) &
                      ((BigInt.one << TOKEN_T__0) |
                          ...
                          (BigInt.one << TOKEN_FloatingPointLiteral))) !=
                  BigInt.zero) ||
          ((((_la - 64)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 64)) &
                      ((BigInt.one << (TOKEN_BooleanLiteral - 64)) |
                          (BigInt.one << (TOKEN_CharacterLiteral - 64)) |
                          (BigInt.one << (TOKEN_StringLiteral - 64)) |
                          (BigInt.one << (TOKEN_NullLiteral - 64)) |
                          (BigInt.one << (TOKEN_LPAREN - 64)) |
  ...
  InterfaceBodyContext interfaceBody() {
    ...
    try {
      ...
      while ((((_la) & ~0x3f) == 0 &&
          ...
          ((((_la - 74)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 74)) &
                      ((BigInt.one << (TOKEN_SEMI - 74)) |
                          (BigInt.one << (TOKEN_AT - 74)) |
                          (BigInt.one << (TOKEN_LT - 74)) |
                          (BigInt.one << (TOKEN_Identifier - 74)))) !=
                  BigInt.zero)) {
        state = 1425;
        interfaceMemberDeclaration();
        state = 1430;
  ...
  StatementWithoutTrailingSubstatementContext
      statementWithoutTrailingSubstatement() {
    dynamic _localctx =
        StatementWithoutTrailingSubstatementContext(context, state);
  ...
  PrimaryNoNewArray_lfno_arrayAccessContext
      primaryNoNewArray_lfno_arrayAccess() {
    dynamic _localctx =
        PrimaryNoNewArray_lfno_arrayAccessContext(context, state);
  ...
  ClassInstanceCreationExpression_lf_primaryContext
      classInstanceCreationExpression_lf_primary() {
    dynamic _localctx =
        ClassInstanceCreationExpression_lf_primaryContext(context, state);
  ...
  ClassInstanceCreationExpression_lfno_primaryContext
      classInstanceCreationExpression_lfno_primary() {
    dynamic _localctx =
        ClassInstanceCreationExpression_lfno_primaryContext(context, state);
    enterRule(
        _localctx, 390, RULE_classInstanceCreationExpression_lfno_primary);
    int _la;
    try {
      state = 2321;
      errorHandler.sync(this);
  ...
  AssignmentOperatorContext assignmentOperator() {
    ...
    try {
      ...
      if (!(((((_la - 80)) & ~0x3f) == 0 &&
          ((BigInt.one << (_la - 80)) &
                  ((BigInt.one << (TOKEN_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_ADD_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_SUB_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_MUL_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_DIV_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_AND_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_OR_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_XOR_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_MOD_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_LSHIFT_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_RSHIFT_ASSIGN - 80)) |
                      (BigInt.one << (TOKEN_URSHIFT_ASSIGN - 80)))) !=
              BigInt.zero))) {
        errorHandler.recoverInline(this);
      } else {
        if (tokenStream.LA(1) == IntStream.EOF) matchedEOF = true;
    ...
    try {
      ...
      while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
        if (_alt == 1) {
          ...
          pushNewRecursionContext(
              _localctx, _startState, RULE_inclusiveOrExpression);
          state = 2786;
          if (!(precpred(context, 1))) {
            throw FailedPredicateException(this, "precpred(context, 1)");
          }
    ...
    try {
      ...
      while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
        if (_alt == 1) {
          ...
          pushNewRecursionContext(
              _localctx, _startState, RULE_exclusiveOrExpression);
          state = 2797;
          if (!(precpred(context, 1))) {
            throw FailedPredicateException(this, "precpred(context, 1)");
          }
        ...
        if (_alt == 1) {
          ...
          switch (interpreter.adaptivePredict(tokenStream, 326, context)) {
            case 1:
              ...
              pushNewRecursionContext(
                  _localctx, _startState, RULE_shiftExpression);
              state = 2856;
              if (!(precpred(context, 3))) {
                throw FailedPredicateException(this, "precpred(context, 3)");
              }
      ...
      while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
        if (_alt == 1) {
          ...
          switch (interpreter.adaptivePredict(tokenStream, 330, context)) {
            case 1:
              _localctx =
                  MultiplicativeExpressionContext(_parentctx, _parentState);
              pushNewRecursionContext(
                  _localctx, _startState, RULE_multiplicativeExpression);
              state = 2891;
              if (!(precpred(context, 3))) {
                throw FailedPredicateException(this, "precpred(context, 3)");
              }
  ...
  PostIncrementExpression_lf_postfixExpressionContext
      postIncrementExpression_lf_postfixExpression() {
    dynamic _localctx =
        PostIncrementExpression_lf_postfixExpressionContext(context, state);
    enterRule(
  ...
  PostDecrementExpression_lf_postfixExpressionContext
      postDecrementExpression_lf_postfixExpression() {
    dynamic _localctx =
        PostDecrementExpression_lf_postfixExpressionContext(context, state);
    enterRule(
        _localctx, 484, RULE_postDecrementExpression_lf_postfixExpression);
    try {
      enterOuterAlt(_localctx, 1);
      state = 2947;
      match(TOKEN_DEC);
  ...
  bool _packageOrTypeName_sempred(
  ...
  bool _conditionalOrExpression_sempred(
  ...
  bool _conditionalAndExpression_sempred(
  ...
  bool _inclusiveOrExpression_sempred(
  ...
  bool _exclusiveOrExpression_sempred(
  ...
  bool _equalityExpression_sempred(
  ...
  bool _relationalExpression_sempred(
  ...
  bool _shiftExpression_sempred(
      ShiftExpressionContext _localctx, int predIndex) {
    switch (predIndex) {
      case 16:
        return precpred(context, 3);
      case 17:
  ...
  bool _additiveExpression_sempred(
  ...
  bool _multiplicativeExpression_sempred(
...
class LiteralContext extends ParserRuleContext {
  TerminalNode IntegerLiteral() =>
      getToken(Java9Parser.TOKEN_IntegerLiteral, 0);
  TerminalNode FloatingPointLiteral() =>
      getToken(Java9Parser.TOKEN_FloatingPointLiteral, 0);
  TerminalNode BooleanLiteral() =>
      getToken(Java9Parser.TOKEN_BooleanLiteral, 0);
  TerminalNode CharacterLiteral() =>
      getToken(Java9Parser.TOKEN_CharacterLiteral, 0);
...
class PrimitiveTypeContext extends ParserRuleContext {
  ...
  PrimitiveTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class NumericTypeContext extends ParserRuleContext {
  ...
  FloatingPointTypeContext floatingPointType() =>
      getRuleContext<FloatingPointTypeContext>(0);
  NumericTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class IntegralTypeContext extends ParserRuleContext {
  ...
  IntegralTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FloatingPointTypeContext extends ParserRuleContext {
  ...
  FloatingPointTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ReferenceTypeContext extends ParserRuleContext {
  ClassOrInterfaceTypeContext classOrInterfaceType() =>
      getRuleContext<ClassOrInterfaceTypeContext>(0);
  ...
  ReferenceTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassOrInterfaceTypeContext extends ParserRuleContext {
  ClassType_lfno_classOrInterfaceTypeContext
      classType_lfno_classOrInterfaceType() =>
          getRuleContext<ClassType_lfno_classOrInterfaceTypeContext>(0);
  InterfaceType_lfno_classOrInterfaceTypeContext
      interfaceType_lfno_classOrInterfaceType() =>
          getRuleContext<InterfaceType_lfno_classOrInterfaceTypeContext>(0);
  List<ClassType_lf_classOrInterfaceTypeContext>
      classType_lf_classOrInterfaceTypes() =>
          getRuleContexts<ClassType_lf_classOrInterfaceTypeContext>();
  ClassType_lf_classOrInterfaceTypeContext classType_lf_classOrInterfaceType(
          int i) =>
      getRuleContext<ClassType_lf_classOrInterfaceTypeContext>(i);
  List<InterfaceType_lf_classOrInterfaceTypeContext>
      interfaceType_lf_classOrInterfaceTypes() =>
          getRuleContexts<InterfaceType_lf_classOrInterfaceTypeContext>();
  InterfaceType_lf_classOrInterfaceTypeContext
      interfaceType_lf_classOrInterfaceType(int i) =>
          getRuleContext<InterfaceType_lf_classOrInterfaceTypeContext>(i);
  ClassOrInterfaceTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassTypeContext extends ParserRuleContext {
  ...
  ClassTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InterfaceType_lf_classOrInterfaceTypeContext extends ParserRuleContext {
  ClassType_lf_classOrInterfaceTypeContext
      classType_lf_classOrInterfaceType() =>
          getRuleContext<ClassType_lf_classOrInterfaceTypeContext>(0);
  InterfaceType_lf_classOrInterfaceTypeContext(
      [ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeVariableContext extends ParserRuleContext {
  ...
  List<AnnotationContext> annotations() => getRuleContexts<AnnotationContext>();
  AnnotationContext annotation(int i) => getRuleContext<AnnotationContext>(i);
  TypeVariableContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArrayTypeContext extends ParserRuleContext {
  PrimitiveTypeContext primitiveType() =>
      getRuleContext<PrimitiveTypeContext>(0);
...
class DimsContext extends ParserRuleContext {
  ...
  List<AnnotationContext> annotations() => getRuleContexts<AnnotationContext>();
  AnnotationContext annotation(int i) => getRuleContext<AnnotationContext>(i);
  DimsContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeParameterContext extends ParserRuleContext {
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  List<TypeParameterModifierContext> typeParameterModifiers() =>
      getRuleContexts<TypeParameterModifierContext>();
  TypeParameterModifierContext typeParameterModifier(int i) =>
      getRuleContext<TypeParameterModifierContext>(i);
  TypeBoundContext typeBound() => getRuleContext<TypeBoundContext>(0);
  TypeParameterContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeParameterModifierContext extends ParserRuleContext {
  ...
  TypeParameterModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeBoundContext extends ParserRuleContext {
  ...
  ClassOrInterfaceTypeContext classOrInterfaceType() =>
      getRuleContext<ClassOrInterfaceTypeContext>(0);
  List<AdditionalBoundContext> additionalBounds() =>
      getRuleContexts<AdditionalBoundContext>();
  AdditionalBoundContext additionalBound(int i) =>
      getRuleContext<AdditionalBoundContext>(i);
...
class AdditionalBoundContext extends ParserRuleContext {
  ...
  AdditionalBoundContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeArgumentsContext extends ParserRuleContext {
  ...
  TypeArgumentListContext typeArgumentList() =>
      getRuleContext<TypeArgumentListContext>(0);
...
class TypeArgumentListContext extends ParserRuleContext {
  List<TypeArgumentContext> typeArguments() =>
      getRuleContexts<TypeArgumentContext>();
  TypeArgumentContext typeArgument(int i) =>
      getRuleContext<TypeArgumentContext>(i);
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  TypeArgumentListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeArgumentContext extends ParserRuleContext {
  ReferenceTypeContext referenceType() =>
      getRuleContext<ReferenceTypeContext>(0);
  WildcardContext wildcard() => getRuleContext<WildcardContext>(0);
  TypeArgumentContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class WildcardContext extends ParserRuleContext {
  ...
  AnnotationContext annotation(int i) => getRuleContext<AnnotationContext>(i);
  WildcardBoundsContext wildcardBounds() =>
      getRuleContext<WildcardBoundsContext>(0);
  WildcardContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class WildcardBoundsContext extends ParserRuleContext {
  ...
  WildcardBoundsContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ModuleNameContext extends ParserRuleContext {
  ...
  TerminalNode DOT() => getToken(Java9Parser.TOKEN_DOT, 0);
  ModuleNameContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeNameContext extends ParserRuleContext {
  ...
  PackageOrTypeNameContext packageOrTypeName() =>
      getRuleContext<PackageOrTypeNameContext>(0);
  TerminalNode DOT() => getToken(Java9Parser.TOKEN_DOT, 0);
...
class PackageOrTypeNameContext extends ParserRuleContext {
  ...
  PackageOrTypeNameContext packageOrTypeName() =>
      getRuleContext<PackageOrTypeNameContext>(0);
  TerminalNode DOT() => getToken(Java9Parser.TOKEN_DOT, 0);
  PackageOrTypeNameContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExpressionNameContext extends ParserRuleContext {
  ...
  AmbiguousNameContext ambiguousName() =>
      getRuleContext<AmbiguousNameContext>(0);
  TerminalNode DOT() => getToken(Java9Parser.TOKEN_DOT, 0);
  ExpressionNameContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AmbiguousNameContext extends ParserRuleContext {
  ...
  AmbiguousNameContext ambiguousName() =>
      getRuleContext<AmbiguousNameContext>(0);
  TerminalNode DOT() => getToken(Java9Parser.TOKEN_DOT, 0);
  AmbiguousNameContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class CompilationUnitContext extends ParserRuleContext {
  OrdinaryCompilationContext ordinaryCompilation() =>
      getRuleContext<OrdinaryCompilationContext>(0);
  ModularCompilationContext modularCompilation() =>
      getRuleContext<ModularCompilationContext>(0);
...
class OrdinaryCompilationContext extends ParserRuleContext {
  ...
  PackageDeclarationContext packageDeclaration() =>
      getRuleContext<PackageDeclarationContext>(0);
  List<ImportDeclarationContext> importDeclarations() =>
      getRuleContexts<ImportDeclarationContext>();
  ImportDeclarationContext importDeclaration(int i) =>
      getRuleContext<ImportDeclarationContext>(i);
  List<TypeDeclarationContext> typeDeclarations() =>
      getRuleContexts<TypeDeclarationContext>();
  TypeDeclarationContext typeDeclaration(int i) =>
      getRuleContext<TypeDeclarationContext>(i);
  OrdinaryCompilationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ModularCompilationContext extends ParserRuleContext {
  ModuleDeclarationContext moduleDeclaration() =>
      getRuleContext<ModuleDeclarationContext>(0);
  List<ImportDeclarationContext> importDeclarations() =>
      getRuleContexts<ImportDeclarationContext>();
  ImportDeclarationContext importDeclaration(int i) =>
      getRuleContext<ImportDeclarationContext>(i);
  ModularCompilationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PackageDeclarationContext extends ParserRuleContext {
  ...
  List<PackageModifierContext> packageModifiers() =>
      getRuleContexts<PackageModifierContext>();
  PackageModifierContext packageModifier(int i) =>
      getRuleContext<PackageModifierContext>(i);
  PackageDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PackageModifierContext extends ParserRuleContext {
  AnnotationContext annotation() => getRuleContext<AnnotationContext>(0);
  PackageModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ImportDeclarationContext extends ParserRuleContext {
  SingleTypeImportDeclarationContext singleTypeImportDeclaration() =>
      getRuleContext<SingleTypeImportDeclarationContext>(0);
  TypeImportOnDemandDeclarationContext typeImportOnDemandDeclaration() =>
      getRuleContext<TypeImportOnDemandDeclarationContext>(0);
  SingleStaticImportDeclarationContext singleStaticImportDeclaration() =>
      getRuleContext<SingleStaticImportDeclarationContext>(0);
  StaticImportOnDemandDeclarationContext staticImportOnDemandDeclaration() =>
      getRuleContext<StaticImportOnDemandDeclarationContext>(0);
...
class ModuleDeclarationContext extends ParserRuleContext {
  ...
  List<AnnotationContext> annotations() => getRuleContexts<AnnotationContext>();
  AnnotationContext annotation(int i) => getRuleContext<AnnotationContext>(i);
  List<ModuleDirectiveContext> moduleDirectives() =>
      getRuleContexts<ModuleDirectiveContext>();
  ModuleDirectiveContext moduleDirective(int i) =>
      getRuleContext<ModuleDirectiveContext>(i);
  ModuleDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ModuleDirectiveContext extends ParserRuleContext {
  ...
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
  List<RequiresModifierContext> requiresModifiers() =>
      getRuleContexts<RequiresModifierContext>();
  RequiresModifierContext requiresModifier(int i) =>
      getRuleContext<RequiresModifierContext>(i);
  PackageNameContext packageName() => getRuleContext<PackageNameContext>(0);
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  ...
  ModuleDirectiveContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class RequiresModifierContext extends ParserRuleContext {
  TerminalNode STATIC() => getToken(Java9Parser.TOKEN_STATIC, 0);
  RequiresModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassDeclarationContext extends ParserRuleContext {
  NormalClassDeclarationContext normalClassDeclaration() =>
      getRuleContext<NormalClassDeclarationContext>(0);
  EnumDeclarationContext enumDeclaration() =>
...
class NormalClassDeclarationContext extends ParserRuleContext {
  ...
  List<ClassModifierContext> classModifiers() =>
      getRuleContexts<ClassModifierContext>();
  ClassModifierContext classModifier(int i) =>
      getRuleContext<ClassModifierContext>(i);
  TypeParametersContext typeParameters() =>
      getRuleContext<TypeParametersContext>(0);
  SuperclassContext superclass() => getRuleContext<SuperclassContext>(0);
  SuperinterfacesContext superinterfaces() =>
      getRuleContext<SuperinterfacesContext>(0);
  NormalClassDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassModifierContext extends ParserRuleContext {
  ...
  ClassModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeParametersContext extends ParserRuleContext {
  TerminalNode LT() => getToken(Java9Parser.TOKEN_LT, 0);
  TypeParameterListContext typeParameterList() =>
      getRuleContext<TypeParameterListContext>(0);
  TerminalNode GT() => getToken(Java9Parser.TOKEN_GT, 0);
  TypeParametersContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeParameterListContext extends ParserRuleContext {
  List<TypeParameterContext> typeParameters() =>
      getRuleContexts<TypeParameterContext>();
  TypeParameterContext typeParameter(int i) =>
      getRuleContext<TypeParameterContext>(i);
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  TypeParameterListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SuperclassContext extends ParserRuleContext {
  TerminalNode EXTENDS() => getToken(Java9Parser.TOKEN_EXTENDS, 0);
  ClassTypeContext classType() => getRuleContext<ClassTypeContext>(0);
  SuperclassContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SuperinterfacesContext extends ParserRuleContext {
  ...
  InterfaceTypeListContext interfaceTypeList() =>
      getRuleContext<InterfaceTypeListContext>(0);
  SuperinterfacesContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InterfaceTypeListContext extends ParserRuleContext {
  List<InterfaceTypeContext> interfaceTypes() =>
      getRuleContexts<InterfaceTypeContext>();
  InterfaceTypeContext interfaceType(int i) =>
      getRuleContext<InterfaceTypeContext>(i);
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  InterfaceTypeListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassBodyDeclarationContext extends ParserRuleContext {
  ClassMemberDeclarationContext classMemberDeclaration() =>
      getRuleContext<ClassMemberDeclarationContext>(0);
  InstanceInitializerContext instanceInitializer() =>
      getRuleContext<InstanceInitializerContext>(0);
  StaticInitializerContext staticInitializer() =>
      getRuleContext<StaticInitializerContext>(0);
  ConstructorDeclarationContext constructorDeclaration() =>
...
class ClassMemberDeclarationContext extends ParserRuleContext {
  ...
  InterfaceDeclarationContext interfaceDeclaration() =>
      getRuleContext<InterfaceDeclarationContext>(0);
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
  ClassMemberDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FieldDeclarationContext extends ParserRuleContext {
  ...
  VariableDeclaratorListContext variableDeclaratorList() =>
      getRuleContext<VariableDeclaratorListContext>(0);
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
  List<FieldModifierContext> fieldModifiers() =>
      getRuleContexts<FieldModifierContext>();
  FieldModifierContext fieldModifier(int i) =>
      getRuleContext<FieldModifierContext>(i);
...
class FieldModifierContext extends ParserRuleContext {
  ...
  FieldModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class VariableDeclaratorListContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  VariableDeclaratorListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class VariableDeclaratorContext extends ParserRuleContext {
  VariableDeclaratorIdContext variableDeclaratorId() =>
      getRuleContext<VariableDeclaratorIdContext>(0);
  TerminalNode ASSIGN() => getToken(Java9Parser.TOKEN_ASSIGN, 0);
  VariableInitializerContext variableInitializer() =>
      getRuleContext<VariableInitializerContext>(0);
...
class VariableDeclaratorIdContext extends ParserRuleContext {
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  DimsContext dims() => getRuleContext<DimsContext>(0);
  VariableDeclaratorIdContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class VariableInitializerContext extends ParserRuleContext {
  ...
  VariableInitializerContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnannTypeContext extends ParserRuleContext {
  UnannPrimitiveTypeContext unannPrimitiveType() =>
      getRuleContext<UnannPrimitiveTypeContext>(0);
  UnannReferenceTypeContext unannReferenceType() =>
      getRuleContext<UnannReferenceTypeContext>(0);
  UnannTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnannPrimitiveTypeContext extends ParserRuleContext {
  NumericTypeContext numericType() => getRuleContext<NumericTypeContext>(0);
  TerminalNode BOOLEAN() => getToken(Java9Parser.TOKEN_BOOLEAN, 0);
  UnannPrimitiveTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnannReferenceTypeContext extends ParserRuleContext {
  UnannClassOrInterfaceTypeContext unannClassOrInterfaceType() =>
      getRuleContext<UnannClassOrInterfaceTypeContext>(0);
  UnannTypeVariableContext unannTypeVariable() =>
      getRuleContext<UnannTypeVariableContext>(0);
  UnannArrayTypeContext unannArrayType() =>
      getRuleContext<UnannArrayTypeContext>(0);
  UnannReferenceTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnannClassOrInterfaceTypeContext extends ParserRuleContext {
  UnannClassType_lfno_unannClassOrInterfaceTypeContext
      unannClassType_lfno_unannClassOrInterfaceType() =>
          getRuleContext<UnannClassType_lfno_unannClassOrInterfaceTypeContext>(
              0);
  UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext
      unannInterfaceType_lfno_unannClassOrInterfaceType() => getRuleContext<
          UnannInterfaceType_lfno_unannClassOrInterfaceTypeContext>(0);
  List<UnannClassType_lf_unannClassOrInterfaceTypeContext>
      unannClassType_lf_unannClassOrInterfaceTypes() =>
          getRuleContexts<UnannClassType_lf_unannClassOrInterfaceTypeContext>();
  UnannClassType_lf_unannClassOrInterfaceTypeContext
      unannClassType_lf_unannClassOrInterfaceType(int i) =>
          getRuleContext<UnannClassType_lf_unannClassOrInterfaceTypeContext>(i);
  List<UnannInterfaceType_lf_unannClassOrInterfaceTypeContext>
      unannInterfaceType_lf_unannClassOrInterfaceTypes() => getRuleContexts<
          UnannInterfaceType_lf_unannClassOrInterfaceTypeContext>();
  UnannInterfaceType_lf_unannClassOrInterfaceTypeContext
      unannInterfaceType_lf_unannClassOrInterfaceType(int i) => getRuleContext<
          UnannInterfaceType_lf_unannClassOrInterfaceTypeContext>(i);
...
class UnannClassTypeContext extends ParserRuleContext {
  ...
  List<AnnotationContext> annotations() => getRuleContexts<AnnotationContext>();
  AnnotationContext annotation(int i) => getRuleContext<AnnotationContext>(i);
  UnannClassTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnannInterfaceTypeContext extends ParserRuleContext {
  UnannClassTypeContext unannClassType() =>
      getRuleContext<UnannClassTypeContext>(0);
  UnannInterfaceTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnannInterfaceType_lf_unannClassOrInterfaceTypeContext
  ...
  UnannClassType_lf_unannClassOrInterfaceTypeContext
      unannClassType_lf_unannClassOrInterfaceType() =>
          getRuleContext<UnannClassType_lf_unannClassOrInterfaceTypeContext>(0);
  UnannInterfaceType_lf_unannClassOrInterfaceTypeContext(
      [ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnannTypeVariableContext extends ParserRuleContext {
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  UnannTypeVariableContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnannArrayTypeContext extends ParserRuleContext {
  ...
  UnannTypeVariableContext unannTypeVariable() =>
      getRuleContext<UnannTypeVariableContext>(0);
  UnannArrayTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodDeclarationContext extends ParserRuleContext {
  ...
  List<MethodModifierContext> methodModifiers() =>
      getRuleContexts<MethodModifierContext>();
  MethodModifierContext methodModifier(int i) =>
      getRuleContext<MethodModifierContext>(i);
...
class MethodModifierContext extends ParserRuleContext {
  ...
  TerminalNode STRICTFP() => getToken(Java9Parser.TOKEN_STRICTFP, 0);
  MethodModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodHeaderContext extends ParserRuleContext {
  ...
  MethodDeclaratorContext methodDeclarator() =>
      getRuleContext<MethodDeclaratorContext>(0);
  Throws_Context throws_() => getRuleContext<Throws_Context>(0);
  TypeParametersContext typeParameters() =>
      getRuleContext<TypeParametersContext>(0);
  List<AnnotationContext> annotations() => getRuleContexts<AnnotationContext>();
  AnnotationContext annotation(int i) => getRuleContext<AnnotationContext>(i);
  MethodHeaderContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodDeclaratorContext extends ParserRuleContext {
  ...
  DimsContext dims() => getRuleContext<DimsContext>(0);
  MethodDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FormalParameterListContext extends ParserRuleContext {
  ...
  LastFormalParameterContext lastFormalParameter() =>
      getRuleContext<LastFormalParameterContext>(0);
  ReceiverParameterContext receiverParameter() =>
      getRuleContext<ReceiverParameterContext>(0);
...
class FormalParameterContext extends ParserRuleContext {
  ...
  List<VariableModifierContext> variableModifiers() =>
      getRuleContexts<VariableModifierContext>();
  VariableModifierContext variableModifier(int i) =>
      getRuleContext<VariableModifierContext>(i);
...
class VariableModifierContext extends ParserRuleContext {
  AnnotationContext annotation() => getRuleContext<AnnotationContext>(0);
  TerminalNode FINAL() => getToken(Java9Parser.TOKEN_FINAL, 0);
  VariableModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class LastFormalParameterContext extends ParserRuleContext {
  ...
  AnnotationContext annotation(int i) => getRuleContext<AnnotationContext>(i);
  FormalParameterContext formalParameter() =>
      getRuleContext<FormalParameterContext>(0);
  LastFormalParameterContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ReceiverParameterContext extends ParserRuleContext {
  ...
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  TerminalNode DOT() => getToken(Java9Parser.TOKEN_DOT, 0);
  ReceiverParameterContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class Throws_Context extends ParserRuleContext {
  ...
  ExceptionTypeListContext exceptionTypeList() =>
      getRuleContext<ExceptionTypeListContext>(0);
  Throws_Context([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExceptionTypeListContext extends ParserRuleContext {
  List<ExceptionTypeContext> exceptionTypes() =>
      getRuleContexts<ExceptionTypeContext>();
  ExceptionTypeContext exceptionType(int i) =>
      getRuleContext<ExceptionTypeContext>(i);
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  ExceptionTypeListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExceptionTypeContext extends ParserRuleContext {
  ClassTypeContext classType() => getRuleContext<ClassTypeContext>(0);
  TypeVariableContext typeVariable() => getRuleContext<TypeVariableContext>(0);
  ExceptionTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodBodyContext extends ParserRuleContext {
  ...
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
  MethodBodyContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InstanceInitializerContext extends ParserRuleContext {
  BlockContext block() => getRuleContext<BlockContext>(0);
  InstanceInitializerContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class StaticInitializerContext extends ParserRuleContext {
  TerminalNode STATIC() => getToken(Java9Parser.TOKEN_STATIC, 0);
  BlockContext block() => getRuleContext<BlockContext>(0);
  StaticInitializerContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ConstructorDeclarationContext extends ParserRuleContext {
  ConstructorDeclaratorContext constructorDeclarator() =>
      getRuleContext<ConstructorDeclaratorContext>(0);
  ConstructorBodyContext constructorBody() =>
      getRuleContext<ConstructorBodyContext>(0);
  List<ConstructorModifierContext> constructorModifiers() =>
      getRuleContexts<ConstructorModifierContext>();
  ConstructorModifierContext constructorModifier(int i) =>
      getRuleContext<ConstructorModifierContext>(i);
  Throws_Context throws_() => getRuleContext<Throws_Context>(0);
...
class ConstructorModifierContext extends ParserRuleContext {
  ...
  TerminalNode PROTECTED() => getToken(Java9Parser.TOKEN_PROTECTED, 0);
  TerminalNode PRIVATE() => getToken(Java9Parser.TOKEN_PRIVATE, 0);
  ConstructorModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ConstructorDeclaratorContext extends ParserRuleContext {
  SimpleTypeNameContext simpleTypeName() =>
      getRuleContext<SimpleTypeNameContext>(0);
  TerminalNode LPAREN() => getToken(Java9Parser.TOKEN_LPAREN, 0);
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  TypeParametersContext typeParameters() =>
      getRuleContext<TypeParametersContext>(0);
  FormalParameterListContext formalParameterList() =>
      getRuleContext<FormalParameterListContext>(0);
  ConstructorDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SimpleTypeNameContext extends ParserRuleContext {
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  SimpleTypeNameContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ConstructorBodyContext extends ParserRuleContext {
  ...
  TerminalNode RBRACE() => getToken(Java9Parser.TOKEN_RBRACE, 0);
  ExplicitConstructorInvocationContext explicitConstructorInvocation() =>
      getRuleContext<ExplicitConstructorInvocationContext>(0);
  BlockStatementsContext blockStatements() =>
      getRuleContext<BlockStatementsContext>(0);
  ConstructorBodyContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExplicitConstructorInvocationContext extends ParserRuleContext {
  ...
  TerminalNode SUPER() => getToken(Java9Parser.TOKEN_SUPER, 0);
  ExpressionNameContext expressionName() =>
      getRuleContext<ExpressionNameContext>(0);
  TerminalNode DOT() => getToken(Java9Parser.TOKEN_DOT, 0);
...
class EnumBodyContext extends ParserRuleContext {
  ...
  TerminalNode RBRACE() => getToken(Java9Parser.TOKEN_RBRACE, 0);
  EnumConstantListContext enumConstantList() =>
      getRuleContext<EnumConstantListContext>(0);
  TerminalNode COMMA() => getToken(Java9Parser.TOKEN_COMMA, 0);
  EnumBodyDeclarationsContext enumBodyDeclarations() =>
      getRuleContext<EnumBodyDeclarationsContext>(0);
  EnumBodyContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumConstantListContext extends ParserRuleContext {
  List<EnumConstantContext> enumConstants() =>
      getRuleContexts<EnumConstantContext>();
  EnumConstantContext enumConstant(int i) =>
      getRuleContext<EnumConstantContext>(i);
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  EnumConstantListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumConstantContext extends ParserRuleContext {
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  List<EnumConstantModifierContext> enumConstantModifiers() =>
      getRuleContexts<EnumConstantModifierContext>();
  EnumConstantModifierContext enumConstantModifier(int i) =>
      getRuleContext<EnumConstantModifierContext>(i);
  TerminalNode LPAREN() => getToken(Java9Parser.TOKEN_LPAREN, 0);
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  ClassBodyContext classBody() => getRuleContext<ClassBodyContext>(0);
  ArgumentListContext argumentList() => getRuleContext<ArgumentListContext>(0);
  EnumConstantContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumConstantModifierContext extends ParserRuleContext {
  AnnotationContext annotation() => getRuleContext<AnnotationContext>(0);
  EnumConstantModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumBodyDeclarationsContext extends ParserRuleContext {
  ...
  ClassBodyDeclarationContext classBodyDeclaration(int i) =>
      getRuleContext<ClassBodyDeclarationContext>(i);
  EnumBodyDeclarationsContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InterfaceDeclarationContext extends ParserRuleContext {
  NormalInterfaceDeclarationContext normalInterfaceDeclaration() =>
      getRuleContext<NormalInterfaceDeclarationContext>(0);
  AnnotationTypeDeclarationContext annotationTypeDeclaration() =>
      getRuleContext<AnnotationTypeDeclarationContext>(0);
...
class NormalInterfaceDeclarationContext extends ParserRuleContext {
  ...
  List<InterfaceModifierContext> interfaceModifiers() =>
      getRuleContexts<InterfaceModifierContext>();
  InterfaceModifierContext interfaceModifier(int i) =>
      getRuleContext<InterfaceModifierContext>(i);
  TypeParametersContext typeParameters() =>
      getRuleContext<TypeParametersContext>(0);
  ExtendsInterfacesContext extendsInterfaces() =>
      getRuleContext<ExtendsInterfacesContext>(0);
...
class InterfaceModifierContext extends ParserRuleContext {
  ...
  TerminalNode STATIC() => getToken(Java9Parser.TOKEN_STATIC, 0);
  TerminalNode STRICTFP() => getToken(Java9Parser.TOKEN_STRICTFP, 0);
  InterfaceModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExtendsInterfacesContext extends ParserRuleContext {
  ...
  InterfaceTypeListContext interfaceTypeList() =>
      getRuleContext<InterfaceTypeListContext>(0);
  ExtendsInterfacesContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InterfaceBodyContext extends ParserRuleContext {
  TerminalNode LBRACE() => getToken(Java9Parser.TOKEN_LBRACE, 0);
  TerminalNode RBRACE() => getToken(Java9Parser.TOKEN_RBRACE, 0);
  List<InterfaceMemberDeclarationContext> interfaceMemberDeclarations() =>
      getRuleContexts<InterfaceMemberDeclarationContext>();
  InterfaceMemberDeclarationContext interfaceMemberDeclaration(int i) =>
      getRuleContext<InterfaceMemberDeclarationContext>(i);
...
class InterfaceMemberDeclarationContext extends ParserRuleContext {
  ConstantDeclarationContext constantDeclaration() =>
      getRuleContext<ConstantDeclarationContext>(0);
  InterfaceMethodDeclarationContext interfaceMethodDeclaration() =>
      getRuleContext<InterfaceMethodDeclarationContext>(0);
  ClassDeclarationContext classDeclaration() =>
      getRuleContext<ClassDeclarationContext>(0);
  InterfaceDeclarationContext interfaceDeclaration() =>
      getRuleContext<InterfaceDeclarationContext>(0);
...
class ConstantDeclarationContext extends ParserRuleContext {
  ...
  VariableDeclaratorListContext variableDeclaratorList() =>
      getRuleContext<VariableDeclaratorListContext>(0);
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
  List<ConstantModifierContext> constantModifiers() =>
      getRuleContexts<ConstantModifierContext>();
  ConstantModifierContext constantModifier(int i) =>
      getRuleContext<ConstantModifierContext>(i);
  ConstantDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ConstantModifierContext extends ParserRuleContext {
  ...
  TerminalNode STATIC() => getToken(Java9Parser.TOKEN_STATIC, 0);
  TerminalNode FINAL() => getToken(Java9Parser.TOKEN_FINAL, 0);
  ConstantModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InterfaceMethodDeclarationContext extends ParserRuleContext {
  MethodHeaderContext methodHeader() => getRuleContext<MethodHeaderContext>(0);
  MethodBodyContext methodBody() => getRuleContext<MethodBodyContext>(0);
  List<InterfaceMethodModifierContext> interfaceMethodModifiers() =>
      getRuleContexts<InterfaceMethodModifierContext>();
  InterfaceMethodModifierContext interfaceMethodModifier(int i) =>
      getRuleContext<InterfaceMethodModifierContext>(i);
...
class InterfaceMethodModifierContext extends ParserRuleContext {
  ...
  TerminalNode STATIC() => getToken(Java9Parser.TOKEN_STATIC, 0);
  TerminalNode STRICTFP() => getToken(Java9Parser.TOKEN_STRICTFP, 0);
  InterfaceMethodModifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AnnotationTypeDeclarationContext extends ParserRuleContext {
  ...
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  AnnotationTypeBodyContext annotationTypeBody() =>
      getRuleContext<AnnotationTypeBodyContext>(0);
  List<InterfaceModifierContext> interfaceModifiers() =>
      getRuleContexts<InterfaceModifierContext>();
  InterfaceModifierContext interfaceModifier(int i) =>
      getRuleContext<InterfaceModifierContext>(i);
...
class AnnotationTypeBodyContext extends ParserRuleContext {
  TerminalNode LBRACE() => getToken(Java9Parser.TOKEN_LBRACE, 0);
  TerminalNode RBRACE() => getToken(Java9Parser.TOKEN_RBRACE, 0);
  List<AnnotationTypeMemberDeclarationContext>
      annotationTypeMemberDeclarations() =>
          getRuleContexts<AnnotationTypeMemberDeclarationContext>();
  AnnotationTypeMemberDeclarationContext annotationTypeMemberDeclaration(
          int i) =>
      getRuleContext<AnnotationTypeMemberDeclarationContext>(i);
  AnnotationTypeBodyContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AnnotationTypeMemberDeclarationContext extends ParserRuleContext {
  AnnotationTypeElementDeclarationContext annotationTypeElementDeclaration() =>
      getRuleContext<AnnotationTypeElementDeclarationContext>(0);
  ConstantDeclarationContext constantDeclaration() =>
      getRuleContext<ConstantDeclarationContext>(0);
  ClassDeclarationContext classDeclaration() =>
      getRuleContext<ClassDeclarationContext>(0);
...
class AnnotationTypeElementDeclarationContext extends ParserRuleContext {
  ...
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
  List<AnnotationTypeElementModifierContext> annotationTypeElementModifiers() =>
      getRuleContexts<AnnotationTypeElementModifierContext>();
  AnnotationTypeElementModifierContext annotationTypeElementModifier(int i) =>
      getRuleContext<AnnotationTypeElementModifierContext>(i);
  DimsContext dims() => getRuleContext<DimsContext>(0);
...
class DefaultValueContext extends ParserRuleContext {
  ...
  DefaultValueContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AnnotationContext extends ParserRuleContext {
  NormalAnnotationContext normalAnnotation() =>
      getRuleContext<NormalAnnotationContext>(0);
  MarkerAnnotationContext markerAnnotation() =>
      getRuleContext<MarkerAnnotationContext>(0);
  SingleElementAnnotationContext singleElementAnnotation() =>
      getRuleContext<SingleElementAnnotationContext>(0);
...
class NormalAnnotationContext extends ParserRuleContext {
  ...
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  ElementValuePairListContext elementValuePairList() =>
      getRuleContext<ElementValuePairListContext>(0);
  NormalAnnotationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ElementValuePairListContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  ElementValuePairListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ElementValueContext extends ParserRuleContext {
  ConditionalExpressionContext conditionalExpression() =>
      getRuleContext<ConditionalExpressionContext>(0);
  ElementValueArrayInitializerContext elementValueArrayInitializer() =>
...
class ElementValueArrayInitializerContext extends ParserRuleContext {
  ...
  TerminalNode RBRACE() => getToken(Java9Parser.TOKEN_RBRACE, 0);
  ElementValueListContext elementValueList() =>
      getRuleContext<ElementValueListContext>(0);
  TerminalNode COMMA() => getToken(Java9Parser.TOKEN_COMMA, 0);
...
class ElementValueListContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  ElementValueListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MarkerAnnotationContext extends ParserRuleContext {
  TerminalNode AT() => getToken(Java9Parser.TOKEN_AT, 0);
  TypeNameContext typeName() => getRuleContext<TypeNameContext>(0);
  MarkerAnnotationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SingleElementAnnotationContext extends ParserRuleContext {
  ...
  ElementValueContext elementValue() => getRuleContext<ElementValueContext>(0);
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  SingleElementAnnotationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArrayInitializerContext extends ParserRuleContext {
  ...
  TerminalNode RBRACE() => getToken(Java9Parser.TOKEN_RBRACE, 0);
  VariableInitializerListContext variableInitializerList() =>
      getRuleContext<VariableInitializerListContext>(0);
  TerminalNode COMMA() => getToken(Java9Parser.TOKEN_COMMA, 0);
...
class VariableInitializerListContext extends ParserRuleContext {
  List<VariableInitializerContext> variableInitializers() =>
      getRuleContexts<VariableInitializerContext>();
  VariableInitializerContext variableInitializer(int i) =>
      getRuleContext<VariableInitializerContext>(i);
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  VariableInitializerListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class BlockStatementsContext extends ParserRuleContext {
  List<BlockStatementContext> blockStatements() =>
      getRuleContexts<BlockStatementContext>();
  BlockStatementContext blockStatement(int i) =>
      getRuleContext<BlockStatementContext>(i);
  BlockStatementsContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class BlockStatementContext extends ParserRuleContext {
  ...
  BlockStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class LocalVariableDeclarationContext extends ParserRuleContext {
  ...
  VariableModifierContext variableModifier(int i) =>
      getRuleContext<VariableModifierContext>(i);
  LocalVariableDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class StatementContext extends ParserRuleContext {
  StatementWithoutTrailingSubstatementContext
      statementWithoutTrailingSubstatement() =>
          getRuleContext<StatementWithoutTrailingSubstatementContext>(0);
  LabeledStatementContext labeledStatement() =>
      getRuleContext<LabeledStatementContext>(0);
  IfThenStatementContext ifThenStatement() =>
      getRuleContext<IfThenStatementContext>(0);
  IfThenElseStatementContext ifThenElseStatement() =>
      getRuleContext<IfThenElseStatementContext>(0);
  WhileStatementContext whileStatement() =>
...
class StatementNoShortIfContext extends ParserRuleContext {
  StatementWithoutTrailingSubstatementContext
      statementWithoutTrailingSubstatement() =>
          getRuleContext<StatementWithoutTrailingSubstatementContext>(0);
  LabeledStatementNoShortIfContext labeledStatementNoShortIf() =>
      getRuleContext<LabeledStatementNoShortIfContext>(0);
  IfThenElseStatementNoShortIfContext ifThenElseStatementNoShortIf() =>
      getRuleContext<IfThenElseStatementNoShortIfContext>(0);
  WhileStatementNoShortIfContext whileStatementNoShortIf() =>
      getRuleContext<WhileStatementNoShortIfContext>(0);
  ForStatementNoShortIfContext forStatementNoShortIf() =>
      getRuleContext<ForStatementNoShortIfContext>(0);
  StatementNoShortIfContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class StatementWithoutTrailingSubstatementContext extends ParserRuleContext {
  ...
  AssertStatementContext assertStatement() =>
      getRuleContext<AssertStatementContext>(0);
  SwitchStatementContext switchStatement() =>
...
class LabeledStatementNoShortIfContext extends ParserRuleContext {
  ...
  TerminalNode COLON() => getToken(Java9Parser.TOKEN_COLON, 0);
  StatementNoShortIfContext statementNoShortIf() =>
      getRuleContext<StatementNoShortIfContext>(0);
...
class ExpressionStatementContext extends ParserRuleContext {
  StatementExpressionContext statementExpression() =>
      getRuleContext<StatementExpressionContext>(0);
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
...
class StatementExpressionContext extends ParserRuleContext {
  ...
  PreIncrementExpressionContext preIncrementExpression() =>
      getRuleContext<PreIncrementExpressionContext>(0);
  PreDecrementExpressionContext preDecrementExpression() =>
      getRuleContext<PreDecrementExpressionContext>(0);
  PostIncrementExpressionContext postIncrementExpression() =>
      getRuleContext<PostIncrementExpressionContext>(0);
  PostDecrementExpressionContext postDecrementExpression() =>
      getRuleContext<PostDecrementExpressionContext>(0);
  MethodInvocationContext methodInvocation() =>
      getRuleContext<MethodInvocationContext>(0);
  ClassInstanceCreationExpressionContext classInstanceCreationExpression() =>
      getRuleContext<ClassInstanceCreationExpressionContext>(0);
  StatementExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class IfThenStatementContext extends ParserRuleContext {
  ...
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  StatementContext statement() => getRuleContext<StatementContext>(0);
  IfThenStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class IfThenElseStatementContext extends ParserRuleContext {
  ...
  StatementContext statement() => getRuleContext<StatementContext>(0);
  IfThenElseStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class IfThenElseStatementNoShortIfContext extends ParserRuleContext {
  ...
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  List<StatementNoShortIfContext> statementNoShortIfs() =>
      getRuleContexts<StatementNoShortIfContext>();
  StatementNoShortIfContext statementNoShortIf(int i) =>
      getRuleContext<StatementNoShortIfContext>(i);
  TerminalNode ELSE() => getToken(Java9Parser.TOKEN_ELSE, 0);
...
class AssertStatementContext extends ParserRuleContext {
  ...
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
  TerminalNode COLON() => getToken(Java9Parser.TOKEN_COLON, 0);
  AssertStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SwitchBlockContext extends ParserRuleContext {
  TerminalNode LBRACE() => getToken(Java9Parser.TOKEN_LBRACE, 0);
  TerminalNode RBRACE() => getToken(Java9Parser.TOKEN_RBRACE, 0);
  List<SwitchBlockStatementGroupContext> switchBlockStatementGroups() =>
      getRuleContexts<SwitchBlockStatementGroupContext>();
  SwitchBlockStatementGroupContext switchBlockStatementGroup(int i) =>
      getRuleContext<SwitchBlockStatementGroupContext>(i);
...
class SwitchLabelsContext extends ParserRuleContext {
  ...
  SwitchLabelContext switchLabel(int i) =>
      getRuleContext<SwitchLabelContext>(i);
  SwitchLabelsContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SwitchLabelContext extends ParserRuleContext {
  ...
  TerminalNode COLON() => getToken(Java9Parser.TOKEN_COLON, 0);
  EnumConstantNameContext enumConstantName() =>
      getRuleContext<EnumConstantNameContext>(0);
  TerminalNode DEFAULT() => getToken(Java9Parser.TOKEN_DEFAULT, 0);
...
class EnumConstantNameContext extends ParserRuleContext {
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  EnumConstantNameContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class WhileStatementNoShortIfContext extends ParserRuleContext {
  ...
  StatementNoShortIfContext statementNoShortIf() =>
      getRuleContext<StatementNoShortIfContext>(0);
  WhileStatementNoShortIfContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ForStatementContext extends ParserRuleContext {
  BasicForStatementContext basicForStatement() =>
      getRuleContext<BasicForStatementContext>(0);
  EnhancedForStatementContext enhancedForStatement() =>
      getRuleContext<EnhancedForStatementContext>(0);
...
class ForStatementNoShortIfContext extends ParserRuleContext {
  BasicForStatementNoShortIfContext basicForStatementNoShortIf() =>
      getRuleContext<BasicForStatementNoShortIfContext>(0);
  EnhancedForStatementNoShortIfContext enhancedForStatementNoShortIf() =>
      getRuleContext<EnhancedForStatementNoShortIfContext>(0);
  ForStatementNoShortIfContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class BasicForStatementContext extends ParserRuleContext {
  ...
  BasicForStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ForInitContext extends ParserRuleContext {
  StatementExpressionListContext statementExpressionList() =>
      getRuleContext<StatementExpressionListContext>(0);
  LocalVariableDeclarationContext localVariableDeclaration() =>
      getRuleContext<LocalVariableDeclarationContext>(0);
...
class StatementExpressionListContext extends ParserRuleContext {
  List<StatementExpressionContext> statementExpressions() =>
      getRuleContexts<StatementExpressionContext>();
  StatementExpressionContext statementExpression(int i) =>
      getRuleContext<StatementExpressionContext>(i);
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  StatementExpressionListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnhancedForStatementContext extends ParserRuleContext {
  ...
  VariableModifierContext variableModifier(int i) =>
      getRuleContext<VariableModifierContext>(i);
  EnhancedForStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TryStatementContext extends ParserRuleContext {
  ...
  TryWithResourcesStatementContext tryWithResourcesStatement() =>
      getRuleContext<TryWithResourcesStatementContext>(0);
...
class CatchesContext extends ParserRuleContext {
  ...
  CatchesContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class CatchClauseContext extends ParserRuleContext {
  ...
  TerminalNode LPAREN() => getToken(Java9Parser.TOKEN_LPAREN, 0);
  CatchFormalParameterContext catchFormalParameter() =>
      getRuleContext<CatchFormalParameterContext>(0);
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  BlockContext block() => getRuleContext<BlockContext>(0);
...
class CatchFormalParameterContext extends ParserRuleContext {
  ...
  VariableModifierContext variableModifier(int i) =>
      getRuleContext<VariableModifierContext>(i);
  CatchFormalParameterContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class CatchTypeContext extends ParserRuleContext {
  ...
  CatchTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class Finally_Context extends ParserRuleContext {
  ...
  BlockContext block() => getRuleContext<BlockContext>(0);
  Finally_Context([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TryWithResourcesStatementContext extends ParserRuleContext {
  TerminalNode TRY() => getToken(Java9Parser.TOKEN_TRY, 0);
  ResourceSpecificationContext resourceSpecification() =>
      getRuleContext<ResourceSpecificationContext>(0);
  BlockContext block() => getRuleContext<BlockContext>(0);
  CatchesContext catches() => getRuleContext<CatchesContext>(0);
  Finally_Context finally_() => getRuleContext<Finally_Context>(0);
...
class ResourceSpecificationContext extends ParserRuleContext {
  ...
  TerminalNode RPAREN() => getToken(Java9Parser.TOKEN_RPAREN, 0);
  TerminalNode SEMI() => getToken(Java9Parser.TOKEN_SEMI, 0);
  ResourceSpecificationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ResourceContext extends ParserRuleContext {
  ...
  VariableModifierContext variableModifier(int i) =>
      getRuleContext<VariableModifierContext>(i);
  VariableAccessContext variableAccess() =>
      getRuleContext<VariableAccessContext>(0);
  ResourceContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class VariableAccessContext extends ParserRuleContext {
  ...
  VariableAccessContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PrimaryContext extends ParserRuleContext {
  PrimaryNoNewArray_lfno_primaryContext primaryNoNewArray_lfno_primary() =>
      getRuleContext<PrimaryNoNewArray_lfno_primaryContext>(0);
  ArrayCreationExpressionContext arrayCreationExpression() =>
      getRuleContext<ArrayCreationExpressionContext>(0);
  List<PrimaryNoNewArray_lf_primaryContext> primaryNoNewArray_lf_primarys() =>
      getRuleContexts<PrimaryNoNewArray_lf_primaryContext>();
  PrimaryNoNewArray_lf_primaryContext primaryNoNewArray_lf_primary(int i) =>
      getRuleContext<PrimaryNoNewArray_lf_primaryContext>(i);
...
class PrimaryNoNewArrayContext extends ParserRuleContext {
  ...
  MethodInvocationContext methodInvocation() =>
      getRuleContext<MethodInvocationContext>(0);
  MethodReferenceContext methodReference() =>
      getRuleContext<MethodReferenceContext>(0);
  PrimaryNoNewArrayContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PrimaryNoNewArray_lf_primaryContext extends ParserRuleContext {
  ClassInstanceCreationExpression_lf_primaryContext
      classInstanceCreationExpression_lf_primary() =>
          getRuleContext<ClassInstanceCreationExpression_lf_primaryContext>(0);
  FieldAccess_lf_primaryContext fieldAccess_lf_primary() =>
      getRuleContext<FieldAccess_lf_primaryContext>(0);
  ArrayAccess_lf_primaryContext arrayAccess_lf_primary() =>
      getRuleContext<ArrayAccess_lf_primaryContext>(0);
  MethodInvocation_lf_primaryContext methodInvocation_lf_primary() =>
      getRuleContext<MethodInvocation_lf_primaryContext>(0);
  MethodReference_lf_primaryContext methodReference_lf_primary() =>
      getRuleContext<MethodReference_lf_primaryContext>(0);
  ...
  ClassInstanceCreationExpression_lfno_primaryContext
      classInstanceCreationExpression_lfno_primary() =>
          getRuleContext<ClassInstanceCreationExpression_lfno_primaryContext>(
              0);
  FieldAccess_lfno_primaryContext fieldAccess_lfno_primary() =>
      getRuleContext<FieldAccess_lfno_primaryContext>(0);
  ArrayAccess_lfno_primaryContext arrayAccess_lfno_primary() =>
      getRuleContext<ArrayAccess_lfno_primaryContext>(0);
  MethodInvocation_lfno_primaryContext methodInvocation_lfno_primary() =>
      getRuleContext<MethodInvocation_lfno_primaryContext>(0);
  MethodReference_lfno_primaryContext methodReference_lfno_primary() =>
      getRuleContext<MethodReference_lfno_primaryContext>(0);
...
class PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext
  ...
  void enterRule(ParseTreeListener listener) {
    if (listener is Java9Listener)
      listener.enterPrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary(
          this);
  }
...
class ClassLiteralContext extends ParserRuleContext {
  ...
  TerminalNode RBRACK(int i) => getToken(Java9Parser.TOKEN_RBRACK, i);
  TerminalNode VOID() => getToken(Java9Parser.TOKEN_VOID, 0);
  ClassLiteralContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassInstanceCreationExpressionContext extends ParserRuleContext {
  ...
  TypeArgumentsOrDiamondContext typeArgumentsOrDiamond() =>
      getRuleContext<TypeArgumentsOrDiamondContext>(0);
  ArgumentListContext argumentList() => getRuleContext<ArgumentListContext>(0);
  ClassBodyContext classBody() => getRuleContext<ClassBodyContext>(0);
  ExpressionNameContext expressionName() =>
      getRuleContext<ExpressionNameContext>(0);
...
class TypeArgumentsOrDiamondContext extends ParserRuleContext {
  ...
  TerminalNode LT() => getToken(Java9Parser.TOKEN_LT, 0);
  TerminalNode GT() => getToken(Java9Parser.TOKEN_GT, 0);
  TypeArgumentsOrDiamondContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FieldAccessContext extends ParserRuleContext {
  ...
  TerminalNode SUPER() => getToken(Java9Parser.TOKEN_SUPER, 0);
  TypeNameContext typeName() => getRuleContext<TypeNameContext>(0);
  FieldAccessContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FieldAccess_lf_primaryContext extends ParserRuleContext {
  TerminalNode DOT() => getToken(Java9Parser.TOKEN_DOT, 0);
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  FieldAccess_lf_primaryContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FieldAccess_lfno_primaryContext extends ParserRuleContext {
  ...
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  TypeNameContext typeName() => getRuleContext<TypeNameContext>(0);
  FieldAccess_lfno_primaryContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArrayAccessContext extends ParserRuleContext {
  ...
  PrimaryNoNewArray_lfno_arrayAccessContext
      primaryNoNewArray_lfno_arrayAccess() =>
          getRuleContext<PrimaryNoNewArray_lfno_arrayAccessContext>(0);
  List<PrimaryNoNewArray_lf_arrayAccessContext>
      primaryNoNewArray_lf_arrayAccesss() =>
          getRuleContexts<PrimaryNoNewArray_lf_arrayAccessContext>();
  PrimaryNoNewArray_lf_arrayAccessContext primaryNoNewArray_lf_arrayAccess(
          int i) =>
      getRuleContext<PrimaryNoNewArray_lf_arrayAccessContext>(i);
  ArrayAccessContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArrayAccess_lf_primaryContext extends ParserRuleContext {
  PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext
      primaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primary() =>
          getRuleContext<
              PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primaryContext>(0);
  List<TerminalNode> LBRACKs() => getTokens(Java9Parser.TOKEN_LBRACK);
  TerminalNode LBRACK(int i) => getToken(Java9Parser.TOKEN_LBRACK, i);
  List<ExpressionContext> expressions() => getRuleContexts<ExpressionContext>();
  ExpressionContext expression(int i) => getRuleContext<ExpressionContext>(i);
  List<TerminalNode> RBRACKs() => getTokens(Java9Parser.TOKEN_RBRACK);
  TerminalNode RBRACK(int i) => getToken(Java9Parser.TOKEN_RBRACK, i);
  List<PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext>
      primaryNoNewArray_lf_primary_lf_arrayAccess_lf_primarys() =>
          getRuleContexts<
              PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext>();
  PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext
      primaryNoNewArray_lf_primary_lf_arrayAccess_lf_primary(int i) =>
          getRuleContext<
              PrimaryNoNewArray_lf_primary_lf_arrayAccess_lf_primaryContext>(i);
  ArrayAccess_lf_primaryContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArrayAccess_lfno_primaryContext extends ParserRuleContext {
  ...
  PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext
      primaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary() =>
          getRuleContext<
              PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primaryContext>(0);
  List<PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext>
      primaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primarys() =>
          getRuleContexts<
              PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext>();
  PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext
      primaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primary(int i) =>
          getRuleContext<
              PrimaryNoNewArray_lfno_primary_lf_arrayAccess_lfno_primaryContext>(i);
  ArrayAccess_lfno_primaryContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodInvocationContext extends ParserRuleContext {
  ...
  PrimaryContext primary() => getRuleContext<PrimaryContext>(0);
  TerminalNode SUPER() => getToken(Java9Parser.TOKEN_SUPER, 0);
  MethodInvocationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArgumentListContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(Java9Parser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(Java9Parser.TOKEN_COMMA, i);
  ArgumentListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodReferenceContext extends ParserRuleContext {
  ...
  TerminalNode NEW() => getToken(Java9Parser.TOKEN_NEW, 0);
  ArrayTypeContext arrayType() => getRuleContext<ArrayTypeContext>(0);
  MethodReferenceContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArrayCreationExpressionContext extends ParserRuleContext {
  ...
  ArrayInitializerContext arrayInitializer() =>
      getRuleContext<ArrayInitializerContext>(0);
  ArrayCreationExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DimExprsContext extends ParserRuleContext {
  ...
  DimExprsContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DimExprContext extends ParserRuleContext {
  ...
  List<AnnotationContext> annotations() => getRuleContexts<AnnotationContext>();
  AnnotationContext annotation(int i) => getRuleContext<AnnotationContext>(i);
  DimExprContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExpressionContext extends ParserRuleContext {
  LambdaExpressionContext lambdaExpression() =>
      getRuleContext<LambdaExpressionContext>(0);
  AssignmentExpressionContext assignmentExpression() =>
      getRuleContext<AssignmentExpressionContext>(0);
...
class LambdaParametersContext extends ParserRuleContext {
  ...
  FormalParameterListContext formalParameterList() =>
      getRuleContext<FormalParameterListContext>(0);
  InferredFormalParameterListContext inferredFormalParameterList() =>
      getRuleContext<InferredFormalParameterListContext>(0);
  LambdaParametersContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class LambdaBodyContext extends ParserRuleContext {
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  BlockContext block() => getRuleContext<BlockContext>(0);
  LambdaBodyContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AssignmentExpressionContext extends ParserRuleContext {
  ConditionalExpressionContext conditionalExpression() =>
      getRuleContext<ConditionalExpressionContext>(0);
  AssignmentContext assignment() => getRuleContext<AssignmentContext>(0);
  AssignmentExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class LeftHandSideContext extends ParserRuleContext {
  ...
  FieldAccessContext fieldAccess() => getRuleContext<FieldAccessContext>(0);
  ArrayAccessContext arrayAccess() => getRuleContext<ArrayAccessContext>(0);
  LeftHandSideContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AssignmentOperatorContext extends ParserRuleContext {
  ...
  TerminalNode URSHIFT_ASSIGN() =>
      getToken(Java9Parser.TOKEN_URSHIFT_ASSIGN, 0);
...
class ConditionalExpressionContext extends ParserRuleContext {
  ConditionalOrExpressionContext conditionalOrExpression() =>
      getRuleContext<ConditionalOrExpressionContext>(0);
  TerminalNode QUESTION() => getToken(Java9Parser.TOKEN_QUESTION, 0);
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  TerminalNode COLON() => getToken(Java9Parser.TOKEN_COLON, 0);
  ConditionalExpressionContext conditionalExpression() =>
  ...
  LambdaExpressionContext lambdaExpression() =>
      getRuleContext<LambdaExpressionContext>(0);
  ConditionalExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ConditionalOrExpressionContext extends ParserRuleContext {
  ConditionalAndExpressionContext conditionalAndExpression() =>
      getRuleContext<ConditionalAndExpressionContext>(0);
  ConditionalOrExpressionContext conditionalOrExpression() =>
      getRuleContext<ConditionalOrExpressionContext>(0);
  TerminalNode OR() => getToken(Java9Parser.TOKEN_OR, 0);
  ConditionalOrExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ConditionalAndExpressionContext extends ParserRuleContext {
  InclusiveOrExpressionContext inclusiveOrExpression() =>
      getRuleContext<InclusiveOrExpressionContext>(0);
  ConditionalAndExpressionContext conditionalAndExpression() =>
      getRuleContext<ConditionalAndExpressionContext>(0);
  TerminalNode AND() => getToken(Java9Parser.TOKEN_AND, 0);
  ConditionalAndExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InclusiveOrExpressionContext extends ParserRuleContext {
  ExclusiveOrExpressionContext exclusiveOrExpression() =>
      getRuleContext<ExclusiveOrExpressionContext>(0);
  InclusiveOrExpressionContext inclusiveOrExpression() =>
      getRuleContext<InclusiveOrExpressionContext>(0);
  TerminalNode BITOR() => getToken(Java9Parser.TOKEN_BITOR, 0);
  InclusiveOrExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExclusiveOrExpressionContext extends ParserRuleContext {
  AndExpressionContext andExpression() =>
      getRuleContext<AndExpressionContext>(0);
  ExclusiveOrExpressionContext exclusiveOrExpression() =>
      getRuleContext<ExclusiveOrExpressionContext>(0);
  TerminalNode CARET() => getToken(Java9Parser.TOKEN_CARET, 0);
  ExclusiveOrExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AndExpressionContext extends ParserRuleContext {
  EqualityExpressionContext equalityExpression() =>
      getRuleContext<EqualityExpressionContext>(0);
  AndExpressionContext andExpression() =>
      getRuleContext<AndExpressionContext>(0);
  TerminalNode BITAND() => getToken(Java9Parser.TOKEN_BITAND, 0);
  AndExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EqualityExpressionContext extends ParserRuleContext {
  RelationalExpressionContext relationalExpression() =>
      getRuleContext<RelationalExpressionContext>(0);
  EqualityExpressionContext equalityExpression() =>
      getRuleContext<EqualityExpressionContext>(0);
  TerminalNode EQUAL() => getToken(Java9Parser.TOKEN_EQUAL, 0);
  TerminalNode NOTEQUAL() => getToken(Java9Parser.TOKEN_NOTEQUAL, 0);
  EqualityExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class RelationalExpressionContext extends ParserRuleContext {
  ShiftExpressionContext shiftExpression() =>
      getRuleContext<ShiftExpressionContext>(0);
  RelationalExpressionContext relationalExpression() =>
      getRuleContext<RelationalExpressionContext>(0);
  TerminalNode LT() => getToken(Java9Parser.TOKEN_LT, 0);
  TerminalNode GT() => getToken(Java9Parser.TOKEN_GT, 0);
  ...
  ReferenceTypeContext referenceType() =>
      getRuleContext<ReferenceTypeContext>(0);
  RelationalExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ShiftExpressionContext extends ParserRuleContext {
  AdditiveExpressionContext additiveExpression() =>
      getRuleContext<AdditiveExpressionContext>(0);
  ShiftExpressionContext shiftExpression() =>
      getRuleContext<ShiftExpressionContext>(0);
  ...
  ShiftExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AdditiveExpressionContext extends ParserRuleContext {
  MultiplicativeExpressionContext multiplicativeExpression() =>
      getRuleContext<MultiplicativeExpressionContext>(0);
  AdditiveExpressionContext additiveExpression() =>
      getRuleContext<AdditiveExpressionContext>(0);
  TerminalNode ADD() => getToken(Java9Parser.TOKEN_ADD, 0);
  TerminalNode SUB() => getToken(Java9Parser.TOKEN_SUB, 0);
  AdditiveExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MultiplicativeExpressionContext extends ParserRuleContext {
  ...
  MultiplicativeExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnaryExpressionContext extends ParserRuleContext {
  ...
  TerminalNode SUB() => getToken(Java9Parser.TOKEN_SUB, 0);
  UnaryExpressionNotPlusMinusContext unaryExpressionNotPlusMinus() =>
      getRuleContext<UnaryExpressionNotPlusMinusContext>(0);
...
class PreIncrementExpressionContext extends ParserRuleContext {
  ...
  UnaryExpressionContext unaryExpression() =>
      getRuleContext<UnaryExpressionContext>(0);
  PreIncrementExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PreDecrementExpressionContext extends ParserRuleContext {
  ...
  UnaryExpressionContext unaryExpression() =>
      getRuleContext<UnaryExpressionContext>(0);
  PreDecrementExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PostfixExpressionContext extends ParserRuleContext {
  ...
  ExpressionNameContext expressionName() =>
      getRuleContext<ExpressionNameContext>(0);
  List<PostIncrementExpression_lf_postfixExpressionContext>
      postIncrementExpression_lf_postfixExpressions() => getRuleContexts<
          PostIncrementExpression_lf_postfixExpressionContext>();
  PostIncrementExpression_lf_postfixExpressionContext
      postIncrementExpression_lf_postfixExpression(int i) =>
          getRuleContext<PostIncrementExpression_lf_postfixExpressionContext>(
              i);
  List<PostDecrementExpression_lf_postfixExpressionContext>
      postDecrementExpression_lf_postfixExpressions() => getRuleContexts<
          PostDecrementExpression_lf_postfixExpressionContext>();
  PostDecrementExpression_lf_postfixExpressionContext
      postDecrementExpression_lf_postfixExpression(int i) =>
          getRuleContext<PostDecrementExpression_lf_postfixExpressionContext>(
              i);
...
class PostIncrementExpressionContext extends ParserRuleContext {
  PostfixExpressionContext postfixExpression() =>
      getRuleContext<PostfixExpressionContext>(0);
  TerminalNode INC() => getToken(Java9Parser.TOKEN_INC, 0);
  PostIncrementExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PostDecrementExpressionContext extends ParserRuleContext {
  PostfixExpressionContext postfixExpression() =>
      getRuleContext<PostfixExpressionContext>(0);
  TerminalNode DEC() => getToken(Java9Parser.TOKEN_DEC, 0);
  PostDecrementExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override

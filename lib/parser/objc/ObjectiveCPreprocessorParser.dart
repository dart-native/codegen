...
const int RULE_directive = 0, RULE_directiveText = 1, RULE_preprocessorExpression = 2;
class ObjectiveCPreprocessorParser extends Parser {
  ...
  DirectiveContext directive() {
    ...
    try {
      ...
      case 1:
        ...
        if (!(_la == TOKEN_DIRECTIVE_IMPORT || _la == TOKEN_DIRECTIVE_INCLUDE)) {
      ...
      case 12:
        ...
        errorHandler.sync(this);
        _la = tokenStream.LA(1);
        if (_la == TOKEN_DIRECTIVE_TEXT_NEWLINE || _la == TOKEN_DIRECTIVE_TEXT) {
          state = 40;
          directiveText();
        }
  ...
  DirectiveTextContext directiveText() {
    ...
    try {
      ...
      do {
        ...
        errorHandler.sync(this);
        _la = tokenStream.LA(1);
      } while (_la == TOKEN_DIRECTIVE_TEXT_NEWLINE || _la == TOKEN_DIRECTIVE_TEXT);
    } on RecognitionException catch (re) {
      _localctx.exception = re;
      errorHandler.reportError(this, re);
      errorHandler.recover(this, re);
    ...
    try {
      ...
      while (_alt != 2 && _alt != ATN.INVALID_ALT_NUMBER) {
        if (_alt == 1) {
          ...
          case 1:
            _localctx = PreprocessorBinaryContext(new PreprocessorExpressionContext(_parentctx, _parentState));
            ...
            _la = tokenStream.LA(1);
            if (!(_la == TOKEN_DIRECTIVE_EQUAL || _la == TOKEN_DIRECTIVE_NOTEQUAL)) {
          ...
          case 4:
            ...
            _localctx.op = tokenStream.LT(1);
            _la = tokenStream.LA(1);
            if (!(((((_la - 221)) & ~0x3f) == 0 && ((BigInt.one << (_la - 221)) & ((BigInt.one << (TOKEN_DIRECTIVE_LT - 221)) | (BigInt.one << (TOKEN_DIRECTIVE_GT - 221)) | (BigInt.one << (TOKEN_DIRECTIVE_LE - 221)) | (BigInt.one << (TOKEN_DIRECTIVE_GE - 221)))) != BigInt.zero))) {
              _localctx.op = errorHandler.recoverInline(this);
            } else {
              if ( tokenStream.LA(1)==IntStream.EOF ) matchedEOF = true;
              errorHandler.reportMatch(this);
  ...
  bool _preprocessorExpression_sempred(PreprocessorExpressionContext _localctx, int predIndex) {
    switch (predIndex) {
...
class DirectiveTextContext extends ParserRuleContext {
  List<TerminalNode> DIRECTIVE_TEXTs() => getTokens(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_TEXT);
  TerminalNode DIRECTIVE_TEXT(int i) => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_TEXT, i);
  List<TerminalNode> DIRECTIVE_TEXT_NEWLINEs() => getTokens(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_TEXT_NEWLINE);
  TerminalNode DIRECTIVE_TEXT_NEWLINE(int i) => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_TEXT_NEWLINE, i);
  DirectiveTextContext([ParserRuleContext parent, int invokingState]) : super(parent, invokingState);
  @override
  int get ruleIndex => RULE_directiveText;
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterDirectiveText(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitDirectiveText(this);
  }
}

class PreprocessorExpressionContext extends ParserRuleContext {
  PreprocessorExpressionContext([ParserRuleContext parent, int invokingState]) : super(parent, invokingState);
  @override
...
class PreprocessorDefContext extends DirectiveContext {
  ...
  TerminalNode DIRECTIVE_IFDEF() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_IFDEF, 0);
  TerminalNode DIRECTIVE_ID() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_ID, 0);
  TerminalNode DIRECTIVE_IFNDEF() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_IFNDEF, 0);
  TerminalNode DIRECTIVE_UNDEF() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_UNDEF, 0);
  PreprocessorDefContext(DirectiveContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorDef(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorDef(this);
  }
}

class PreprocessorErrorContext extends DirectiveContext {
  TerminalNode SHARP() => getToken(ObjectiveCPreprocessorParser.TOKEN_SHARP, 0);
  TerminalNode DIRECTIVE_ERROR() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_ERROR, 0);
  DirectiveTextContext directiveText() => getRuleContext<DirectiveTextContext>(0);
  PreprocessorErrorContext(DirectiveContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorError(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorError(this);
  }
}

class PreprocessorConditionalContext extends DirectiveContext {
  TerminalNode SHARP() => getToken(ObjectiveCPreprocessorParser.TOKEN_SHARP, 0);
  TerminalNode DIRECTIVE_IF() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_IF, 0);
  PreprocessorExpressionContext preprocessorExpression() => getRuleContext<PreprocessorExpressionContext>(0);
  TerminalNode DIRECTIVE_ELIF() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_ELIF, 0);
  TerminalNode DIRECTIVE_ELSE() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_ELSE, 0);
  TerminalNode DIRECTIVE_ENDIF() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_ENDIF, 0);
  PreprocessorConditionalContext(DirectiveContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorConditional(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorConditional(this);
  }
}
...
class PreprocessorImportContext extends DirectiveContext {
  TerminalNode SHARP() => getToken(ObjectiveCPreprocessorParser.TOKEN_SHARP, 0);
  DirectiveTextContext directiveText() => getRuleContext<DirectiveTextContext>(0);
  TerminalNode DIRECTIVE_IMPORT() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_IMPORT, 0);
  TerminalNode DIRECTIVE_INCLUDE() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_INCLUDE, 0);
  PreprocessorImportContext(DirectiveContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorImport(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorImport(this);
  }
}

class PreprocessorPragmaContext extends DirectiveContext {
  TerminalNode SHARP() => getToken(ObjectiveCPreprocessorParser.TOKEN_SHARP, 0);
  TerminalNode DIRECTIVE_PRAGMA() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_PRAGMA, 0);
  DirectiveTextContext directiveText() => getRuleContext<DirectiveTextContext>(0);
  PreprocessorPragmaContext(DirectiveContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorPragma(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorPragma(this);
  }
}

class PreprocessorDefineContext extends DirectiveContext {
  TerminalNode SHARP() => getToken(ObjectiveCPreprocessorParser.TOKEN_SHARP, 0);
  TerminalNode DIRECTIVE_DEFINE() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_DEFINE, 0);
  TerminalNode DIRECTIVE_ID() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_ID, 0);
  DirectiveTextContext directiveText() => getRuleContext<DirectiveTextContext>(0);
  PreprocessorDefineContext(DirectiveContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorDefine(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorDefine(this);
  }
}

class PreprocessorWarningContext extends DirectiveContext {
  TerminalNode SHARP() => getToken(ObjectiveCPreprocessorParser.TOKEN_SHARP, 0);
  TerminalNode DIRECTIVE_WARNING() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_WARNING, 0);
  DirectiveTextContext directiveText() => getRuleContext<DirectiveTextContext>(0);
  PreprocessorWarningContext(DirectiveContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorWarning(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorWarning(this);
  }
}class PreprocessorParenthesisContext extends PreprocessorExpressionContext {
  TerminalNode DIRECTIVE_LP() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_LP, 0);
  PreprocessorExpressionContext preprocessorExpression() => getRuleContext<PreprocessorExpressionContext>(0);
  TerminalNode DIRECTIVE_RP() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_RP, 0);
  PreprocessorParenthesisContext(PreprocessorExpressionContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorParenthesis(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorParenthesis(this);
  }
}

class PreprocessorNotContext extends PreprocessorExpressionContext {
  TerminalNode DIRECTIVE_BANG() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_BANG, 0);
  PreprocessorExpressionContext preprocessorExpression() => getRuleContext<PreprocessorExpressionContext>(0);
  PreprocessorNotContext(PreprocessorExpressionContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorNot(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorNot(this);
  }
}

class PreprocessorBinaryContext extends PreprocessorExpressionContext {
  Token op;
  List<PreprocessorExpressionContext> preprocessorExpressions() => getRuleContexts<PreprocessorExpressionContext>();
  PreprocessorExpressionContext preprocessorExpression(int i) => getRuleContext<PreprocessorExpressionContext>(i);
  TerminalNode DIRECTIVE_EQUAL() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_EQUAL, 0);
  TerminalNode DIRECTIVE_NOTEQUAL() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_NOTEQUAL, 0);
  TerminalNode DIRECTIVE_AND() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_AND, 0);
  TerminalNode DIRECTIVE_OR() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_OR, 0);
  TerminalNode DIRECTIVE_LT() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_LT, 0);
  TerminalNode DIRECTIVE_GT() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_GT, 0);
  TerminalNode DIRECTIVE_LE() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_LE, 0);
  TerminalNode DIRECTIVE_GE() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_GE, 0);
  PreprocessorBinaryContext(PreprocessorExpressionContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorBinary(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorBinary(this);
  }
}

class PreprocessorConstantContext extends PreprocessorExpressionContext {
  TerminalNode DIRECTIVE_TRUE() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_TRUE, 0);
  TerminalNode DIRECTIVE_FALSE() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_FALSE, 0);
  TerminalNode DIRECTIVE_DECIMAL_LITERAL() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_DECIMAL_LITERAL, 0);
  TerminalNode DIRECTIVE_STRING() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_STRING, 0);
  PreprocessorConstantContext(PreprocessorExpressionContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorConstant(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorConstant(this);
  }
}
...
class PreprocessorConditionalSymbolContext extends PreprocessorExpressionContext {
  ...
  PreprocessorExpressionContext preprocessorExpression() => getRuleContext<PreprocessorExpressionContext>(0);
  TerminalNode DIRECTIVE_RP() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_RP, 0);
  PreprocessorConditionalSymbolContext(PreprocessorExpressionContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorConditionalSymbol(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorConditionalSymbol(this);
  }
}

class PreprocessorDefinedContext extends PreprocessorExpressionContext {
  TerminalNode DIRECTIVE_DEFINED() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_DEFINED, 0);
  TerminalNode DIRECTIVE_ID() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_ID, 0);
  TerminalNode DIRECTIVE_LP() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_LP, 0);
  TerminalNode DIRECTIVE_RP() => getToken(ObjectiveCPreprocessorParser.TOKEN_DIRECTIVE_RP, 0);
  PreprocessorDefinedContext(PreprocessorExpressionContext ctx) { copyFrom(ctx); }
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.enterPreprocessorDefined(this);
  }
  @override
  void exitRule(ParseTreeListener listener) {
    if (listener is ObjectiveCPreprocessorParserListener) listener.exitPreprocessorDefined(this);
  }
}
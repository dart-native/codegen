...
const int RULE_translationUnit = 0,
    ...
    RULE_functionPointer = 64,
    RULE_attribute = 65,
    RULE_attributeName = 66,
    RULE_attributeParameters = 67,
    RULE_attributeParameterList = 68,
    RULE_attributeParameter = 69,
    RULE_attributeParameterAssignment = 70,
    RULE_declaration = 71,
    RULE_functionCallExpression = 72,
    RULE_enumDeclaration = 73,
    RULE_varDeclaration = 74,
    RULE_typedefDeclaration = 75,
    RULE_typeDeclaratorList = 76,
    RULE_typeDeclarator = 77,
    RULE_commonSpecifiers = 78,
    RULE_declarationSpecifiers = 79,
    RULE_pointerQualifier = 80,
    RULE_attributeSpecifier = 81,
    RULE_initDeclaratorList = 82,
    RULE_initDeclarator = 83,
    RULE_structOrUnionSpecifier = 84,
    RULE_fieldDeclaration = 85,
    RULE_specifierQualifierList = 86,
    RULE_ibOutletQualifier = 87,
    RULE_arcBehaviourSpecifier = 88,
    RULE_nullabilitySpecifier = 89,
    RULE_storageClassSpecifier = 90,
    RULE_typePrefix = 91,
    RULE_typeQualifier = 92,
    RULE_protocolQualifier = 93,
    RULE_typeSpecifier = 94,
    RULE_typeofExpression = 95,
    RULE_fieldDeclaratorList = 96,
    RULE_fieldDeclarator = 97,
    RULE_enumSpecifier = 98,
    RULE_enumeratorList = 99,
    RULE_enumerator = 100,
    RULE_enumeratorIdentifier = 101,
    RULE_directDeclarator = 102,
    RULE_declaratorSuffix = 103,
    RULE_parameterList = 104,
    RULE_pointer = 105,
    RULE_macro = 106,
    RULE_arrayInitializer = 107,
    RULE_structInitializer = 108,
    RULE_initializerList = 109,
    RULE_typeName = 110,
    RULE_abstractDeclarator = 111,
    RULE_abstractDeclaratorSuffix = 112,
    RULE_parameterDeclarationList = 113,
    RULE_parameterDeclaration = 114,
    RULE_declarator = 115,
    RULE_statement = 116,
    RULE_labeledStatement = 117,
    RULE_rangeExpression = 118,
    RULE_compoundStatement = 119,
    RULE_selectionStatement = 120,
    RULE_switchStatement = 121,
    RULE_switchBlock = 122,
    RULE_switchSection = 123,
    RULE_switchLabel = 124,
    RULE_iterationStatement = 125,
    RULE_whileStatement = 126,
    RULE_doStatement = 127,
    RULE_forStatement = 128,
    RULE_forLoopInitializer = 129,
    RULE_forInStatement = 130,
    RULE_jumpStatement = 131,
    RULE_expressions = 132,
    RULE_expression = 133,
    RULE_assignmentOperator = 134,
    RULE_castExpression = 135,
    RULE_initializer = 136,
    RULE_constantExpression = 137,
    RULE_unaryExpression = 138,
    RULE_unaryOperator = 139,
    RULE_postfixExpression = 140,
    RULE_postfix = 141,
    RULE_argumentExpressionList = 142,
    RULE_argumentExpression = 143,
    RULE_osVersion = 144,
    RULE_primaryExpression = 145,
    RULE_constant = 146,
    RULE_stringLiteral = 147,
    RULE_identifier = 148;
...
class ObjectiveCParser extends Parser {
  ...
  TranslationUnitContext translationUnit() {
    ...
    try {
      ...
      while ((((_la) & ~0x3f) == 0 &&
              ((BigInt.one << _la) &
                      ((BigInt.one << TOKEN_AUTO) |
                          (BigInt.one << TOKEN_CHAR) |
                          (BigInt.one << TOKEN_CONST) |
                          (BigInt.one << TOKEN_DOUBLE) |
                          (BigInt.one << TOKEN_ENUM) |
                          (BigInt.one << TOKEN_EXTERN) |
                          (BigInt.one << TOKEN_FLOAT) |
                          (BigInt.one << TOKEN_INLINE) |
                          (BigInt.one << TOKEN_INT) |
                          (BigInt.one << TOKEN_LONG) |
                          (BigInt.one << TOKEN_REGISTER) |
                          (BigInt.one << TOKEN_RESTRICT) |
                          (BigInt.one << TOKEN_SHORT) |
                          (BigInt.one << TOKEN_SIGNED) |
                          (BigInt.one << TOKEN_STATIC) |
                          (BigInt.one << TOKEN_STRUCT) |
                          (BigInt.one << TOKEN_TYPEDEF) |
                          (BigInt.one << TOKEN_UNION) |
                          (BigInt.one << TOKEN_UNSIGNED) |
                          (BigInt.one << TOKEN_VOID) |
                          (BigInt.one << TOKEN_VOLATILE) |
                          (BigInt.one << TOKEN_BOOL) |
                          (BigInt.one << TOKEN_Class) |
                          (BigInt.one << TOKEN_BYCOPY) |
                          (BigInt.one << TOKEN_BYREF) |
                          (BigInt.one << TOKEN_ID) |
                          (BigInt.one << TOKEN_IMP) |
                          (BigInt.one << TOKEN_IN) |
                          (BigInt.one << TOKEN_INOUT) |
                          (BigInt.one << TOKEN_ONEWAY) |
                          (BigInt.one << TOKEN_OUT) |
                          (BigInt.one << TOKEN_PROTOCOL_) |
                          (BigInt.one << TOKEN_SEL) |
                          (BigInt.one << TOKEN_SELF) |
                          (BigInt.one << TOKEN_SUPER) |
                          (BigInt.one << TOKEN_CLASS))) !=
                  BigInt.zero) ||
          ((((_la - 65)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 65)) &
                      ((BigInt.one << (TOKEN_IMPLEMENTATION - 65)) |
                          (BigInt.one << (TOKEN_INTERFACE - 65)) |
                          (BigInt.one << (TOKEN_IMPORT - 65)) |
                          (BigInt.one << (TOKEN_PROTOCOL - 65)) |
                          (BigInt.one << (TOKEN_ATOMIC - 65)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 65)) |
                          (BigInt.one << (TOKEN_RETAIN - 65)) |
                          (BigInt.one << (TOKEN_ATTRIBUTE - 65)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 65)) |
                          (BigInt.one << (TOKEN_BLOCK - 65)) |
                          (BigInt.one << (TOKEN_BRIDGE - 65)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 65)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 65)) |
                          (BigInt.one << (TOKEN_COVARIANT - 65)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 65)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 65)) |
                          (BigInt.one << (TOKEN_KINDOF - 65)) |
                          (BigInt.one << (TOKEN_STRONG_QUALIFIER - 65)) |
                          (BigInt.one << (TOKEN_TYPEOF - 65)) |
                          (BigInt.one <<
                              (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 65)) |
                          (BigInt.one << (TOKEN_UNUSED - 65)) |
                          (BigInt.one << (TOKEN_WEAK_QUALIFIER - 65)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 65)) |
                          (BigInt.one << (TOKEN_NULLABLE - 65)) |
                          (BigInt.one << (TOKEN_NONNULL - 65)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 65)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 65)) |
                          (BigInt.one << (TOKEN_NS_ENUM - 65)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 65)) |
                          (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 65)) |
                          (BigInt.one << (TOKEN_NS_ERROR_ENUM - 65)) |
                          (BigInt.one << (TOKEN_ASSIGN - 65)) |
                          (BigInt.one << (TOKEN_COPY - 65)) |
                          (BigInt.one << (TOKEN_GETTER - 65)) |
                          (BigInt.one << (TOKEN_SETTER - 65)) |
                          (BigInt.one << (TOKEN_STRONG - 65)) |
                          (BigInt.one << (TOKEN_READONLY - 65)) |
                          (BigInt.one << (TOKEN_READWRITE - 65)) |
                          (BigInt.one << (TOKEN_WEAK - 65)) |
                          (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 65)) |
                          (BigInt.one << (TOKEN_IB_OUTLET - 65)) |
                          (BigInt.one << (TOKEN_IB_OUTLET_COLLECTION - 65)) |
                          (BigInt.one << (TOKEN_IB_INSPECTABLE - 65)) |
                          (BigInt.one << (TOKEN_IB_DESIGNABLE - 65)))) !=
                  BigInt.zero) ||
  ...
  ClassInterfaceContext classInterface() {
    ...
    try {
      ...
      while ((((_la) & ~0x3f) == 0 &&
          ...
          ((((_la - 81)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 81)) &
                      ((BigInt.one << (TOKEN_ATOMIC - 81)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 81)) |
                          (BigInt.one << (TOKEN_RETAIN - 81)) |
                          (BigInt.one << (TOKEN_ATTRIBUTE - 81)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 81)) |
                          (BigInt.one << (TOKEN_BLOCK - 81)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 81)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 81)) |
                          (BigInt.one << (TOKEN_COVARIANT - 81)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 81)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 81)) |
                          (BigInt.one << (TOKEN_KINDOF - 81)) |
                          (BigInt.one << (TOKEN_UNUSED - 81)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 81)) |
                          (BigInt.one << (TOKEN_NULLABLE - 81)) |
                          (BigInt.one << (TOKEN_NONNULL - 81)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 81)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 81)) |
                          (BigInt.one << (TOKEN_NS_ENUM - 81)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 81)) |
                          (BigInt.one << (TOKEN_ASSIGN - 81)) |
                          (BigInt.one << (TOKEN_COPY - 81)) |
                          (BigInt.one << (TOKEN_GETTER - 81)) |
                          (BigInt.one << (TOKEN_SETTER - 81)) |
                          (BigInt.one << (TOKEN_STRONG - 81)) |
                          (BigInt.one << (TOKEN_READONLY - 81)) |
                          (BigInt.one << (TOKEN_READWRITE - 81)) |
                          (BigInt.one << (TOKEN_WEAK - 81)) |
                          (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 81)) |
                          (BigInt.one << (TOKEN_IB_OUTLET - 81)) |
                          (BigInt.one << (TOKEN_IB_OUTLET_COLLECTION - 81)) |
                          (BigInt.one << (TOKEN_IB_INSPECTABLE - 81)) |
                          (BigInt.one << (TOKEN_IB_DESIGNABLE - 81)) |
                          (BigInt.one << (TOKEN_IDENTIFIER - 81)))) !=
                  BigInt.zero)) {
        state = 343;
        errorHandler.sync(this);
        switch (tokenStream.LA(1)) {
      ...
      if ((((_la) & ~0x3f) == 0 &&
          ...
          ((((_la - 72)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 72)) &
                      ((BigInt.one << (TOKEN_PROPERTY - 72)) |
                          (BigInt.one << (TOKEN_ATOMIC - 72)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 72)) |
                          (BigInt.one << (TOKEN_RETAIN - 72)) |
                          (BigInt.one << (TOKEN_ATTRIBUTE - 72)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 72)) |
                          (BigInt.one << (TOKEN_BLOCK - 72)) |
                          (BigInt.one << (TOKEN_BRIDGE - 72)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 72)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 72)) |
                          (BigInt.one << (TOKEN_COVARIANT - 72)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 72)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 72)) |
                          (BigInt.one << (TOKEN_KINDOF - 72)) |
                          (BigInt.one << (TOKEN_STRONG_QUALIFIER - 72)) |
                          (BigInt.one << (TOKEN_TYPEOF - 72)) |
                          (BigInt.one <<
                              (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 72)) |
                          (BigInt.one << (TOKEN_UNUSED - 72)) |
                          (BigInt.one << (TOKEN_WEAK_QUALIFIER - 72)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 72)) |
                          (BigInt.one << (TOKEN_NULLABLE - 72)) |
                          (BigInt.one << (TOKEN_NONNULL - 72)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 72)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 72)) |
                          (BigInt.one << (TOKEN_NS_ENUM - 72)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 72)) |
                          (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 72)) |
                          (BigInt.one << (TOKEN_NS_ERROR_ENUM - 72)) |
                          (BigInt.one << (TOKEN_ASSIGN - 72)) |
                          (BigInt.one << (TOKEN_COPY - 72)) |
                          (BigInt.one << (TOKEN_GETTER - 72)) |
                          (BigInt.one << (TOKEN_SETTER - 72)) |
                          (BigInt.one << (TOKEN_STRONG - 72)) |
                          (BigInt.one << (TOKEN_READONLY - 72)) |
                          (BigInt.one << (TOKEN_READWRITE - 72)) |
                          (BigInt.one << (TOKEN_WEAK - 72)) |
                          (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 72)) |
                          (BigInt.one << (TOKEN_IB_OUTLET - 72)) |
                          (BigInt.one << (TOKEN_IB_OUTLET_COLLECTION - 72)) |
                          (BigInt.one << (TOKEN_IB_INSPECTABLE - 72)) |
                          (BigInt.one << (TOKEN_IB_DESIGNABLE - 72)))) !=
                  BigInt.zero) ||
          ((((_la - 136)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 136)) &
                      ((BigInt.one << (TOKEN_IDENTIFIER - 136)) |
                          (BigInt.one << (TOKEN_ADD - 136)) |
                          (BigInt.one << (TOKEN_SUB - 136)))) !=
                  BigInt.zero)) {
        state = 363;
        interfaceDeclarationList();
      }
      ...
      if ((((_la) & ~0x3f) == 0 &&
              ((BigInt.one << _la) &
                      ((BigInt.one << TOKEN_AUTO) |
                          ...
                          (BigInt.one << TOKEN_SELF) |
                          (BigInt.one << TOKEN_SUPER) |
                          (BigInt.one << TOKEN_DYNAMIC))) !=
                  BigInt.zero) ||
          ((((_la - 78)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 78)) &
                      ((BigInt.one << (TOKEN_SYNTHESIZE - 78)) |
                          (BigInt.one << (TOKEN_ATOMIC - 78)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 78)) |
                          (BigInt.one << (TOKEN_RETAIN - 78)) |
                          (BigInt.one << (TOKEN_ATTRIBUTE - 78)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 78)) |
                          (BigInt.one << (TOKEN_BLOCK - 78)) |
                          (BigInt.one << (TOKEN_BRIDGE - 78)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 78)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 78)) |
                          (BigInt.one << (TOKEN_COVARIANT - 78)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 78)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 78)) |
                          (BigInt.one << (TOKEN_KINDOF - 78)) |
                          (BigInt.one << (TOKEN_STRONG_QUALIFIER - 78)) |
                          (BigInt.one << (TOKEN_TYPEOF - 78)) |
                          (BigInt.one <<
                              (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 78)) |
                          (BigInt.one << (TOKEN_UNUSED - 78)) |
                          (BigInt.one << (TOKEN_WEAK_QUALIFIER - 78)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 78)) |
                          (BigInt.one << (TOKEN_NULLABLE - 78)) |
                          (BigInt.one << (TOKEN_NONNULL - 78)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 78)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 78)) |
                          (BigInt.one << (TOKEN_NS_ENUM - 78)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 78)) |
                          (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 78)) |
                          (BigInt.one << (TOKEN_NS_ERROR_ENUM - 78)) |
                          (BigInt.one << (TOKEN_ASSIGN - 78)) |
                          (BigInt.one << (TOKEN_COPY - 78)) |
                          (BigInt.one << (TOKEN_GETTER - 78)) |
                          (BigInt.one << (TOKEN_SETTER - 78)) |
                          (BigInt.one << (TOKEN_STRONG - 78)) |
                          (BigInt.one << (TOKEN_READONLY - 78)) |
                          (BigInt.one << (TOKEN_READWRITE - 78)) |
                          (BigInt.one << (TOKEN_WEAK - 78)) |
                          (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 78)) |
                          (BigInt.one << (TOKEN_IB_OUTLET - 78)) |
                          (BigInt.one << (TOKEN_IB_OUTLET_COLLECTION - 78)) |
                          (BigInt.one << (TOKEN_IB_INSPECTABLE - 78)) |
                          (BigInt.one << (TOKEN_IB_DESIGNABLE - 78)) |
                          (BigInt.one << (TOKEN_IDENTIFIER - 78)))) !=
                  BigInt.zero) ||
          _la == TOKEN_ADD ||
          _la == TOKEN_SUB) {
        state = 405;
  ...
  ProtocolDeclarationContext protocolDeclaration() {
    ...
    try {
      ...
      while ((((_la) & ~0x3f) == 0 &&
          ...
          ((((_la - 70)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 70)) &
                      ((BigInt.one << (TOKEN_OPTIONAL - 70)) |
                          (BigInt.one << (TOKEN_PROPERTY - 70)) |
                          (BigInt.one << (TOKEN_REQUIRED - 70)) |
                          (BigInt.one << (TOKEN_ATOMIC - 70)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 70)) |
                          (BigInt.one << (TOKEN_RETAIN - 70)) |
                          (BigInt.one << (TOKEN_ATTRIBUTE - 70)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 70)) |
                          (BigInt.one << (TOKEN_BLOCK - 70)) |
                          (BigInt.one << (TOKEN_BRIDGE - 70)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 70)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 70)) |
                          (BigInt.one << (TOKEN_COVARIANT - 70)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 70)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 70)) |
                          (BigInt.one << (TOKEN_KINDOF - 70)) |
                          (BigInt.one << (TOKEN_STRONG_QUALIFIER - 70)) |
                          (BigInt.one << (TOKEN_TYPEOF - 70)) |
                          (BigInt.one <<
                              (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 70)) |
                          (BigInt.one << (TOKEN_UNUSED - 70)) |
                          (BigInt.one << (TOKEN_WEAK_QUALIFIER - 70)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 70)) |
                          (BigInt.one << (TOKEN_NULLABLE - 70)) |
                          (BigInt.one << (TOKEN_NONNULL - 70)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 70)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 70)) |
                          (BigInt.one << (TOKEN_NS_ENUM - 70)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 70)) |
                          (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 70)) |
                          (BigInt.one << (TOKEN_NS_ERROR_ENUM - 70)) |
                          (BigInt.one << (TOKEN_ASSIGN - 70)) |
                          (BigInt.one << (TOKEN_COPY - 70)) |
                          (BigInt.one << (TOKEN_GETTER - 70)) |
                          (BigInt.one << (TOKEN_SETTER - 70)) |
                          (BigInt.one << (TOKEN_STRONG - 70)) |
                          (BigInt.one << (TOKEN_READONLY - 70)) |
                          (BigInt.one << (TOKEN_READWRITE - 70)) |
                          (BigInt.one << (TOKEN_WEAK - 70)) |
                          (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 70)) |
                          (BigInt.one << (TOKEN_IB_OUTLET - 70)) |
                          (BigInt.one << (TOKEN_IB_OUTLET_COLLECTION - 70)) |
                          (BigInt.one << (TOKEN_IB_INSPECTABLE - 70)) |
                          (BigInt.one << (TOKEN_IB_DESIGNABLE - 70)))) !=
                  BigInt.zero) ||
          ((((_la - 136)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 136)) &
                      ((BigInt.one << (TOKEN_IDENTIFIER - 136)) |
  ...
  InstanceVariablesContext instanceVariables() {
    ...
    try {
      ...
      while ((((_la) & ~0x3f) == 0 &&
          ...
          ((((_la - 68)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 68)) &
                      ((BigInt.one << (TOKEN_PACKAGE - 68)) |
                          (BigInt.one << (TOKEN_PRIVATE - 68)) |
                          (BigInt.one << (TOKEN_PROTECTED - 68)) |
                          (BigInt.one << (TOKEN_PUBLIC - 68)) |
                          (BigInt.one << (TOKEN_ATOMIC - 68)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 68)) |
                          (BigInt.one << (TOKEN_RETAIN - 68)) |
                          (BigInt.one << (TOKEN_ATTRIBUTE - 68)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 68)) |
                          (BigInt.one << (TOKEN_BLOCK - 68)) |
                          (BigInt.one << (TOKEN_BRIDGE - 68)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 68)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 68)) |
                          (BigInt.one << (TOKEN_COVARIANT - 68)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 68)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 68)) |
                          (BigInt.one << (TOKEN_KINDOF - 68)) |
                          (BigInt.one << (TOKEN_STRONG_QUALIFIER - 68)) |
                          (BigInt.one << (TOKEN_TYPEOF - 68)) |
                          (BigInt.one <<
                              (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 68)) |
                          (BigInt.one << (TOKEN_UNUSED - 68)) |
                          (BigInt.one << (TOKEN_WEAK_QUALIFIER - 68)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 68)) |
                          (BigInt.one << (TOKEN_NULLABLE - 68)) |
                          (BigInt.one << (TOKEN_NONNULL - 68)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 68)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 68)) |
                          (BigInt.one << (TOKEN_NS_ENUM - 68)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 68)) |
                          (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 68)) |
                          (BigInt.one << (TOKEN_NS_ERROR_ENUM - 68)) |
                          (BigInt.one << (TOKEN_ASSIGN - 68)) |
                          (BigInt.one << (TOKEN_COPY - 68)) |
                          (BigInt.one << (TOKEN_GETTER - 68)) |
                          (BigInt.one << (TOKEN_SETTER - 68)) |
                          (BigInt.one << (TOKEN_STRONG - 68)) |
                          (BigInt.one << (TOKEN_READONLY - 68)) |
                          (BigInt.one << (TOKEN_READWRITE - 68)) |
                          (BigInt.one << (TOKEN_WEAK - 68)) |
                          (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 68)) |
                          (BigInt.one << (TOKEN_IB_OUTLET - 68)) |
                          (BigInt.one << (TOKEN_IB_OUTLET_COLLECTION - 68)) |
                          (BigInt.one << (TOKEN_IB_INSPECTABLE - 68)) |
                          (BigInt.one << (TOKEN_IB_DESIGNABLE - 68)))) !=
                  BigInt.zero) ||
          _la == TOKEN_IDENTIFIER ||
          _la == TOKEN_LP) {
        state = 555;
  ...
  MethodDefinitionContext methodDefinition() {
    ...
    try {
      ...
      if (((((_la - 40)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 40)) &
                      ((BigInt.one << (TOKEN_BOOL - 40)) |
                          (BigInt.one << (TOKEN_Class - 40)) |
                          (BigInt.one << (TOKEN_BYCOPY - 40)) |
                          (BigInt.one << (TOKEN_BYREF - 40)) |
                          (BigInt.one << (TOKEN_ID - 40)) |
                          (BigInt.one << (TOKEN_IMP - 40)) |
                          (BigInt.one << (TOKEN_IN - 40)) |
                          (BigInt.one << (TOKEN_INOUT - 40)) |
                          (BigInt.one << (TOKEN_ONEWAY - 40)) |
                          (BigInt.one << (TOKEN_OUT - 40)) |
                          (BigInt.one << (TOKEN_PROTOCOL_ - 40)) |
                          (BigInt.one << (TOKEN_SEL - 40)) |
                          (BigInt.one << (TOKEN_SELF - 40)) |
                          (BigInt.one << (TOKEN_SUPER - 40)) |
                          (BigInt.one << (TOKEN_ATOMIC - 40)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 40)) |
                          (BigInt.one << (TOKEN_RETAIN - 40)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 40)) |
                          (BigInt.one << (TOKEN_BLOCK - 40)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 40)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 40)) |
                          (BigInt.one << (TOKEN_COVARIANT - 40)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 40)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 40)) |
                          (BigInt.one << (TOKEN_KINDOF - 40)) |
                          (BigInt.one << (TOKEN_UNUSED - 40)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 40)) |
                          (BigInt.one << (TOKEN_NULLABLE - 40)) |
                          (BigInt.one << (TOKEN_NONNULL - 40)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 40)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 40)))) !=
                  BigInt.zero) ||
          ((((_la - 104)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 104)) &
                      ((BigInt.one << (TOKEN_NS_ENUM - 104)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 104)) |
                          (BigInt.one << (TOKEN_ASSIGN - 104)) |
                          (BigInt.one << (TOKEN_COPY - 104)) |
                          (BigInt.one << (TOKEN_GETTER - 104)) |
                          (BigInt.one << (TOKEN_SETTER - 104)) |
                          (BigInt.one << (TOKEN_STRONG - 104)) |
                          (BigInt.one << (TOKEN_READONLY - 104)) |
                          (BigInt.one << (TOKEN_READWRITE - 104)) |
                          (BigInt.one << (TOKEN_WEAK - 104)) |
                          (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 104)) |
                          (BigInt.one << (TOKEN_IB_OUTLET - 104)) |
                          (BigInt.one << (TOKEN_IB_OUTLET_COLLECTION - 104)) |
                          (BigInt.one << (TOKEN_IB_INSPECTABLE - 104)) |
                          (BigInt.one << (TOKEN_IB_DESIGNABLE - 104)) |
                          (BigInt.one << (TOKEN_IDENTIFIER - 104)) |
                          (BigInt.one << (TOKEN_LP - 104)) |
                          (BigInt.one << (TOKEN_MUL - 104)))) !=
                  BigInt.zero)) {
        state = 626;
        initDeclaratorList();
      }
  ...
  BlockTypeContext blockType() {
    ...
    try {
      ...
      if (((((_la - 99)) & ~0x3f) == 0 &&
          ((BigInt.one << (_la - 99)) &
                  ((BigInt.one << (TOKEN_NULL_UNSPECIFIED - 99)) |
                      (BigInt.one << (TOKEN_NULLABLE - 99)) |
                      (BigInt.one << (TOKEN_NONNULL - 99)) |
                      (BigInt.one << (TOKEN_NULL_RESETTABLE - 99)))) !=
              BigInt.zero)) {
        state = 696;
        nullabilitySpecifier();
      }
          ...
          ((((_la - 81)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 81)) &
                      ((BigInt.one << (TOKEN_ATOMIC - 81)) |
                          ...
                          (BigInt.one << (TOKEN_NS_ENUM - 81)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 81)) |
                          (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 81)) |
                          (BigInt.one << (TOKEN_NS_ERROR_ENUM - 81)) |
                          (BigInt.one << (TOKEN_ASSIGN - 81)) |
                          (BigInt.one << (TOKEN_COPY - 81)) |
                          (BigInt.one << (TOKEN_GETTER - 81)) |
                          (BigInt.one << (TOKEN_SETTER - 81)) |
  ...
  DictionaryExpressionContext dictionaryExpression() {
    ...
    try {
      ...
      if ((((_la) & ~0x3f) == 0 &&
              ((BigInt.one << _la) &
                      ((BigInt.one << TOKEN_SIZEOF) |
                          (BigInt.one << TOKEN_TRUE) |
                          (BigInt.one << TOKEN_FALSE) |
                          (BigInt.one << TOKEN_BOOL) |
                          (BigInt.one << TOKEN_Class) |
                          (BigInt.one << TOKEN_BYCOPY) |
                          (BigInt.one << TOKEN_BYREF) |
                          ...
                          (BigInt.one << TOKEN_SELF) |
                          (BigInt.one << TOKEN_SUPER) |
                          (BigInt.one << TOKEN_YES) |
                          (BigInt.one << TOKEN_ENCODE))) !=
                  BigInt.zero) ||
          ((((_la - 69)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 69)) &
                      ((BigInt.one << (TOKEN_PROTOCOL - 69)) |
                          (BigInt.one << (TOKEN_SELECTOR - 69)) |
                          (BigInt.one << (TOKEN_ATOMIC - 69)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 69)) |
                          (BigInt.one << (TOKEN_RETAIN - 69)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 69)) |
                          (BigInt.one << (TOKEN_BLOCK - 69)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 69)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 69)) |
                          (BigInt.one << (TOKEN_COVARIANT - 69)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 69)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 69)) |
                          (BigInt.one << (TOKEN_KINDOF - 69)) |
                          (BigInt.one << (TOKEN_UNUSED - 69)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 69)) |
                          (BigInt.one << (TOKEN_NULLABLE - 69)) |
                          (BigInt.one << (TOKEN_NONNULL - 69)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 69)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 69)) |
                          (BigInt.one << (TOKEN_NS_ENUM - 69)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 69)) |
                          (BigInt.one << (TOKEN_ASSIGN - 69)) |
                          (BigInt.one << (TOKEN_COPY - 69)) |
                          (BigInt.one << (TOKEN_GETTER - 69)) |
                          (BigInt.one << (TOKEN_SETTER - 69)) |
                          (BigInt.one << (TOKEN_STRONG - 69)) |
                          (BigInt.one << (TOKEN_READONLY - 69)) |
                          (BigInt.one << (TOKEN_READWRITE - 69)) |
                          (BigInt.one << (TOKEN_WEAK - 69)) |
                          (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 69)) |
                          (BigInt.one << (TOKEN_IB_OUTLET - 69)) |
                          (BigInt.one << (TOKEN_IB_OUTLET_COLLECTION - 69)) |
                          (BigInt.one << (TOKEN_IB_INSPECTABLE - 69)) |
                          (BigInt.one << (TOKEN_IB_DESIGNABLE - 69)))) !=
                  BigInt.zero) ||
          ((((_la - 136)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 136)) &
                      ((BigInt.one << (TOKEN_IDENTIFIER - 136)) |
                          (BigInt.one << (TOKEN_LP - 136)) |
                          (BigInt.one << (TOKEN_LBRACK - 136)) |
                          (BigInt.one << (TOKEN_AT - 136)) |
                          (BigInt.one << (TOKEN_BANG - 136)) |
                          (BigInt.one << (TOKEN_TILDE - 136)) |
                          (BigInt.one << (TOKEN_INC - 136)) |
                          (BigInt.one << (TOKEN_DEC - 136)) |
                          (BigInt.one << (TOKEN_ADD - 136)) |
                          (BigInt.one << (TOKEN_SUB - 136)) |
                          (BigInt.one << (TOKEN_MUL - 136)) |
                          (BigInt.one << (TOKEN_BITAND - 136)) |
                          (BigInt.one << (TOKEN_BITXOR - 136)) |
                          (BigInt.one << (TOKEN_CHARACTER_LITERAL - 136)) |
                          (BigInt.one << (TOKEN_STRING_START - 136)) |
                          (BigInt.one << (TOKEN_HEX_LITERAL - 136)) |
                          (BigInt.one << (TOKEN_OCTAL_LITERAL - 136)) |
                          (BigInt.one << (TOKEN_BINARY_LITERAL - 136)) |
                          (BigInt.one << (TOKEN_DECIMAL_LITERAL - 136)) |
                          (BigInt.one <<
                              (TOKEN_FLOATING_POINT_LITERAL - 136)))) !=
                  BigInt.zero)) {
        state = 732;
        dictionaryPair();
        state = 737;
    ...
    try {
      ...
      if ((((_la) & ~0x3f) == 0 &&
          ...
          ((((_la - 81)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 81)) &
                      ((BigInt.one << (TOKEN_ATOMIC - 81)) |
                          ...
                          (BigInt.one << (TOKEN_DEPRECATED - 81)) |
                          (BigInt.one << (TOKEN_KINDOF - 81)) |
                          (BigInt.one << (TOKEN_STRONG_QUALIFIER - 81)) |
                          (BigInt.one << (TOKEN_TYPEOF - 81)) |
                          (BigInt.one <<
                              (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 81)) |
                          (BigInt.one << (TOKEN_UNUSED - 81)) |
                          (BigInt.one << (TOKEN_WEAK_QUALIFIER - 81)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 81)) |
                          (BigInt.one << (TOKEN_NULLABLE - 81)) |
                          (BigInt.one << (TOKEN_NONNULL - 81)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 81)) |
        ...
        switch (interpreter.adaptivePredict(tokenStream, 79, context)) {
          case 1:
            state = 774;
            _localctx._typeVariableDeclaratorOrName =
                typeVariableDeclaratorOrName();
              ...
              ((((_la - 81)) & ~0x3f) == 0 &&
                  ((BigInt.one << (_la - 81)) &
                          ((BigInt.one << (TOKEN_ATOMIC - 81)) |
                              ...
                              (BigInt.one << (TOKEN_RETAIN - 81)) |
                              (BigInt.one <<
                                  (TOKEN_AUTORELEASING_QUALIFIER - 81)) |
                              (BigInt.one << (TOKEN_BLOCK - 81)) |
                              (BigInt.one << (TOKEN_BRIDGE_RETAINED - 81)) |
                              (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 81)) |
                              (BigInt.one << (TOKEN_COVARIANT - 81)) |
  ...
  AttributeParametersContext attributeParameters() {
    ...
    try {
      ...
      if ((((_la) & ~0x3f) == 0 &&
          ...
          ((((_la - 163)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 163)) &
                      ((BigInt.one << (TOKEN_ADD - 163)) |
                          (BigInt.one << (TOKEN_SUB - 163)) |
                          (BigInt.one << (TOKEN_CHARACTER_LITERAL - 163)) |
                          (BigInt.one << (TOKEN_STRING_START - 163)) |
                          (BigInt.one << (TOKEN_HEX_LITERAL - 163)) |
                          (BigInt.one << (TOKEN_OCTAL_LITERAL - 163)) |
                          (BigInt.one << (TOKEN_BINARY_LITERAL - 163)) |
                          (BigInt.one << (TOKEN_DECIMAL_LITERAL - 163)) |
                          (BigInt.one <<
                              (TOKEN_FLOATING_POINT_LITERAL - 163)))) !=
                  BigInt.zero)) {
        state = 973;
        attributeParameterList();
      }
  ...
  ArcBehaviourSpecifierContext arcBehaviourSpecifier() {
    ...
    try {
      ...
      if (!(((((_la - 85)) & ~0x3f) == 0 &&
          ((BigInt.one << (_la - 85)) &
                  ((BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 85)) |
                      (BigInt.one << (TOKEN_STRONG_QUALIFIER - 85)) |
                      (BigInt.one << (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 85)) |
                      (BigInt.one << (TOKEN_WEAK_QUALIFIER - 85)))) !=
              BigInt.zero))) {
        errorHandler.recoverInline(this);
      } else {
        if (tokenStream.LA(1) == IntStream.EOF) matchedEOF = true;
  ...
  TypePrefixContext typePrefix() {
    ...
    try {
      ...
      if (!(_la == TOKEN_INLINE ||
          ((((_la - 86)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 86)) &
                      ((BigInt.one << (TOKEN_BLOCK - 86)) |
                          (BigInt.one << (TOKEN_BRIDGE - 86)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 86)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 86)) |
                          (BigInt.one << (TOKEN_KINDOF - 86)) |
                          (BigInt.one << (TOKEN_NS_INLINE - 86)))) !=
                  BigInt.zero))) {
        errorHandler.recoverInline(this);
      } else {
        if (tokenStream.LA(1) == IntStream.EOF) matchedEOF = true;
          ...
          if (((((_la - 40)) & ~0x3f) == 0 &&
                  ((BigInt.one << (_la - 40)) &
                          ((BigInt.one << (TOKEN_BOOL - 40)) |
                              ...
                              (BigInt.one << (TOKEN_RETAIN - 40)) |
                              (BigInt.one <<
                                  (TOKEN_AUTORELEASING_QUALIFIER - 40)) |
                              (BigInt.one << (TOKEN_BLOCK - 40)) |
                              (BigInt.one << (TOKEN_BRIDGE_RETAINED - 40)) |
                              (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 40)) |
                              (BigInt.one << (TOKEN_COVARIANT - 40)) |
              ...
              ((((_la - 104)) & ~0x3f) == 0 &&
                  ((BigInt.one << (_la - 104)) &
                          ((BigInt.one << (TOKEN_NS_ENUM - 104)) |
                              ...
                              (BigInt.one << (TOKEN_IB_OUTLET - 104)) |
                              (BigInt.one <<
                                  (TOKEN_IB_OUTLET_COLLECTION - 104)) |
                              (BigInt.one << (TOKEN_IB_INSPECTABLE - 104)) |
                              (BigInt.one << (TOKEN_IB_DESIGNABLE - 104)) |
                              (BigInt.one << (TOKEN_IDENTIFIER - 104)) |
                              (BigInt.one << (TOKEN_LP - 104)) |
        ...
        case TOKEN_NS_ERROR_ENUM:
          ...
          if (!(((((_la - 104)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 104)) &
                      ((BigInt.one << (TOKEN_NS_ENUM - 104)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 104)) |
                          (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 104)) |
                          (BigInt.one << (TOKEN_NS_ERROR_ENUM - 104)))) !=
                  BigInt.zero))) {
    ...
    try {
      ...
      switch (interpreter.adaptivePredict(tokenStream, 199, context)) {
        case 1:
          ...
          if (((((_la - 137)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 137)) &
                      ((BigInt.one << (TOKEN_LP - 137)) |
                          (BigInt.one << (TOKEN_LBRACK - 137)) |
                          (BigInt.one << (TOKEN_MUL - 137)))) !=
                  BigInt.zero)) {
            state = 1433;
            abstractDeclarator();
          }
      ...
      while ((((_la) & ~0x3f) == 0 &&
              ((BigInt.one << _la) &
                      ((BigInt.one << TOKEN_AUTO) |
                          ...
                          (BigInt.one << TOKEN_SUPER) |
                          (BigInt.one << TOKEN_YES) |
                          (BigInt.one << TOKEN_AUTORELEASEPOOL) |
                          (BigInt.one << TOKEN_ENCODE))) !=
                  BigInt.zero) ||
          ((((_la - 69)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 69)) &
                      ((BigInt.one << (TOKEN_PROTOCOL - 69)) |
                          (BigInt.one << (TOKEN_SELECTOR - 69)) |
                          (BigInt.one << (TOKEN_SYNCHRONIZED - 69)) |
                          (BigInt.one << (TOKEN_THROW - 69)) |
                          (BigInt.one << (TOKEN_TRY - 69)) |
                          (BigInt.one << (TOKEN_ATOMIC - 69)) |
                          (BigInt.one << (TOKEN_NONATOMIC - 69)) |
                          (BigInt.one << (TOKEN_RETAIN - 69)) |
                          (BigInt.one << (TOKEN_ATTRIBUTE - 69)) |
                          (BigInt.one << (TOKEN_AUTORELEASING_QUALIFIER - 69)) |
                          (BigInt.one << (TOKEN_BLOCK - 69)) |
                          (BigInt.one << (TOKEN_BRIDGE - 69)) |
                          (BigInt.one << (TOKEN_BRIDGE_RETAINED - 69)) |
                          (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 69)) |
                          (BigInt.one << (TOKEN_COVARIANT - 69)) |
                          (BigInt.one << (TOKEN_CONTRAVARIANT - 69)) |
                          (BigInt.one << (TOKEN_DEPRECATED - 69)) |
                          (BigInt.one << (TOKEN_KINDOF - 69)) |
                          (BigInt.one << (TOKEN_STRONG_QUALIFIER - 69)) |
                          (BigInt.one << (TOKEN_TYPEOF - 69)) |
                          (BigInt.one <<
                              (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 69)) |
                          (BigInt.one << (TOKEN_UNUSED - 69)) |
                          (BigInt.one << (TOKEN_WEAK_QUALIFIER - 69)) |
                          (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 69)) |
                          (BigInt.one << (TOKEN_NULLABLE - 69)) |
                          (BigInt.one << (TOKEN_NONNULL - 69)) |
                          (BigInt.one << (TOKEN_NULL_RESETTABLE - 69)) |
                          ...
                          (BigInt.one << (TOKEN_NS_ENUM - 69)) |
                          (BigInt.one << (TOKEN_NS_OPTIONS - 69)) |
                          (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 69)) |
                          (BigInt.one << (TOKEN_NS_ERROR_ENUM - 69)) |
                          (BigInt.one << (TOKEN_ASSIGN - 69)) |
                          (BigInt.one << (TOKEN_COPY - 69)) |
                          (BigInt.one << (TOKEN_GETTER - 69)) |
                          (BigInt.one << (TOKEN_SETTER - 69)) |
          ...
          ((((_la - 136)) & ~0x3f) == 0 &&
              ((BigInt.one << (_la - 136)) &
                      ((BigInt.one << (TOKEN_IDENTIFIER - 136)) |
                          (BigInt.one << (TOKEN_LP - 136)) |
                          (BigInt.one << (TOKEN_LBRACE - 136)) |
                          (BigInt.one << (TOKEN_LBRACK - 136)) |
                          (BigInt.one << (TOKEN_SEMI - 136)) |
                          (BigInt.one << (TOKEN_AT - 136)) |
                          (BigInt.one << (TOKEN_BANG - 136)) |
                          (BigInt.one << (TOKEN_TILDE - 136)) |
                          (BigInt.one << (TOKEN_INC - 136)) |
        ...
        if (_alt == 1) {
          ...
          switch (interpreter.adaptivePredict(tokenStream, 246, context)) {
            case 1:
              ...
              if (!(((((_la - 165)) & ~0x3f) == 0 &&
                  ((BigInt.one << (_la - 165)) &
                          ((BigInt.one << (TOKEN_MUL - 165)) |
                              (BigInt.one << (TOKEN_DIV - 165)) |
                              (BigInt.one << (TOKEN_MOD - 165)))) !=
                      BigInt.zero))) {
            ...
            case 4:
              ...
              if (!(((((_la - 149)) & ~0x3f) == 0 &&
                  ((BigInt.one << (_la - 149)) &
                          ((BigInt.one << (TOKEN_GT - 149)) |
                              (BigInt.one << (TOKEN_LT - 149)) |
                              (BigInt.one << (TOKEN_LE - 149)) |
                              (BigInt.one << (TOKEN_GE - 149)))) !=
                      BigInt.zero))) {
                _localctx.op = errorHandler.recoverInline(this);
              } else {
                if (tokenStream.LA(1) == IntStream.EOF) matchedEOF = true;
                  ...
                  ((((_la - 69)) & ~0x3f) == 0 &&
                      ((BigInt.one << (_la - 69)) &
                              ((BigInt.one << (TOKEN_PROTOCOL - 69)) |
                                  ...
                                  (BigInt.one << (TOKEN_RETAIN - 69)) |
                                  (BigInt.one <<
                                      (TOKEN_AUTORELEASING_QUALIFIER - 69)) |
                                  (BigInt.one << (TOKEN_BLOCK - 69)) |
                                  (BigInt.one << (TOKEN_BRIDGE_RETAINED - 69)) |
                                  (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 69)) |
                                  (BigInt.one << (TOKEN_COVARIANT - 69)) |
                                  ...
                                  (BigInt.one << (TOKEN_WEAK - 69)) |
                                  (BigInt.one <<
                                      (TOKEN_UNSAFE_UNRETAINED - 69)) |
                                  (BigInt.one << (TOKEN_IB_OUTLET - 69)) |
                                  (BigInt.one <<
                                      (TOKEN_IB_OUTLET_COLLECTION - 69)) |
                                  (BigInt.one << (TOKEN_IB_INSPECTABLE - 69)) |
                                  (BigInt.one <<
                                      (TOKEN_IB_DESIGNABLE - 69)))) !=
                          BigInt.zero) ||
                  ((((_la - 136)) & ~0x3f) == 0 &&
                      ((BigInt.one << (_la - 136)) &
                              ((BigInt.one << (TOKEN_IDENTIFIER - 136)) |
                                  ...
                                  (BigInt.one << (TOKEN_BITXOR - 136)) |
                                  (BigInt.one <<
                                      (TOKEN_CHARACTER_LITERAL - 136)) |
                                  (BigInt.one << (TOKEN_STRING_START - 136)) |
                                  (BigInt.one << (TOKEN_HEX_LITERAL - 136)) |
                                  (BigInt.one << (TOKEN_OCTAL_LITERAL - 136)) |
                                  (BigInt.one << (TOKEN_BINARY_LITERAL - 136)) |
                                  (BigInt.one <<
                                      (TOKEN_DECIMAL_LITERAL - 136)) |
                                  (BigInt.one <<
                                      (TOKEN_FLOATING_POINT_LITERAL - 136)))) !=
                          BigInt.zero)) {
                state = 1730;
  ...
  AssignmentOperatorContext assignmentOperator() {
    ...
    try {
      ...
      if (!(((((_la - 148)) & ~0x3f) == 0 &&
          ((BigInt.one << (_la - 148)) &
                  ((BigInt.one << (TOKEN_ASSIGNMENT - 148)) |
                      (BigInt.one << (TOKEN_ADD_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_SUB_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_MUL_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_DIV_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_AND_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_OR_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_XOR_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_MOD_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_LSHIFT_ASSIGN - 148)) |
                      (BigInt.one << (TOKEN_RSHIFT_ASSIGN - 148)))) !=
              BigInt.zero))) {
        errorHandler.recoverInline(this);
      } else {
        if (tokenStream.LA(1) == IntStream.EOF) matchedEOF = true;
  ...
  UnaryOperatorContext unaryOperator() {
    ...
    try {
      ...
      if (!(((((_la - 151)) & ~0x3f) == 0 &&
          ((BigInt.one << (_la - 151)) &
                  ((BigInt.one << (TOKEN_BANG - 151)) |
                      (BigInt.one << (TOKEN_TILDE - 151)) |
                      (BigInt.one << (TOKEN_ADD - 151)) |
                      (BigInt.one << (TOKEN_SUB - 151)) |
                      (BigInt.one << (TOKEN_MUL - 151)) |
                      (BigInt.one << (TOKEN_BITAND - 151)))) !=
              BigInt.zero))) {
        errorHandler.recoverInline(this);
      } else {
        if (tokenStream.LA(1) == IntStream.EOF) matchedEOF = true;
          ...
          do {
            ...
            _la = tokenStream.LA(1);
                  ...
                  ((BigInt.one << _la) &
                          ((BigInt.one << TOKEN_AUTO) |
                              (BigInt.one << TOKEN_BREAK) |
                              (BigInt.one << TOKEN_CASE) |
                              (BigInt.one << TOKEN_CHAR) |
                              (BigInt.one << TOKEN_CONST) |
                              (BigInt.one << TOKEN_CONTINUE) |
                              (BigInt.one << TOKEN_DEFAULT) |
                              (BigInt.one << TOKEN_DO) |
                              (BigInt.one << TOKEN_DOUBLE) |
                              ...
                              (BigInt.one << TOKEN_VOLATILE) |
                              (BigInt.one << TOKEN_WHILE) |
                              (BigInt.one << TOKEN_BOOL_) |
                              (BigInt.one << TOKEN_COMPLEX) |
                              (BigInt.one << TOKEN_IMAGINERY) |
                              (BigInt.one << TOKEN_TRUE) |
                              (BigInt.one << TOKEN_FALSE) |
                              (BigInt.one << TOKEN_BOOL) |
                              (BigInt.one << TOKEN_Class) |
                              ...
                              (BigInt.one << TOKEN_DYNAMIC) |
                              (BigInt.one << TOKEN_ENCODE) |
                              (BigInt.one << TOKEN_END))) !=
                      BigInt.zero) ||
              ((((_la - 64)) & ~0x3f) == 0 &&
                  ((BigInt.one << (_la - 64)) &
                          ((BigInt.one << (TOKEN_FINALLY - 64)) |
                              (BigInt.one << (TOKEN_IMPLEMENTATION - 64)) |
                              (BigInt.one << (TOKEN_INTERFACE - 64)) |
                              (BigInt.one << (TOKEN_IMPORT - 64)) |
                              (BigInt.one << (TOKEN_PACKAGE - 64)) |
                              (BigInt.one << (TOKEN_PROTOCOL - 64)) |
                              (BigInt.one << (TOKEN_OPTIONAL - 64)) |
                              (BigInt.one << (TOKEN_PRIVATE - 64)) |
                              (BigInt.one << (TOKEN_PROPERTY - 64)) |
                              (BigInt.one << (TOKEN_PROTECTED - 64)) |
                              (BigInt.one << (TOKEN_PUBLIC - 64)) |
                              (BigInt.one << (TOKEN_REQUIRED - 64)) |
                              (BigInt.one << (TOKEN_SELECTOR - 64)) |
                              (BigInt.one << (TOKEN_SYNCHRONIZED - 64)) |
                              (BigInt.one << (TOKEN_SYNTHESIZE - 64)) |
                              (BigInt.one << (TOKEN_THROW - 64)) |
                              (BigInt.one << (TOKEN_TRY - 64)) |
                              (BigInt.one << (TOKEN_ATOMIC - 64)) |
                              (BigInt.one << (TOKEN_NONATOMIC - 64)) |
                              (BigInt.one << (TOKEN_RETAIN - 64)) |
                              (BigInt.one << (TOKEN_ATTRIBUTE - 64)) |
                              (BigInt.one <<
                                  (TOKEN_AUTORELEASING_QUALIFIER - 64)) |
                              (BigInt.one << (TOKEN_BLOCK - 64)) |
                              (BigInt.one << (TOKEN_BRIDGE - 64)) |
                              (BigInt.one << (TOKEN_BRIDGE_RETAINED - 64)) |
                              (BigInt.one << (TOKEN_BRIDGE_TRANSFER - 64)) |
                              (BigInt.one << (TOKEN_COVARIANT - 64)) |
                              (BigInt.one << (TOKEN_CONTRAVARIANT - 64)) |
                              (BigInt.one << (TOKEN_DEPRECATED - 64)) |
                              (BigInt.one << (TOKEN_KINDOF - 64)) |
                              (BigInt.one << (TOKEN_STRONG_QUALIFIER - 64)) |
                              (BigInt.one << (TOKEN_TYPEOF - 64)) |
                              (BigInt.one <<
                                  (TOKEN_UNSAFE_UNRETAINED_QUALIFIER - 64)) |
                              (BigInt.one << (TOKEN_UNUSED - 64)) |
                              (BigInt.one << (TOKEN_WEAK_QUALIFIER - 64)) |
                              (BigInt.one << (TOKEN_NULL_UNSPECIFIED - 64)) |
                              (BigInt.one << (TOKEN_NULLABLE - 64)) |
                              (BigInt.one << (TOKEN_NONNULL - 64)) |
                              (BigInt.one << (TOKEN_NULL_RESETTABLE - 64)) |
                              (BigInt.one << (TOKEN_NS_INLINE - 64)) |
                              (BigInt.one << (TOKEN_NS_ENUM - 64)) |
                              (BigInt.one << (TOKEN_NS_OPTIONS - 64)) |
                              (BigInt.one << (TOKEN_NS_CLOSED_ENUM - 64)) |
                              (BigInt.one <<
                                  (TOKEN_NS_TYPED_EXTENSIBLE_ENUM - 64)) |
                              (BigInt.one << (TOKEN_NS_ERROR_ENUM - 64)) |
                              (BigInt.one << (TOKEN_ASSIGN - 64)) |
                              (BigInt.one << (TOKEN_COPY - 64)) |
                              (BigInt.one << (TOKEN_GETTER - 64)) |
                              (BigInt.one << (TOKEN_SETTER - 64)) |
                              (BigInt.one << (TOKEN_STRONG - 64)) |
                              (BigInt.one << (TOKEN_READONLY - 64)) |
                              (BigInt.one << (TOKEN_READWRITE - 64)) |
                              (BigInt.one << (TOKEN_WEAK - 64)) |
                              (BigInt.one << (TOKEN_UNSAFE_UNRETAINED - 64)) |
                              (BigInt.one << (TOKEN_IB_OUTLET - 64)) |
                              (BigInt.one <<
                                  (TOKEN_IB_OUTLET_COLLECTION - 64)) |
                              (BigInt.one << (TOKEN_IB_INSPECTABLE - 64)) |
                              (BigInt.one << (TOKEN_IB_DESIGNABLE - 64)) |
                              (BigInt.one <<
                                  (TOKEN_NS_ASSUME_NONNULL_BEGIN - 64)) |
                              (BigInt.one <<
                                  (TOKEN_NS_ASSUME_NONNULL_END - 64)) |
                              (BigInt.one << (TOKEN_EXTERN_SUFFIX - 64)) |
                              (BigInt.one << (TOKEN_IOS_SUFFIX - 64)) |
                              (BigInt.one << (TOKEN_MAC_SUFFIX - 64)) |
                              (BigInt.one << (TOKEN_TVOS_PROHIBITED - 64)))) !=
                      BigInt.zero) ||
              ((((_la - 128)) & ~0x3f) == 0 &&
                  ((BigInt.one << (_la - 128)) &
                          ((BigInt.one << (TOKEN_NS_NOESCAPE - 128)) |
                              (BigInt.one << (TOKEN_EXPORT_SUFFIX - 128)) |
                              (BigInt.one <<
                                  (TOKEN_NS_RETURNS_RETAINED - 128)) |
                              (BigInt.one <<
                                  (TOKEN_NS_RETURNS_NOT_RETAINED - 128)) |
                              (BigInt.one <<
                                  (TOKEN_NS_RETURNS_INNER_POINTER - 128)) |
                              (BigInt.one <<
                                  (TOKEN_CF_RETURNS_RETAINED - 128)) |
                              (BigInt.one <<
                                  (TOKEN_CF_RETURNS_NOT_RETAINED - 128)) |
                              (BigInt.one << (TOKEN_CF_CONSUMED - 128)) |
                              (BigInt.one << (TOKEN_IDENTIFIER - 128)) |
                              (BigInt.one << (TOKEN_LP - 128)) |
                              (BigInt.one << (TOKEN_LBRACE - 128)) |
                              (BigInt.one << (TOKEN_RBRACE - 128)) |
                              (BigInt.one << (TOKEN_LBRACK - 128)) |
                              (BigInt.one << (TOKEN_RBRACK - 128)) |
                              (BigInt.one << (TOKEN_SEMI - 128)) |
                              (BigInt.one << (TOKEN_COMMA - 128)) |
                              (BigInt.one << (TOKEN_DOT - 128)) |
                              (BigInt.one << (TOKEN_STRUCTACCESS - 128)) |
                              (BigInt.one << (TOKEN_AT - 128)) |
                              (BigInt.one << (TOKEN_ASSIGNMENT - 128)) |
                              (BigInt.one << (TOKEN_GT - 128)) |
                              (BigInt.one << (TOKEN_LT - 128)) |
                              (BigInt.one << (TOKEN_BANG - 128)) |
                              (BigInt.one << (TOKEN_TILDE - 128)) |
                              (BigInt.one << (TOKEN_QUESTION - 128)) |
                              (BigInt.one << (TOKEN_COLON - 128)) |
                              (BigInt.one << (TOKEN_EQUAL - 128)) |
                              (BigInt.one << (TOKEN_LE - 128)) |
                              (BigInt.one << (TOKEN_GE - 128)) |
                              (BigInt.one << (TOKEN_NOTEQUAL - 128)) |
                              (BigInt.one << (TOKEN_AND - 128)) |
                              (BigInt.one << (TOKEN_OR - 128)) |
                              (BigInt.one << (TOKEN_INC - 128)) |
                              (BigInt.one << (TOKEN_DEC - 128)) |
                              (BigInt.one << (TOKEN_ADD - 128)) |
                              (BigInt.one << (TOKEN_SUB - 128)) |
                              (BigInt.one << (TOKEN_MUL - 128)) |
                              (BigInt.one << (TOKEN_DIV - 128)) |
                              (BigInt.one << (TOKEN_BITAND - 128)) |
                              (BigInt.one << (TOKEN_BITOR - 128)) |
                              (BigInt.one << (TOKEN_BITXOR - 128)) |
                              (BigInt.one << (TOKEN_MOD - 128)) |
                              (BigInt.one << (TOKEN_ADD_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_SUB_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_MUL_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_DIV_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_AND_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_OR_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_XOR_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_MOD_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_LSHIFT_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_RSHIFT_ASSIGN - 128)) |
                              (BigInt.one << (TOKEN_ELIPSIS - 128)) |
                              (BigInt.one << (TOKEN_CHARACTER_LITERAL - 128)) |
                              (BigInt.one << (TOKEN_STRING_START - 128)) |
                              (BigInt.one << (TOKEN_HEX_LITERAL - 128)) |
                              (BigInt.one << (TOKEN_OCTAL_LITERAL - 128)) |
                              (BigInt.one << (TOKEN_BINARY_LITERAL - 128)) |
                              (BigInt.one << (TOKEN_DECIMAL_LITERAL - 128)) |
                              (BigInt.one <<
                                  (TOKEN_FLOATING_POINT_LITERAL - 128)) |
                              (BigInt.one << (TOKEN_VERSION_SEMATIC - 128)) |
                              (BigInt.one << (TOKEN_WS - 128)) |
                              (BigInt.one << (TOKEN_MULTI_COMMENT - 128)))) !=
                      BigInt.zero) ||
              ((((_la - 192)) & ~0x3f) == 0 &&
                  ((BigInt.one << (_la - 192)) &
                          ((BigInt.one << (TOKEN_SINGLE_COMMENT - 192)) |
                              (BigInt.one << (TOKEN_BACKSLASH - 192)) |
                              (BigInt.one << (TOKEN_SHARP - 192)) |
                              (BigInt.one << (TOKEN_STRING_NEWLINE - 192)) |
                              (BigInt.one << (TOKEN_STRING_END - 192)) |
                              (BigInt.one << (TOKEN_STRING_VALUE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_IMPORT - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_INCLUDE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_PRAGMA - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_DEFINE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_DEFINED - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_IF - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_ELIF - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_ELSE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_UNDEF - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_IFDEF - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_IFNDEF - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_ENDIF - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_TRUE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_FALSE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_ERROR - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_WARNING - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_BANG - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_LP - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_RP - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_EQUAL - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_NOTEQUAL - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_AND - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_OR - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_LT - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_GT - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_LE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_GE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_ADD - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_SUB - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_MUL - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_DIV - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_BITAND - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_BITOR - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_BITXOR - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_MOD - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_DOT - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_STRING - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_ID - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_DECIMAL_LITERAL - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_FLOAT - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_NEWLINE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_MULTI_COMMENT - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_SINGLE_COMMENT - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_BACKSLASH_NEWLINE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_TEXT_NEWLINE - 192)) |
                              (BigInt.one << (TOKEN_DIRECTIVE_TEXT - 192)))) !=
                      BigInt.zero));
          state = 1818;
          match(TOKEN_RP);
          break;
    ...
    try {
      ...
      if (_la == TOKEN_LP) {
        ...
        if (!(((((_la - 136)) & ~0x3f) == 0 &&
            ((BigInt.one << (_la - 136)) &
                    ((BigInt.one << (TOKEN_IDENTIFIER - 136)) |
                        (BigInt.one << (TOKEN_FLOATING_POINT_LITERAL - 136)) |
                        (BigInt.one << (TOKEN_VERSION_SEMATIC - 136)))) !=
                BigInt.zero))) {
  ...
  bool _postfixExpression_sempred(
      PostfixExpressionContext _localctx, int predIndex) {
    switch (predIndex) {
      case 11:
...
class TranslationUnitContext extends ParserRuleContext {
  ...
  List<TopLevelDeclarationContext> topLevelDeclarations() =>
      getRuleContexts<TopLevelDeclarationContext>();
  TopLevelDeclarationContext topLevelDeclaration(int i) =>
      getRuleContext<TopLevelDeclarationContext>(i);
...
class TopLevelDeclarationContext extends ParserRuleContext {
  ImportDeclarationContext importDeclaration() =>
      getRuleContext<ImportDeclarationContext>(0);
  FunctionDeclarationContext functionDeclaration() =>
      getRuleContext<FunctionDeclarationContext>(0);
  DeclarationContext declaration() => getRuleContext<DeclarationContext>(0);
  ClassInterfaceContext classInterface() =>
      getRuleContext<ClassInterfaceContext>(0);
  ClassImplementationContext classImplementation() =>
      getRuleContext<ClassImplementationContext>(0);
  CategoryInterfaceContext categoryInterface() =>
      getRuleContext<CategoryInterfaceContext>(0);
  CategoryImplementationContext categoryImplementation() =>
      getRuleContext<CategoryImplementationContext>(0);
  ProtocolDeclarationContext protocolDeclaration() =>
      getRuleContext<ProtocolDeclarationContext>(0);
  ProtocolDeclarationListContext protocolDeclarationList() =>
      getRuleContext<ProtocolDeclarationListContext>(0);
  ClassDeclarationListContext classDeclarationList() =>
      getRuleContext<ClassDeclarationListContext>(0);
  FunctionDefinitionContext functionDefinition() =>
      getRuleContext<FunctionDefinitionContext>(0);
  TopLevelDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ImportDeclarationContext extends ParserRuleContext {
  ...
  StringLiteralContext stringLiteral() =>
      getRuleContext<StringLiteralContext>(0);
  ...
  ImportDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassInterfaceContext extends ParserRuleContext {
  ...
  GenericTypeSpecifierContext genericTypeSpecifier() =>
      getRuleContext<GenericTypeSpecifierContext>(0);
  TerminalNode IB_DESIGNABLE() =>
      getToken(ObjectiveCParser.TOKEN_IB_DESIGNABLE, 0);
  List<MacroContext> macros() => getRuleContexts<MacroContext>();
  MacroContext macro(int i) => getRuleContext<MacroContext>(i);
  List<AttributeSpecifierContext> attributeSpecifiers() =>
      getRuleContexts<AttributeSpecifierContext>();
  AttributeSpecifierContext attributeSpecifier(int i) =>
      getRuleContext<AttributeSpecifierContext>(i);
  TerminalNode COLON() => getToken(ObjectiveCParser.TOKEN_COLON, 0);
  TerminalNode LT() => getToken(ObjectiveCParser.TOKEN_LT, 0);
  TerminalNode GT() => getToken(ObjectiveCParser.TOKEN_GT, 0);
  InstanceVariablesContext instanceVariables() =>
      getRuleContext<InstanceVariablesContext>(0);
  InterfaceDeclarationListContext interfaceDeclarationList() =>
      getRuleContext<InterfaceDeclarationListContext>(0);
  ...
  ClassInterfaceContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class CategoryInterfaceContext extends ParserRuleContext {
  ...
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  ProtocolListContext protocolList() => getRuleContext<ProtocolListContext>(0);
  CategoryInterfaceContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassImplementationContext extends ParserRuleContext {
  ...
  TerminalNode IMPLEMENTATION() =>
      getToken(ObjectiveCParser.TOKEN_IMPLEMENTATION, 0);
  TerminalNode END() => getToken(ObjectiveCParser.TOKEN_END, 0);
  GenericTypeSpecifierContext genericTypeSpecifier() =>
      getRuleContext<GenericTypeSpecifierContext>(0);
  TerminalNode COLON() => getToken(ObjectiveCParser.TOKEN_COLON, 0);
  InstanceVariablesContext instanceVariables() =>
      getRuleContext<InstanceVariablesContext>(0);
  ImplementationDefinitionListContext implementationDefinitionList() =>
      getRuleContext<ImplementationDefinitionListContext>(0);
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  ClassImplementationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class CategoryImplementationContext extends ParserRuleContext {
  ...
  ImplementationDefinitionListContext implementationDefinitionList() =>
      getRuleContext<ImplementationDefinitionListContext>(0);
  CategoryImplementationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class GenericTypeSpecifierContext extends ParserRuleContext {
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  GenericsSpecifierContext genericsSpecifier() =>
      getRuleContext<GenericsSpecifierContext>(0);
  TerminalNode LT() => getToken(ObjectiveCParser.TOKEN_LT, 0);
  ProtocolListContext protocolList() => getRuleContext<ProtocolListContext>(0);
  TerminalNode GT() => getToken(ObjectiveCParser.TOKEN_GT, 0);
  GenericTypeSpecifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ProtocolDeclarationContext extends ParserRuleContext {
  ...
  TerminalNode LT() => getToken(ObjectiveCParser.TOKEN_LT, 0);
  TerminalNode GT() => getToken(ObjectiveCParser.TOKEN_GT, 0);
  List<ProtocolDeclarationSectionContext> protocolDeclarationSections() =>
      getRuleContexts<ProtocolDeclarationSectionContext>();
  ProtocolDeclarationSectionContext protocolDeclarationSection(int i) =>
      getRuleContext<ProtocolDeclarationSectionContext>(i);
  ProtocolListContext protocolList() => getRuleContext<ProtocolListContext>(0);
  ProtocolDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ProtocolDeclarationSectionContext extends ParserRuleContext {
  ...
  List<InterfaceDeclarationListContext> interfaceDeclarationLists() =>
      getRuleContexts<InterfaceDeclarationListContext>();
  InterfaceDeclarationListContext interfaceDeclarationList(int i) =>
      getRuleContext<InterfaceDeclarationListContext>(i);
...
class ProtocolDeclarationListContext extends ParserRuleContext {
  ...
  ProtocolListContext protocolList() => getRuleContext<ProtocolListContext>(0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  ProtocolDeclarationListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassDeclarationListContext extends ParserRuleContext {
  ...
  List<ClassDeclarationContext> classDeclarations() =>
      getRuleContexts<ClassDeclarationContext>();
  ClassDeclarationContext classDeclaration(int i) =>
      getRuleContext<ClassDeclarationContext>(i);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  ...
  ClassDeclarationListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ProtocolListContext extends ParserRuleContext {
  ...
  List<ProtocolNameContext> protocolNames() =>
      getRuleContexts<ProtocolNameContext>();
  ProtocolNameContext protocolName(int i) =>
      getRuleContext<ProtocolNameContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  ProtocolListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PropertyDeclarationContext extends ParserRuleContext {
  ...
  TerminalNode LP() => getToken(ObjectiveCParser.TOKEN_LP, 0);
  PropertyAttributesListContext propertyAttributesList() =>
      getRuleContext<PropertyAttributesListContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  IbOutletQualifierContext ibOutletQualifier() =>
      getRuleContext<IbOutletQualifierContext>(0);
  TerminalNode IB_INSPECTABLE() =>
      getToken(ObjectiveCParser.TOKEN_IB_INSPECTABLE, 0);
...
class PropertyAttributesListContext extends ParserRuleContext {
  List<PropertyAttributeContext> propertyAttributes() =>
      getRuleContexts<PropertyAttributeContext>();
  PropertyAttributeContext propertyAttribute(int i) =>
      getRuleContext<PropertyAttributeContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  PropertyAttributesListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PropertyAttributeContext extends ParserRuleContext {
  ...
  TerminalNode UNSAFE_UNRETAINED() =>
      getToken(ObjectiveCParser.TOKEN_UNSAFE_UNRETAINED, 0);
  ...
  TerminalNode COLON() => getToken(ObjectiveCParser.TOKEN_COLON, 0);
  NullabilitySpecifierContext nullabilitySpecifier() =>
      getRuleContext<NullabilitySpecifierContext>(0);
  PropertyAttributeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ProtocolNameContext extends ParserRuleContext {
  ...
  TerminalNode CONTRAVARIANT() =>
      getToken(ObjectiveCParser.TOKEN_CONTRAVARIANT, 0);
  ProtocolNameContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InstanceVariablesContext extends ParserRuleContext {
  ...
  List<VisibilitySectionContext> visibilitySections() =>
      getRuleContexts<VisibilitySectionContext>();
  VisibilitySectionContext visibilitySection(int i) =>
      getRuleContext<VisibilitySectionContext>(i);
  InstanceVariablesContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class VisibilitySectionContext extends ParserRuleContext {
  ...
  List<FieldDeclarationContext> fieldDeclarations() =>
      getRuleContexts<FieldDeclarationContext>();
  FieldDeclarationContext fieldDeclaration(int i) =>
      getRuleContext<FieldDeclarationContext>(i);
  VisibilitySectionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InterfaceDeclarationListContext extends ParserRuleContext {
  ...
  List<ClassMethodDeclarationContext> classMethodDeclarations() =>
      getRuleContexts<ClassMethodDeclarationContext>();
  ClassMethodDeclarationContext classMethodDeclaration(int i) =>
      getRuleContext<ClassMethodDeclarationContext>(i);
  List<InstanceMethodDeclarationContext> instanceMethodDeclarations() =>
      getRuleContexts<InstanceMethodDeclarationContext>();
  InstanceMethodDeclarationContext instanceMethodDeclaration(int i) =>
      getRuleContext<InstanceMethodDeclarationContext>(i);
  List<PropertyDeclarationContext> propertyDeclarations() =>
      getRuleContexts<PropertyDeclarationContext>();
  PropertyDeclarationContext propertyDeclaration(int i) =>
      getRuleContext<PropertyDeclarationContext>(i);
  List<FunctionDeclarationContext> functionDeclarations() =>
      getRuleContexts<FunctionDeclarationContext>();
  FunctionDeclarationContext functionDeclaration(int i) =>
      getRuleContext<FunctionDeclarationContext>(i);
  InterfaceDeclarationListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ClassMethodDeclarationContext extends ParserRuleContext {
  ...
  ClassMethodDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodDeclarationContext extends ParserRuleContext {
  MethodSelectorContext methodSelector() =>
      getRuleContext<MethodSelectorContext>(0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
...
class ImplementationDefinitionListContext extends ParserRuleContext {
  List<FunctionDefinitionContext> functionDefinitions() =>
      getRuleContexts<FunctionDefinitionContext>();
  FunctionDefinitionContext functionDefinition(int i) =>
      getRuleContext<FunctionDefinitionContext>(i);
  List<DeclarationContext> declarations() =>
      getRuleContexts<DeclarationContext>();
  DeclarationContext declaration(int i) =>
      getRuleContext<DeclarationContext>(i);
  List<ClassMethodDefinitionContext> classMethodDefinitions() =>
      getRuleContexts<ClassMethodDefinitionContext>();
  ClassMethodDefinitionContext classMethodDefinition(int i) =>
      getRuleContext<ClassMethodDefinitionContext>(i);
  List<InstanceMethodDefinitionContext> instanceMethodDefinitions() =>
      getRuleContexts<InstanceMethodDefinitionContext>();
  InstanceMethodDefinitionContext instanceMethodDefinition(int i) =>
      getRuleContext<InstanceMethodDefinitionContext>(i);
  List<PropertyImplementationContext> propertyImplementations() =>
      getRuleContexts<PropertyImplementationContext>();
  PropertyImplementationContext propertyImplementation(int i) =>
      getRuleContext<PropertyImplementationContext>(i);
...
class ClassMethodDefinitionContext extends ParserRuleContext {
  TerminalNode ADD() => getToken(ObjectiveCParser.TOKEN_ADD, 0);
  MethodDefinitionContext methodDefinition() =>
      getRuleContext<MethodDefinitionContext>(0);
  ClassMethodDefinitionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InstanceMethodDefinitionContext extends ParserRuleContext {
  ...
  MethodDefinitionContext methodDefinition() =>
      getRuleContext<MethodDefinitionContext>(0);
  InstanceMethodDefinitionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodDefinitionContext extends ParserRuleContext {
  ...
  MethodTypeContext methodType() => getRuleContext<MethodTypeContext>(0);
  InitDeclaratorListContext initDeclaratorList() =>
      getRuleContext<InitDeclaratorListContext>(0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  MethodDefinitionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodSelectorContext extends ParserRuleContext {
  ...
  List<KeywordDeclaratorContext> keywordDeclarators() =>
      getRuleContexts<KeywordDeclaratorContext>();
  KeywordDeclaratorContext keywordDeclarator(int i) =>
      getRuleContext<KeywordDeclaratorContext>(i);
  TerminalNode COMMA() => getToken(ObjectiveCParser.TOKEN_COMMA, 0);
  TerminalNode ELIPSIS() => getToken(ObjectiveCParser.TOKEN_ELIPSIS, 0);
  MethodSelectorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class KeywordDeclaratorContext extends ParserRuleContext {
  ...
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  ArcBehaviourSpecifierContext arcBehaviourSpecifier() =>
      getRuleContext<ArcBehaviourSpecifierContext>(0);
  SelectorContext selector() => getRuleContext<SelectorContext>(0);
  ...
  KeywordDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MethodTypeContext extends ParserRuleContext {
  ...
  TypeNameContext typeName() => getRuleContext<TypeNameContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  MethodTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PropertyImplementationContext extends ParserRuleContext {
  ...
  PropertySynthesizeListContext propertySynthesizeList() =>
      getRuleContext<PropertySynthesizeListContext>(0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  TerminalNode DYNAMIC() => getToken(ObjectiveCParser.TOKEN_DYNAMIC, 0);
  PropertyImplementationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PropertySynthesizeListContext extends ParserRuleContext {
  List<PropertySynthesizeItemContext> propertySynthesizeItems() =>
      getRuleContexts<PropertySynthesizeItemContext>();
  PropertySynthesizeItemContext propertySynthesizeItem(int i) =>
      getRuleContext<PropertySynthesizeItemContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  PropertySynthesizeListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PropertySynthesizeItemContext extends ParserRuleContext {
  ...
  IdentifierContext identifier(int i) => getRuleContext<IdentifierContext>(i);
  TerminalNode ASSIGNMENT() => getToken(ObjectiveCParser.TOKEN_ASSIGNMENT, 0);
  PropertySynthesizeItemContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class BlockTypeContext extends ParserRuleContext {
  ...
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  List<NullabilitySpecifierContext> nullabilitySpecifiers() =>
      getRuleContexts<NullabilitySpecifierContext>();
  NullabilitySpecifierContext nullabilitySpecifier(int i) =>
      getRuleContext<NullabilitySpecifierContext>(i);
  BlockParametersContext blockParameters() =>
      getRuleContext<BlockParametersContext>(0);
  BlockTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class GenericsSpecifierContext extends ParserRuleContext {
  TerminalNode LT() => getToken(ObjectiveCParser.TOKEN_LT, 0);
  TerminalNode GT() => getToken(ObjectiveCParser.TOKEN_GT, 0);
  List<TypeSpecifierWithPrefixesContext> typeSpecifierWithPrefixess() =>
      getRuleContexts<TypeSpecifierWithPrefixesContext>();
  TypeSpecifierWithPrefixesContext typeSpecifierWithPrefixes(int i) =>
      getRuleContext<TypeSpecifierWithPrefixesContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  GenericsSpecifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DictionaryExpressionContext extends ParserRuleContext {
  ...
  TerminalNode LBRACE() => getToken(ObjectiveCParser.TOKEN_LBRACE, 0);
  TerminalNode RBRACE() => getToken(ObjectiveCParser.TOKEN_RBRACE, 0);
  List<DictionaryPairContext> dictionaryPairs() =>
      getRuleContexts<DictionaryPairContext>();
  DictionaryPairContext dictionaryPair(int i) =>
      getRuleContext<DictionaryPairContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  DictionaryExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DictionaryPairContext extends ParserRuleContext {
  CastExpressionContext castExpression() =>
      getRuleContext<CastExpressionContext>(0);
  TerminalNode COLON() => getToken(ObjectiveCParser.TOKEN_COLON, 0);
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  DictionaryPairContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArrayExpressionContext extends ParserRuleContext {
  ...
  TerminalNode COMMA() => getToken(ObjectiveCParser.TOKEN_COMMA, 0);
  ArrayExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class BoxExpressionContext extends ParserRuleContext {
  ...
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  BoxExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class BlockParametersContext extends ParserRuleContext {
  ...
  List<TypeVariableDeclaratorOrNameContext> types =
      List<TypeVariableDeclaratorOrNameContext>();
  TerminalNode LP() => getToken(ObjectiveCParser.TOKEN_LP, 0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  TerminalNode VOID() => getToken(ObjectiveCParser.TOKEN_VOID, 0);
  List<TypeVariableDeclaratorOrNameContext> typeVariableDeclaratorOrNames() =>
      getRuleContexts<TypeVariableDeclaratorOrNameContext>();
  TypeVariableDeclaratorOrNameContext typeVariableDeclaratorOrName(int i) =>
      getRuleContext<TypeVariableDeclaratorOrNameContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  BlockParametersContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeVariableDeclaratorOrNameContext extends ParserRuleContext {
  TypeVariableDeclaratorContext typeVariableDeclarator() =>
      getRuleContext<TypeVariableDeclaratorContext>(0);
  TypeNameContext typeName() => getRuleContext<TypeNameContext>(0);
...
class BlockExpressionContext extends ParserRuleContext {
  ...
  BlockParametersContext blockParameters() =>
      getRuleContext<BlockParametersContext>(0);
  BlockExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MessageExpressionContext extends ParserRuleContext {
  ...
  MessageSelectorContext messageSelector() =>
      getRuleContext<MessageSelectorContext>(0);
  TerminalNode RBRACK() => getToken(ObjectiveCParser.TOKEN_RBRACK, 0);
  MessageExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MessageSelectorContext extends ParserRuleContext {
  SelectorContext selector() => getRuleContext<SelectorContext>(0);
  List<KeywordArgumentContext> keywordArguments() =>
      getRuleContexts<KeywordArgumentContext>();
  KeywordArgumentContext keywordArgument(int i) =>
      getRuleContext<KeywordArgumentContext>(i);
  MessageSelectorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class KeywordArgumentContext extends ParserRuleContext {
  TerminalNode COLON() => getToken(ObjectiveCParser.TOKEN_COLON, 0);
  List<KeywordArgumentTypeContext> keywordArgumentTypes() =>
      getRuleContexts<KeywordArgumentTypeContext>();
  KeywordArgumentTypeContext keywordArgumentType(int i) =>
      getRuleContext<KeywordArgumentTypeContext>(i);
  SelectorContext selector() => getRuleContext<SelectorContext>(0);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  KeywordArgumentContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class KeywordArgumentTypeContext extends ParserRuleContext {
  ...
  TerminalNode LBRACE() => getToken(ObjectiveCParser.TOKEN_LBRACE, 0);
  InitializerListContext initializerList() =>
      getRuleContext<InitializerListContext>(0);
  TerminalNode RBRACE() => getToken(ObjectiveCParser.TOKEN_RBRACE, 0);
  KeywordArgumentTypeContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SelectorExpressionContext extends ParserRuleContext {
  ...
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  SelectorExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SelectorNameContext extends ParserRuleContext {
  ...
  SelectorNameContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ProtocolExpressionContext extends ParserRuleContext {
  ...
  ProtocolNameContext protocolName() => getRuleContext<ProtocolNameContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  ProtocolExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EncodeExpressionContext extends ParserRuleContext {
  ...
  TypeNameContext typeName() => getRuleContext<TypeNameContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  EncodeExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeVariableDeclaratorContext extends ParserRuleContext {
  DeclarationSpecifiersContext declarationSpecifiers() =>
      getRuleContext<DeclarationSpecifiersContext>(0);
  DeclaratorContext declarator() => getRuleContext<DeclaratorContext>(0);
  TypeVariableDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TryBlockContext extends ParserRuleContext {
  ...
  List<CompoundStatementContext> compoundStatements() =>
      getRuleContexts<CompoundStatementContext>();
  CompoundStatementContext compoundStatement(int i) =>
      getRuleContext<CompoundStatementContext>(i);
  List<CatchStatementContext> catchStatements() =>
      getRuleContexts<CatchStatementContext>();
  CatchStatementContext catchStatement(int i) =>
      getRuleContext<CatchStatementContext>(i);
  TerminalNode FINALLY() => getToken(ObjectiveCParser.TOKEN_FINALLY, 0);
  TryBlockContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class CatchStatementContext extends ParserRuleContext {
  ...
  CompoundStatementContext compoundStatement() =>
      getRuleContext<CompoundStatementContext>(0);
  CatchStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SynchronizedStatementContext extends ParserRuleContext {
  TerminalNode SYNCHRONIZED() =>
      getToken(ObjectiveCParser.TOKEN_SYNCHRONIZED, 0);
  TerminalNode LP() => getToken(ObjectiveCParser.TOKEN_LP, 0);
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  CompoundStatementContext compoundStatement() =>
      getRuleContext<CompoundStatementContext>(0);
  SynchronizedStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AutoreleaseStatementContext extends ParserRuleContext {
  TerminalNode AUTORELEASEPOOL() =>
      getToken(ObjectiveCParser.TOKEN_AUTORELEASEPOOL, 0);
  CompoundStatementContext compoundStatement() =>
      getRuleContext<CompoundStatementContext>(0);
  AutoreleaseStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FunctionDeclarationContext extends ParserRuleContext {
  FunctionSignatureContext functionSignature() =>
      getRuleContext<FunctionSignatureContext>(0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  List<MacroContext> macros() => getRuleContexts<MacroContext>();
  MacroContext macro(int i) => getRuleContext<MacroContext>(i);
  List<AttributeSpecifierContext> attributeSpecifiers() =>
  ...
  AttributeSpecifierContext attributeSpecifier(int i) =>
      getRuleContext<AttributeSpecifierContext>(i);
  FunctionDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FunctionSignatureContext extends ParserRuleContext {
  ...
  DeclarationSpecifiersContext declarationSpecifiers() =>
      getRuleContext<DeclarationSpecifiersContext>(0);
  AttributeSpecifierContext attributeSpecifier() =>
      getRuleContext<AttributeSpecifierContext>(0);
  ParameterListContext parameterList() =>
      getRuleContext<ParameterListContext>(0);
  FunctionSignatureContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FunctionPointerContext extends ParserRuleContext {
  ...
  ParameterListContext parameterList() =>
      getRuleContext<ParameterListContext>(0);
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  FunctionPointerContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AttributeContext extends ParserRuleContext {
  ...
  AttributeParametersContext attributeParameters() =>
      getRuleContext<AttributeParametersContext>(0);
...
class AttributeParametersContext extends ParserRuleContext {
  ...
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  AttributeParameterListContext attributeParameterList() =>
      getRuleContext<AttributeParameterListContext>(0);
  AttributeParametersContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AttributeParameterListContext extends ParserRuleContext {
  List<AttributeParameterContext> attributeParameters() =>
      getRuleContexts<AttributeParameterContext>();
  AttributeParameterContext attributeParameter(int i) =>
      getRuleContext<AttributeParameterContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  AttributeParameterListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AttributeParameterContext extends ParserRuleContext {
  ...
  StringLiteralContext stringLiteral() =>
      getRuleContext<StringLiteralContext>(0);
  AttributeParameterAssignmentContext attributeParameterAssignment() =>
      getRuleContext<AttributeParameterAssignmentContext>(0);
  AttributeParameterContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AttributeParameterAssignmentContext extends ParserRuleContext {
  List<AttributeNameContext> attributeNames() =>
      getRuleContexts<AttributeNameContext>();
  AttributeNameContext attributeName(int i) =>
      getRuleContext<AttributeNameContext>(i);
  TerminalNode ASSIGNMENT() => getToken(ObjectiveCParser.TOKEN_ASSIGNMENT, 0);
  ConstantContext constant() => getRuleContext<ConstantContext>(0);
  StringLiteralContext stringLiteral() =>
      getRuleContext<StringLiteralContext>(0);
...
class DeclarationContext extends ParserRuleContext {
  FunctionCallExpressionContext functionCallExpression() =>
      getRuleContext<FunctionCallExpressionContext>(0);
  EnumDeclarationContext enumDeclaration() =>
      getRuleContext<EnumDeclarationContext>(0);
  VarDeclarationContext varDeclaration() =>
      getRuleContext<VarDeclarationContext>(0);
  TypedefDeclarationContext typedefDeclaration() =>
      getRuleContext<TypedefDeclarationContext>(0);
...
class FunctionCallExpressionContext extends ParserRuleContext {
  ...
  TerminalNode LP() => getToken(ObjectiveCParser.TOKEN_LP, 0);
  DirectDeclaratorContext directDeclarator() =>
      getRuleContext<DirectDeclaratorContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  List<AttributeSpecifierContext> attributeSpecifiers() =>
      getRuleContexts<AttributeSpecifierContext>();
  AttributeSpecifierContext attributeSpecifier(int i) =>
      getRuleContext<AttributeSpecifierContext>(i);
  FunctionCallExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumDeclarationContext extends ParserRuleContext {
  IdentifierContext name;
  EnumSpecifierContext enumSpecifier() =>
      getRuleContext<EnumSpecifierContext>(0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  List<MacroContext> macros() => getRuleContexts<MacroContext>();
  MacroContext macro(int i) => getRuleContext<MacroContext>(i);
  List<AttributeSpecifierContext> attributeSpecifiers() =>
...
class VarDeclarationContext extends ParserRuleContext {
  ...
  AttributeSpecifierContext attributeSpecifier(int i) =>
      getRuleContext<AttributeSpecifierContext>(i);
  VarDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypedefDeclarationContext extends ParserRuleContext {
  ...
  DeclarationSpecifiersContext declarationSpecifiers() =>
      getRuleContext<DeclarationSpecifiersContext>(0);
  TypeDeclaratorListContext typeDeclaratorList() =>
      getRuleContext<TypeDeclaratorListContext>(0);
  FunctionPointerContext functionPointer() =>
      getRuleContext<FunctionPointerContext>(0);
  FunctionSignatureContext functionSignature() =>
      getRuleContext<FunctionSignatureContext>(0);
  StructOrUnionSpecifierContext structOrUnionSpecifier() =>
      getRuleContext<StructOrUnionSpecifierContext>(0);
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  List<AttributeSpecifierContext> attributeSpecifiers() =>
      getRuleContexts<AttributeSpecifierContext>();
  AttributeSpecifierContext attributeSpecifier(int i) =>
  ...
  List<MacroContext> macros() => getRuleContexts<MacroContext>();
  MacroContext macro(int i) => getRuleContext<MacroContext>(i);
  TypedefDeclarationContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeDeclaratorListContext extends ParserRuleContext {
  List<TypeDeclaratorContext> typeDeclarators() =>
      getRuleContexts<TypeDeclaratorContext>();
  TypeDeclaratorContext typeDeclarator(int i) =>
      getRuleContext<TypeDeclaratorContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  TypeDeclaratorListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeDeclaratorContext extends ParserRuleContext {
  ...
  TypeDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class CommonSpecifiersContext extends ParserRuleContext {
  List<ArcBehaviourSpecifierContext> arcBehaviourSpecifiers() =>
      getRuleContexts<ArcBehaviourSpecifierContext>();
  ArcBehaviourSpecifierContext arcBehaviourSpecifier(int i) =>
      getRuleContext<ArcBehaviourSpecifierContext>(i);
  List<NullabilitySpecifierContext> nullabilitySpecifiers() =>
      getRuleContexts<NullabilitySpecifierContext>();
  NullabilitySpecifierContext nullabilitySpecifier(int i) =>
      getRuleContext<NullabilitySpecifierContext>(i);
  List<IbOutletQualifierContext> ibOutletQualifiers() =>
      getRuleContexts<IbOutletQualifierContext>();
  IbOutletQualifierContext ibOutletQualifier(int i) =>
      getRuleContext<IbOutletQualifierContext>(i);
  List<TypePrefixContext> typePrefixs() => getRuleContexts<TypePrefixContext>();
  TypePrefixContext typePrefix(int i) => getRuleContext<TypePrefixContext>(i);
  List<TypeQualifierContext> typeQualifiers() =>
      getRuleContexts<TypeQualifierContext>();
  TypeQualifierContext typeQualifier(int i) =>
      getRuleContext<TypeQualifierContext>(i);
  CommonSpecifiersContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DeclarationSpecifiersContext extends ParserRuleContext {
  List<StorageClassSpecifierContext> storageClassSpecifiers() =>
      getRuleContexts<StorageClassSpecifierContext>();
  StorageClassSpecifierContext storageClassSpecifier(int i) =>
      getRuleContext<StorageClassSpecifierContext>(i);
  List<AttributeSpecifierContext> attributeSpecifiers() =>
      getRuleContexts<AttributeSpecifierContext>();
  AttributeSpecifierContext attributeSpecifier(int i) =>
      getRuleContext<AttributeSpecifierContext>(i);
  List<CommonSpecifiersContext> commonSpecifierss() =>
      getRuleContexts<CommonSpecifiersContext>();
  CommonSpecifiersContext commonSpecifiers(int i) =>
      getRuleContext<CommonSpecifiersContext>(i);
  List<TypeSpecifierContext> typeSpecifiers() =>
      getRuleContexts<TypeSpecifierContext>();
  TypeSpecifierContext typeSpecifier(int i) =>
      getRuleContext<TypeSpecifierContext>(i);
  DeclarationSpecifiersContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PointerQualifierContext extends ParserRuleContext {
  ...
  CommonSpecifiersContext commonSpecifiers(int i) =>
      getRuleContext<CommonSpecifiersContext>(i);
  PointerQualifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AttributeSpecifierContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  AttributeSpecifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InitDeclaratorListContext extends ParserRuleContext {
  List<InitDeclaratorContext> initDeclarators() =>
      getRuleContexts<InitDeclaratorContext>();
  InitDeclaratorContext initDeclarator(int i) =>
      getRuleContext<InitDeclaratorContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  InitDeclaratorListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InitDeclaratorContext extends ParserRuleContext {
  ...
  InitDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class StructOrUnionSpecifierContext extends ParserRuleContext {
  ...
  FieldDeclarationContext fieldDeclaration(int i) =>
      getRuleContext<FieldDeclarationContext>(i);
  StructOrUnionSpecifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FieldDeclarationContext extends ParserRuleContext {
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  SpecifierQualifierListContext specifierQualifierList() =>
      getRuleContext<SpecifierQualifierListContext>(0);
  FieldDeclaratorListContext fieldDeclaratorList() =>
      getRuleContext<FieldDeclaratorListContext>(0);
  FunctionPointerContext functionPointer() =>
      getRuleContext<FunctionPointerContext>(0);
  List<MacroContext> macros() => getRuleContexts<MacroContext>();
  MacroContext macro(int i) => getRuleContext<MacroContext>(i);
...
class SpecifierQualifierListContext extends ParserRuleContext {
  ...
  TypeSpecifierContext typeSpecifier(int i) =>
      getRuleContext<TypeSpecifierContext>(i);
  SpecifierQualifierListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class IbOutletQualifierContext extends ParserRuleContext {
  TerminalNode IB_OUTLET_COLLECTION() =>
      getToken(ObjectiveCParser.TOKEN_IB_OUTLET_COLLECTION, 0);
  TerminalNode LP() => getToken(ObjectiveCParser.TOKEN_LP, 0);
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  TerminalNode IB_OUTLET() => getToken(ObjectiveCParser.TOKEN_IB_OUTLET, 0);
  IbOutletQualifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArcBehaviourSpecifierContext extends ParserRuleContext {
  TerminalNode WEAK_QUALIFIER() =>
      getToken(ObjectiveCParser.TOKEN_WEAK_QUALIFIER, 0);
  TerminalNode STRONG_QUALIFIER() =>
      getToken(ObjectiveCParser.TOKEN_STRONG_QUALIFIER, 0);
  TerminalNode AUTORELEASING_QUALIFIER() =>
      getToken(ObjectiveCParser.TOKEN_AUTORELEASING_QUALIFIER, 0);
  TerminalNode UNSAFE_UNRETAINED_QUALIFIER() =>
      getToken(ObjectiveCParser.TOKEN_UNSAFE_UNRETAINED_QUALIFIER, 0);
  ArcBehaviourSpecifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class NullabilitySpecifierContext extends ParserRuleContext {
  TerminalNode NULL_UNSPECIFIED() =>
      getToken(ObjectiveCParser.TOKEN_NULL_UNSPECIFIED, 0);
  ...
  TerminalNode NULL_RESETTABLE() =>
      getToken(ObjectiveCParser.TOKEN_NULL_RESETTABLE, 0);
  NullabilitySpecifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class StorageClassSpecifierContext extends ParserRuleContext {
  ...
  StorageClassSpecifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypePrefixContext extends ParserRuleContext {
  ...
  TerminalNode BRIDGE_TRANSFER() =>
      getToken(ObjectiveCParser.TOKEN_BRIDGE_TRANSFER, 0);
  TerminalNode BRIDGE_RETAINED() =>
      getToken(ObjectiveCParser.TOKEN_BRIDGE_RETAINED, 0);
  ...
  TypePrefixContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeQualifierContext extends ParserRuleContext {
  ...
  ProtocolQualifierContext protocolQualifier() =>
      getRuleContext<ProtocolQualifierContext>(0);
...
class ProtocolQualifierContext extends ParserRuleContext {
  ...
  ProtocolQualifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeSpecifierContext extends ParserRuleContext {
  TypeofExpressionContext typeofExpression() =>
      getRuleContext<TypeofExpressionContext>(0);
  GenericTypeSpecifierContext genericTypeSpecifier() =>
      getRuleContext<GenericTypeSpecifierContext>(0);
  StructOrUnionSpecifierContext structOrUnionSpecifier() =>
      getRuleContext<StructOrUnionSpecifierContext>(0);
...
class TypeofExpressionContext extends ParserRuleContext {
  ...
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  TypeofExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FieldDeclaratorListContext extends ParserRuleContext {
  List<FieldDeclaratorContext> fieldDeclarators() =>
      getRuleContexts<FieldDeclaratorContext>();
  FieldDeclaratorContext fieldDeclarator(int i) =>
      getRuleContext<FieldDeclaratorContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  FieldDeclaratorListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class FieldDeclaratorContext extends ParserRuleContext {
  ...
  TerminalNode COLON() => getToken(ObjectiveCParser.TOKEN_COLON, 0);
  ConstantContext constant() => getRuleContext<ConstantContext>(0);
  FieldDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumSpecifierContext extends ParserRuleContext {
  ...
  TerminalNode LBRACE() => getToken(ObjectiveCParser.TOKEN_LBRACE, 0);
  EnumeratorListContext enumeratorList() =>
      getRuleContext<EnumeratorListContext>(0);
  TerminalNode RBRACE() => getToken(ObjectiveCParser.TOKEN_RBRACE, 0);
  TerminalNode COLON() => getToken(ObjectiveCParser.TOKEN_COLON, 0);
  TypeNameContext typeName() => getRuleContext<TypeNameContext>(0);
  TerminalNode LP() => getToken(ObjectiveCParser.TOKEN_LP, 0);
  ...
  TerminalNode NS_ERROR_ENUM() =>
      getToken(ObjectiveCParser.TOKEN_NS_ERROR_ENUM, 0);
  TerminalNode NS_CLOSED_ENUM() =>
      getToken(ObjectiveCParser.TOKEN_NS_CLOSED_ENUM, 0);
  TerminalNode COMMA() => getToken(ObjectiveCParser.TOKEN_COMMA, 0);
  EnumSpecifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumeratorListContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  EnumeratorListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumeratorContext extends ParserRuleContext {
  ...
  EnumeratorIdentifierContext enumeratorIdentifier() =>
      getRuleContext<EnumeratorIdentifierContext>(0);
  List<MacroContext> macros() => getRuleContexts<MacroContext>();
  MacroContext macro(int i) => getRuleContext<MacroContext>(i);
  List<AttributeSpecifierContext> attributeSpecifiers() =>
      getRuleContexts<AttributeSpecifierContext>();
  ...
  TerminalNode ASSIGNMENT() => getToken(ObjectiveCParser.TOKEN_ASSIGNMENT, 0);
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  EnumeratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class EnumeratorIdentifierContext extends ParserRuleContext {
  ...
  EnumeratorIdentifierContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DirectDeclaratorContext extends ParserRuleContext {
  ...
  DeclaratorContext declarator() => getRuleContext<DeclaratorContext>(0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  List<DeclaratorSuffixContext> declaratorSuffixs() =>
      getRuleContexts<DeclaratorSuffixContext>();
  DeclaratorSuffixContext declaratorSuffix(int i) =>
      getRuleContext<DeclaratorSuffixContext>(i);
  TerminalNode BITXOR() => getToken(ObjectiveCParser.TOKEN_BITXOR, 0);
  BlockParametersContext blockParameters() =>
      getRuleContext<BlockParametersContext>(0);
  NullabilitySpecifierContext nullabilitySpecifier() =>
      getRuleContext<NullabilitySpecifierContext>(0);
  DirectDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DeclaratorSuffixContext extends ParserRuleContext {
  ...
  TerminalNode RBRACK() => getToken(ObjectiveCParser.TOKEN_RBRACK, 0);
  ConstantExpressionContext constantExpression() =>
      getRuleContext<ConstantExpressionContext>(0);
  DeclaratorSuffixContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ParameterListContext extends ParserRuleContext {
  ParameterDeclarationListContext parameterDeclarationList() =>
      getRuleContext<ParameterDeclarationListContext>(0);
  TerminalNode COMMA() => getToken(ObjectiveCParser.TOKEN_COMMA, 0);
  TerminalNode ELIPSIS() => getToken(ObjectiveCParser.TOKEN_ELIPSIS, 0);
...
class PointerContext extends ParserRuleContext {
  ...
  TerminalNode MUL() => getToken(ObjectiveCParser.TOKEN_MUL, 0);
  PointerQualifierContext pointerQualifier() =>
      getRuleContext<PointerQualifierContext>(0);
  PointerContext pointer() => getRuleContext<PointerContext>(0);
  PointerContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class MacroContext extends ParserRuleContext {
  ...
  List<TerminalNode> RPs() => getTokens(ObjectiveCParser.TOKEN_RP);
  TerminalNode RP(int i) => getToken(ObjectiveCParser.TOKEN_RP, i);
  List<PrimaryExpressionContext> primaryExpressions() =>
      getRuleContexts<PrimaryExpressionContext>();
  PrimaryExpressionContext primaryExpression(int i) =>
      getRuleContext<PrimaryExpressionContext>(i);
  ...
  List<TerminalNode> COLONs() => getTokens(ObjectiveCParser.TOKEN_COLON);
  TerminalNode COLON(int i) => getToken(ObjectiveCParser.TOKEN_COLON, i);
  MacroContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class StructInitializerContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  StructInitializerContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InitializerListContext extends ParserRuleContext {
  List<InitializerContext> initializers() =>
      getRuleContexts<InitializerContext>();
  InitializerContext initializer(int i) =>
      getRuleContext<InitializerContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  InitializerListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class TypeNameContext extends ParserRuleContext {
  SpecifierQualifierListContext specifierQualifierList() =>
      getRuleContext<SpecifierQualifierListContext>(0);
  AbstractDeclaratorContext abstractDeclarator() =>
      getRuleContext<AbstractDeclaratorContext>(0);
...
class AbstractDeclaratorContext extends ParserRuleContext {
  ...
  TerminalNode LP() => getToken(ObjectiveCParser.TOKEN_LP, 0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  List<AbstractDeclaratorSuffixContext> abstractDeclaratorSuffixs() =>
      getRuleContexts<AbstractDeclaratorSuffixContext>();
  AbstractDeclaratorSuffixContext abstractDeclaratorSuffix(int i) =>
      getRuleContext<AbstractDeclaratorSuffixContext>(i);
  ...
  List<ConstantExpressionContext> constantExpressions() =>
      getRuleContexts<ConstantExpressionContext>();
  ConstantExpressionContext constantExpression(int i) =>
      getRuleContext<ConstantExpressionContext>(i);
  AbstractDeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class AbstractDeclaratorSuffixContext extends ParserRuleContext {
  ...
  ParameterDeclarationListContext parameterDeclarationList() =>
      getRuleContext<ParameterDeclarationListContext>(0);
  AbstractDeclaratorSuffixContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ParameterDeclarationListContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  ParameterDeclarationListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DeclaratorContext extends ParserRuleContext {
  DirectDeclaratorContext directDeclarator() =>
      getRuleContext<DirectDeclaratorContext>(0);
  PointerContext pointer() => getRuleContext<PointerContext>(0);
  DeclaratorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class StatementContext extends ParserRuleContext {
  LabeledStatementContext labeledStatement() =>
      getRuleContext<LabeledStatementContext>(0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  CompoundStatementContext compoundStatement() =>
      getRuleContext<CompoundStatementContext>(0);
  SelectionStatementContext selectionStatement() =>
  ...
  IterationStatementContext iterationStatement() =>
      getRuleContext<IterationStatementContext>(0);
  JumpStatementContext jumpStatement() =>
      getRuleContext<JumpStatementContext>(0);
  SynchronizedStatementContext synchronizedStatement() =>
      getRuleContext<SynchronizedStatementContext>(0);
  AutoreleaseStatementContext autoreleaseStatement() =>
      getRuleContext<AutoreleaseStatementContext>(0);
  ThrowStatementContext throwStatement() =>
...
class LabeledStatementContext extends ParserRuleContext {
  ...
  LabeledStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SwitchBlockContext extends ParserRuleContext {
  TerminalNode LBRACE() => getToken(ObjectiveCParser.TOKEN_LBRACE, 0);
  TerminalNode RBRACE() => getToken(ObjectiveCParser.TOKEN_RBRACE, 0);
  List<SwitchSectionContext> switchSections() =>
      getRuleContexts<SwitchSectionContext>();
  SwitchSectionContext switchSection(int i) =>
      getRuleContext<SwitchSectionContext>(i);
  SwitchBlockContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SwitchSectionContext extends ParserRuleContext {
  List<SwitchLabelContext> switchLabels() =>
      getRuleContexts<SwitchLabelContext>();
  SwitchLabelContext switchLabel(int i) =>
      getRuleContext<SwitchLabelContext>(i);
  List<StatementContext> statements() => getRuleContexts<StatementContext>();
  StatementContext statement(int i) => getRuleContext<StatementContext>(i);
  SwitchSectionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class SwitchLabelContext extends ParserRuleContext {
  ...
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  TerminalNode DEFAULT() => getToken(ObjectiveCParser.TOKEN_DEFAULT, 0);
  SwitchLabelContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class IterationStatementContext extends ParserRuleContext {
  ...
  ForInStatementContext forInStatement() =>
      getRuleContext<ForInStatementContext>(0);
  IterationStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class DoStatementContext extends ParserRuleContext {
  ...
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  TerminalNode SEMI() => getToken(ObjectiveCParser.TOKEN_SEMI, 0);
  DoStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ForStatementContext extends ParserRuleContext {
  ...
  StatementContext statement() => getRuleContext<StatementContext>(0);
  ForLoopInitializerContext forLoopInitializer() =>
      getRuleContext<ForLoopInitializerContext>(0);
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  ExpressionsContext expressions() => getRuleContext<ExpressionsContext>(0);
...
class ForLoopInitializerContext extends ParserRuleContext {
  ...
  InitDeclaratorListContext initDeclaratorList() =>
      getRuleContext<InitDeclaratorListContext>(0);
  ExpressionsContext expressions() => getRuleContext<ExpressionsContext>(0);
  ForLoopInitializerContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ForInStatementContext extends ParserRuleContext {
  ...
  StatementContext statement() => getRuleContext<StatementContext>(0);
  ExpressionContext expression() => getRuleContext<ExpressionContext>(0);
  ForInStatementContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExpressionsContext extends ParserRuleContext {
  ...
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  ExpressionsContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ExpressionContext extends ParserRuleContext {
  ...
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  UnaryExpressionContext unaryExpression() =>
      getRuleContext<UnaryExpressionContext>(0);
  AssignmentOperatorContext assignmentOperator() =>
      getRuleContext<AssignmentOperatorContext>(0);
  List<ExpressionContext> expressions() => getRuleContexts<ExpressionContext>();
  ExpressionContext expression(int i) => getRuleContext<ExpressionContext>(i);
  TerminalNode MUL() => getToken(ObjectiveCParser.TOKEN_MUL, 0);
  TerminalNode DIV() => getToken(ObjectiveCParser.TOKEN_DIV, 0);
...
class AssignmentOperatorContext extends ParserRuleContext {
  ...
  TerminalNode LSHIFT_ASSIGN() =>
      getToken(ObjectiveCParser.TOKEN_LSHIFT_ASSIGN, 0);
  TerminalNode RSHIFT_ASSIGN() =>
      getToken(ObjectiveCParser.TOKEN_RSHIFT_ASSIGN, 0);
  ...
  AssignmentOperatorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class CastExpressionContext extends ParserRuleContext {
  ...
  CastExpressionContext castExpression() =>
      getRuleContext<CastExpressionContext>(0);
  InitializerContext initializer() => getRuleContext<InitializerContext>(0);
  CastExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class InitializerContext extends ParserRuleContext {
  ...
  StructInitializerContext structInitializer() =>
      getRuleContext<StructInitializerContext>(0);
...
class ConstantExpressionContext extends ParserRuleContext {
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  ConstantContext constant() => getRuleContext<ConstantContext>(0);
  ConstantExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnaryExpressionContext extends ParserRuleContext {
  ...
  PostfixExpressionContext postfixExpression() =>
      getRuleContext<PostfixExpressionContext>(0);
  ...
  UnaryOperatorContext unaryOperator() =>
      getRuleContext<UnaryOperatorContext>(0);
  CastExpressionContext castExpression() =>
      getRuleContext<CastExpressionContext>(0);
  UnaryExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class UnaryOperatorContext extends ParserRuleContext {
  ...
  UnaryOperatorContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PostfixExpressionContext extends ParserRuleContext {
  PrimaryExpressionContext primaryExpression() =>
      getRuleContext<PrimaryExpressionContext>(0);
  ...
  IdentifierContext identifier() => getRuleContext<IdentifierContext>(0);
  TerminalNode DOT() => getToken(ObjectiveCParser.TOKEN_DOT, 0);
  TerminalNode STRUCTACCESS() =>
      getToken(ObjectiveCParser.TOKEN_STRUCTACCESS, 0);
  PostfixExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PostfixContext extends ParserRuleContext {
  ...
  TerminalNode RP(int i) => getToken(ObjectiveCParser.TOKEN_RP, i);
  ArgumentExpressionListContext argumentExpressionList() =>
      getRuleContext<ArgumentExpressionListContext>(0);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  TerminalNode INC() => getToken(ObjectiveCParser.TOKEN_INC, 0);
  TerminalNode DEC() => getToken(ObjectiveCParser.TOKEN_DEC, 0);
  PostfixContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArgumentExpressionListContext extends ParserRuleContext {
  List<ArgumentExpressionContext> argumentExpressions() =>
      getRuleContexts<ArgumentExpressionContext>();
  ArgumentExpressionContext argumentExpression(int i) =>
      getRuleContext<ArgumentExpressionContext>(i);
  List<TerminalNode> COMMAs() => getTokens(ObjectiveCParser.TOKEN_COMMA);
  TerminalNode COMMA(int i) => getToken(ObjectiveCParser.TOKEN_COMMA, i);
  ArgumentExpressionListContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ArgumentExpressionContext extends ParserRuleContext {
  ...
  TypeSpecifierContext typeSpecifier() =>
      getRuleContext<TypeSpecifierContext>(0);
  ArgumentExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class OsVersionContext extends ParserRuleContext {
  ...
  TerminalNode LP() => getToken(ObjectiveCParser.TOKEN_LP, 0);
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  List<TerminalNode> FLOATING_POINT_LITERALs() =>
      getTokens(ObjectiveCParser.TOKEN_FLOATING_POINT_LITERAL);
  TerminalNode FLOATING_POINT_LITERAL(int i) =>
      getToken(ObjectiveCParser.TOKEN_FLOATING_POINT_LITERAL, i);
  List<TerminalNode> VERSION_SEMATICs() =>
      getTokens(ObjectiveCParser.TOKEN_VERSION_SEMATIC);
  TerminalNode VERSION_SEMATIC(int i) =>
      getToken(ObjectiveCParser.TOKEN_VERSION_SEMATIC, i);
  List<TerminalNode> IDENTIFIERs() =>
      getTokens(ObjectiveCParser.TOKEN_IDENTIFIER);
  TerminalNode IDENTIFIER(int i) =>
      getToken(ObjectiveCParser.TOKEN_IDENTIFIER, i);
  TerminalNode COMMA() => getToken(ObjectiveCParser.TOKEN_COMMA, 0);
  OsVersionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class PrimaryExpressionContext extends ParserRuleContext {
  ...
  TerminalNode RP() => getToken(ObjectiveCParser.TOKEN_RP, 0);
  MessageExpressionContext messageExpression() =>
      getRuleContext<MessageExpressionContext>(0);
  SelectorExpressionContext selectorExpression() =>
      getRuleContext<SelectorExpressionContext>(0);
  ProtocolExpressionContext protocolExpression() =>
      getRuleContext<ProtocolExpressionContext>(0);
  EncodeExpressionContext encodeExpression() =>
      getRuleContext<EncodeExpressionContext>(0);
  DictionaryExpressionContext dictionaryExpression() =>
      getRuleContext<DictionaryExpressionContext>(0);
  ArrayExpressionContext arrayExpression() =>
      getRuleContext<ArrayExpressionContext>(0);
  BoxExpressionContext boxExpression() =>
      getRuleContext<BoxExpressionContext>(0);
  BlockExpressionContext blockExpression() =>
      getRuleContext<BlockExpressionContext>(0);
  PrimaryExpressionContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class ConstantContext extends ParserRuleContext {
  ...
  TerminalNode OCTAL_LITERAL() =>
      getToken(ObjectiveCParser.TOKEN_OCTAL_LITERAL, 0);
  TerminalNode BINARY_LITERAL() =>
      getToken(ObjectiveCParser.TOKEN_BINARY_LITERAL, 0);
  TerminalNode DECIMAL_LITERAL() =>
      getToken(ObjectiveCParser.TOKEN_DECIMAL_LITERAL, 0);
  TerminalNode ADD() => getToken(ObjectiveCParser.TOKEN_ADD, 0);
  TerminalNode SUB() => getToken(ObjectiveCParser.TOKEN_SUB, 0);
  TerminalNode FLOATING_POINT_LITERAL() =>
      getToken(ObjectiveCParser.TOKEN_FLOATING_POINT_LITERAL, 0);
  TerminalNode CHARACTER_LITERAL() =>
      getToken(ObjectiveCParser.TOKEN_CHARACTER_LITERAL, 0);
  ...
  ConstantContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override
...
class StringLiteralContext extends ParserRuleContext {
  List<TerminalNode> STRING_STARTs() =>
      getTokens(ObjectiveCParser.TOKEN_STRING_START);
  TerminalNode STRING_START(int i) =>
      getToken(ObjectiveCParser.TOKEN_STRING_START, i);
  List<TerminalNode> STRING_ENDs() =>
      getTokens(ObjectiveCParser.TOKEN_STRING_END);
  TerminalNode STRING_END(int i) =>
      getToken(ObjectiveCParser.TOKEN_STRING_END, i);
  List<TerminalNode> STRING_VALUEs() =>
      getTokens(ObjectiveCParser.TOKEN_STRING_VALUE);
  TerminalNode STRING_VALUE(int i) =>
      getToken(ObjectiveCParser.TOKEN_STRING_VALUE, i);
  List<TerminalNode> STRING_NEWLINEs() =>
      getTokens(ObjectiveCParser.TOKEN_STRING_NEWLINE);
  TerminalNode STRING_NEWLINE(int i) =>
      getToken(ObjectiveCParser.TOKEN_STRING_NEWLINE, i);
  StringLiteralContext([ParserRuleContext parent, int invokingState])
      : super(parent, invokingState);
  @override

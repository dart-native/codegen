...
var DNTopLevelContext = c.DNTopLevelContext,
    DNClassContext = c.DNClassContext,
    DNCategoryContext = c.DNCategoryContext,
    DNProtocolContext = c.DNPropertyContext,
...
class DNObjectiveCParserListener extends ObjectiveCParserListener {
    ...
    enterTopLevelDeclaration(ctx) {
        this.topLevelContext = new DNTopLevelContext(ctx)
        this.currentContext = this.topLevelContext
    }

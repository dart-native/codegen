import ObjectiveCParserListener from '../../parser/objc/ObjectiveCParserListener.js'
...
import { DNRootContext, DNImportContext, DNBlockDefContext, DNEnumDefContext, DNEnumItemContext, DNClassContext, DNCategoryContext, DNProtocolContext, DNMethodContext, DNMethodDeclarationContext, DNPropertyContext, DNArgumentContext, DNAvailabilityContext, DNOSVersionContext } from './DNObjectiveCContext.js'

let TC = new DNObjectiveCTypeConverter

// This class defines a complete listener for a parse tree produced by ObjectiveCParser.
export default class DNObjectiveCParserListener extends ObjectiveCParserListener {
    ...
    exitBlockType(ctx) {
        if (this.currentContext instanceof DNArgumentContext) {
            ...
            this.currentContext.type += this.currentContext.blockRetType + ' Function' + blockArgs + this.currentContext.name
        }
    }

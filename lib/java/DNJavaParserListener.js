import Java9Listener from '../../parser/java/Java9Listener.js'
import { DNRootContext, DNPackageContext, DNImportContext, DNClassContext, DNMethodContext, DNArgumentContext } from './DNJavaContext.js'

export default class DNJavaParserListener extends Java9Listener {
    ...
    exitPackageName(ctx) {
        var packageName = new DNPackageContext(ctx)
    };
    ...
    enterMethodDeclaration(ctx) {
        var method = new DNMethodContext(ctx);

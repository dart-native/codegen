...
import 'package:dart_native_codegen/src/objc/dn_objectC_context.dart';

typedef void Callback(String dartCode,{error});
      ...
      //check if it is an export file
        ...
        for (var i = 0; i < ctx.children.length; i++) {
            if (ctx.children[i] is TopLevelDeclarationContext) {
                ...
                if (subChildren.childCount > 0 && !(subChildren.getChild(0) is ImportDeclarationContext)) {

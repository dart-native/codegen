				...
				if (_alt === 1) {
					...
					switch (la_) {
						...
						case 4:
							...
							localctx.op = this._input.LT(1);
							_la = this._input.LA(1);
							if (!(((((_la - 221)) & ~0x1f) == 0 && ((1 << (_la - 221)) & ((1 << (ObjectiveCPreprocessorParser.DIRECTIVE_LT - 221)) | (1 << (ObjectiveCPreprocessorParser.DIRECTIVE_GT - 221)) | (1 << (ObjectiveCPreprocessorParser.DIRECTIVE_LE - 221)) | (1 << (ObjectiveCPreprocessorParser.DIRECTIVE_GE - 221)))) !== 0))) {
								localctx.op = this._errHandler.recoverInline(this);
							}
							else {
								this._errHandler.reportMatch(this);
...
ObjectiveCPreprocessorParser.NS_CLOSED_ENUM = 106;
ObjectiveCPreprocessorParser.NS_TYPED_EXTENSIBLE_ENUM = 107;
ObjectiveCPreprocessorParser.NS_ERROR_ENUM = 108;
ObjectiveCPreprocessorParser.ASSIGN = 109;
ObjectiveCPreprocessorParser.COPY = 110;
ObjectiveCPreprocessorParser.GETTER = 111;
ObjectiveCPreprocessorParser.SETTER = 112;
ObjectiveCPreprocessorParser.STRONG = 113;
ObjectiveCPreprocessorParser.READONLY = 114;
ObjectiveCPreprocessorParser.READWRITE = 115;
ObjectiveCPreprocessorParser.WEAK = 116;
ObjectiveCPreprocessorParser.UNSAFE_UNRETAINED = 117;
ObjectiveCPreprocessorParser.IB_OUTLET = 118;
ObjectiveCPreprocessorParser.IB_OUTLET_COLLECTION = 119;
ObjectiveCPreprocessorParser.IB_INSPECTABLE = 120;
ObjectiveCPreprocessorParser.IB_DESIGNABLE = 121;
ObjectiveCPreprocessorParser.NS_ASSUME_NONNULL_BEGIN = 122;
ObjectiveCPreprocessorParser.NS_ASSUME_NONNULL_END = 123;
ObjectiveCPreprocessorParser.EXTERN_SUFFIX = 124;
ObjectiveCPreprocessorParser.IOS_SUFFIX = 125;
ObjectiveCPreprocessorParser.MAC_SUFFIX = 126;
ObjectiveCPreprocessorParser.TVOS_PROHIBITED = 127;
ObjectiveCPreprocessorParser.NS_NOESCAPE = 128;
ObjectiveCPreprocessorParser.EXPORT_SUFFIX = 129;
ObjectiveCPreprocessorParser.NS_RETURNS_RETAINED = 130;
ObjectiveCPreprocessorParser.NS_RETURNS_NOT_RETAINED = 131;
ObjectiveCPreprocessorParser.NS_RETURNS_INNER_POINTER = 132;
ObjectiveCPreprocessorParser.CF_RETURNS_RETAINED = 133;
ObjectiveCPreprocessorParser.CF_RETURNS_NOT_RETAINED = 134;
ObjectiveCPreprocessorParser.CF_CONSUMED = 135;
ObjectiveCPreprocessorParser.IDENTIFIER = 136;
ObjectiveCPreprocessorParser.LP = 137;
ObjectiveCPreprocessorParser.RP = 138;
ObjectiveCPreprocessorParser.LBRACE = 139;
ObjectiveCPreprocessorParser.RBRACE = 140;
ObjectiveCPreprocessorParser.LBRACK = 141;
ObjectiveCPreprocessorParser.RBRACK = 142;
ObjectiveCPreprocessorParser.SEMI = 143;
ObjectiveCPreprocessorParser.COMMA = 144;
ObjectiveCPreprocessorParser.DOT = 145;
ObjectiveCPreprocessorParser.STRUCTACCESS = 146;
ObjectiveCPreprocessorParser.AT = 147;
ObjectiveCPreprocessorParser.ASSIGNMENT = 148;
ObjectiveCPreprocessorParser.GT = 149;
ObjectiveCPreprocessorParser.LT = 150;
ObjectiveCPreprocessorParser.BANG = 151;
ObjectiveCPreprocessorParser.TILDE = 152;
ObjectiveCPreprocessorParser.QUESTION = 153;
ObjectiveCPreprocessorParser.COLON = 154;
ObjectiveCPreprocessorParser.EQUAL = 155;
ObjectiveCPreprocessorParser.LE = 156;
ObjectiveCPreprocessorParser.GE = 157;
ObjectiveCPreprocessorParser.NOTEQUAL = 158;
ObjectiveCPreprocessorParser.AND = 159;
ObjectiveCPreprocessorParser.OR = 160;
ObjectiveCPreprocessorParser.INC = 161;
ObjectiveCPreprocessorParser.DEC = 162;
ObjectiveCPreprocessorParser.ADD = 163;
ObjectiveCPreprocessorParser.SUB = 164;
ObjectiveCPreprocessorParser.MUL = 165;
ObjectiveCPreprocessorParser.DIV = 166;
ObjectiveCPreprocessorParser.BITAND = 167;
ObjectiveCPreprocessorParser.BITOR = 168;
ObjectiveCPreprocessorParser.BITXOR = 169;
ObjectiveCPreprocessorParser.MOD = 170;
ObjectiveCPreprocessorParser.ADD_ASSIGN = 171;
ObjectiveCPreprocessorParser.SUB_ASSIGN = 172;
ObjectiveCPreprocessorParser.MUL_ASSIGN = 173;
ObjectiveCPreprocessorParser.DIV_ASSIGN = 174;
ObjectiveCPreprocessorParser.AND_ASSIGN = 175;
ObjectiveCPreprocessorParser.OR_ASSIGN = 176;
ObjectiveCPreprocessorParser.XOR_ASSIGN = 177;
ObjectiveCPreprocessorParser.MOD_ASSIGN = 178;
ObjectiveCPreprocessorParser.LSHIFT_ASSIGN = 179;
ObjectiveCPreprocessorParser.RSHIFT_ASSIGN = 180;
ObjectiveCPreprocessorParser.ELIPSIS = 181;
ObjectiveCPreprocessorParser.CHARACTER_LITERAL = 182;
ObjectiveCPreprocessorParser.STRING_START = 183;
ObjectiveCPreprocessorParser.HEX_LITERAL = 184;
ObjectiveCPreprocessorParser.OCTAL_LITERAL = 185;
ObjectiveCPreprocessorParser.BINARY_LITERAL = 186;
ObjectiveCPreprocessorParser.DECIMAL_LITERAL = 187;
ObjectiveCPreprocessorParser.FLOATING_POINT_LITERAL = 188;
ObjectiveCPreprocessorParser.VERSION_SEMATIC = 189;
ObjectiveCPreprocessorParser.WS = 190;
ObjectiveCPreprocessorParser.MULTI_COMMENT = 191;
ObjectiveCPreprocessorParser.SINGLE_COMMENT = 192;
ObjectiveCPreprocessorParser.BACKSLASH = 193;
ObjectiveCPreprocessorParser.SHARP = 194;
ObjectiveCPreprocessorParser.STRING_NEWLINE = 195;
ObjectiveCPreprocessorParser.STRING_END = 196;
ObjectiveCPreprocessorParser.STRING_VALUE = 197;
ObjectiveCPreprocessorParser.DIRECTIVE_IMPORT = 198;
ObjectiveCPreprocessorParser.DIRECTIVE_INCLUDE = 199;
ObjectiveCPreprocessorParser.DIRECTIVE_PRAGMA = 200;
ObjectiveCPreprocessorParser.DIRECTIVE_DEFINE = 201;
ObjectiveCPreprocessorParser.DIRECTIVE_DEFINED = 202;
ObjectiveCPreprocessorParser.DIRECTIVE_IF = 203;
ObjectiveCPreprocessorParser.DIRECTIVE_ELIF = 204;
ObjectiveCPreprocessorParser.DIRECTIVE_ELSE = 205;
ObjectiveCPreprocessorParser.DIRECTIVE_UNDEF = 206;
ObjectiveCPreprocessorParser.DIRECTIVE_IFDEF = 207;
ObjectiveCPreprocessorParser.DIRECTIVE_IFNDEF = 208;
ObjectiveCPreprocessorParser.DIRECTIVE_ENDIF = 209;
ObjectiveCPreprocessorParser.DIRECTIVE_TRUE = 210;
ObjectiveCPreprocessorParser.DIRECTIVE_FALSE = 211;
ObjectiveCPreprocessorParser.DIRECTIVE_ERROR = 212;
ObjectiveCPreprocessorParser.DIRECTIVE_WARNING = 213;
ObjectiveCPreprocessorParser.DIRECTIVE_BANG = 214;
ObjectiveCPreprocessorParser.DIRECTIVE_LP = 215;
ObjectiveCPreprocessorParser.DIRECTIVE_RP = 216;
ObjectiveCPreprocessorParser.DIRECTIVE_EQUAL = 217;
ObjectiveCPreprocessorParser.DIRECTIVE_NOTEQUAL = 218;
ObjectiveCPreprocessorParser.DIRECTIVE_AND = 219;
ObjectiveCPreprocessorParser.DIRECTIVE_OR = 220;
ObjectiveCPreprocessorParser.DIRECTIVE_LT = 221;
ObjectiveCPreprocessorParser.DIRECTIVE_GT = 222;
ObjectiveCPreprocessorParser.DIRECTIVE_LE = 223;
ObjectiveCPreprocessorParser.DIRECTIVE_GE = 224;
ObjectiveCPreprocessorParser.DIRECTIVE_ADD = 225;
ObjectiveCPreprocessorParser.DIRECTIVE_SUB = 226;
ObjectiveCPreprocessorParser.DIRECTIVE_MUL = 227;
ObjectiveCPreprocessorParser.DIRECTIVE_DIV = 228;
ObjectiveCPreprocessorParser.DIRECTIVE_BITAND = 229;
ObjectiveCPreprocessorParser.DIRECTIVE_BITOR = 230;
ObjectiveCPreprocessorParser.DIRECTIVE_BITXOR = 231;
ObjectiveCPreprocessorParser.DIRECTIVE_MOD = 232;
ObjectiveCPreprocessorParser.DIRECTIVE_DOT = 233;
ObjectiveCPreprocessorParser.DIRECTIVE_STRING = 234;
ObjectiveCPreprocessorParser.DIRECTIVE_ID = 235;
ObjectiveCPreprocessorParser.DIRECTIVE_DECIMAL_LITERAL = 236;
ObjectiveCPreprocessorParser.DIRECTIVE_FLOAT = 237;
ObjectiveCPreprocessorParser.DIRECTIVE_NEWLINE = 238;
ObjectiveCPreprocessorParser.DIRECTIVE_MULTI_COMMENT = 239;
ObjectiveCPreprocessorParser.DIRECTIVE_SINGLE_COMMENT = 240;
ObjectiveCPreprocessorParser.DIRECTIVE_BACKSLASH_NEWLINE = 241;
ObjectiveCPreprocessorParser.DIRECTIVE_TEXT_NEWLINE = 242;
ObjectiveCPreprocessorParser.DIRECTIVE_TEXT = 243;
